import { Building, Cpu, Hammer, Users, FileText, TrendingUp, Shield, Calculator, BookOpen, Gavel, BrainCircuit, Target } from "lucide-react";
...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    ...
    services: [
      {
        title: "정관 및 배당 컨설팅",
        description: "법인 운영의 기본틀이 되는 정관 설계와 최적화된 배당정책 수립",
        features: [
          "맞춤형 정관 설계 및 개정",
          "배당정책 최적화 전략",
          "주주권리 보호 조항 설계",
...
export const INDUSTRY_SERVICES: IndustryService[] = [
  ...
  },
  {
    icon: Users,
    title: "가족법인·MSO",
    description: "가족법인 설립부터 MSO 운영까지 세대를 넘나드는 자산관리 및 승계 설계",
    painPoints: [
    ...
    caseStudy: {
      ...
      solution: "가족법인 설립, 지분 승계 전략, 세무 최적화를 통한 단계적 승계 설계",
