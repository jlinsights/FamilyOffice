...
export const UPCOMING_SEMINARS: Seminar[] = [
  ...
  {
    id: 'fp-center-asset-management-seoul',
    title: 'FP센터 자산관리 세미나',
    subtitle: '체계적인 자산관리와 포트폴리오 전략',
    description:
      '서울FP센터에서 진행하는 전문 자산관리 세미나입니다. 개인 및 기업 자산의 체계적 관리 방법과 효과적인 포트폴리오 구성 전략을 학습하실 수 있습니다.',
    speaker: {
      id: 'fp-center-expert',
      name: '김자산',
      title: '자산관리전문가',
      company: '서울FP센터',
      bio: '서울FP센터 소속으로 개인 및 기업 자산관리 전문가로 10년 이상의 경험을 보유하고 있습니다.',
      expertise: ['자산관리', '포트폴리오', '재무설계', '투자전략'],
    },
    date: '2025-09-05',
    time: '14:00',
    duration: '2시간 30분',
    ...
    category: 'finance',
    targetAudience: ['개인투자자', '중소기업 대표', '재무담당자'],
    capacity: 30,
    registeredCount: 8,
    price: 0,
    isPremium: false,
    ...
    depositNote: '노쇼 방지를 위한 참가보증금 (세미나 참가 확인 시 즉시 환불)',
    status: 'upcoming',
    tags: ['자산관리', '포트폴리오', '재무설계', 'FP센터'],
    registrationUrl: 'https://example.com/fp-center-seoul',
    detailsUrl: 'https://example.com/fp-center-seoul',
    agenda: [
      {
        time: '14:00',
        title: '등록 및 안내',
      ...
      },
      {
        time: '14:15',
        title: '체계적인 자산관리의 기초',
        description: '개인 및 기업 자산관리의 기본 원칙과 체계',
        speaker: '김자산 자산관리전문가',
        duration: 60,
      },
      {
        time: '15:15',
        title: '포트폴리오 구성 전략',
        description: '리스크 분산과 수익 최적화를 위한 포트폴리오 설계',
        speaker: '김자산 자산관리전문가',
        duration: 60,
      },
      {
  ...
  {
    id: 'fp-center-asset-management-gangnam',
    title: 'FP센터 자산관리 세미나',
    subtitle: '고급 자산관리 전략과 세무 최적화',
    description:
      '강남FP센터에서 진행하는 고급 자산관리 세미나입니다. 고액자산가를 위한 세무 최적화 전략과 고급 투자 기법을 다룹니다.',
    speaker: {
      id: 'fp-center-gangnam-expert',
      name: '박투자',
      title: '수석자산관리사',
      company: '강남FP센터',
      bio: '강남FP센터 수석자산관리사로 고액자산가 대상 자산관리 및 세무 최적화 전문가입니다.',
      expertise: ['고급자산관리', '세무최적화', '대체투자', '상속설계'],
    },
    date: '2025-09-12',
    time: '14:00',
    duration: '2시간 30분',
    ...
    category: 'finance',
    targetAudience: ['고액자산가', '기업오너', '투자전문가'],
    capacity: 25,
    registeredCount: 6,
    price: 0,
    isPremium: true,
    ...
    depositNote: '노쇼 방지를 위한 참가보증금 (세미나 참가 확인 시 즉시 환불)',
    status: 'upcoming',
    tags: ['자산관리', '세무최적화', '대체투자', 'FP센터'],
    registrationUrl: 'https://example.com/fp-center-gangnam',
    detailsUrl: 'https://example.com/fp-center-gangnam',
    agenda: [
      {
        time: '14:00',
        title: '등록 및 안내',
      ...
      },
      {
        time: '14:15',
        title: '고급 자산관리 전략',
        description: '고액자산가를 위한 전문 자산관리 기법',
        speaker: '박투자 수석자산관리사',
        duration: 60,
      },
      {
        time: '15:15',
        title: '세무 최적화와 상속 설계',
        description: '절세 전략과 효과적인 상속 계획 수립',
        speaker: '박투자 수석자산관리사',
        duration: 60,
      },
      {
