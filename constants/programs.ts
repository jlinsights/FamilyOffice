...
export const CEO_PROGRAMS: SpecialProgram[] = [
  { title: "2030 Business Live On", subtitle: "경제, 경영, 인문 등 명사 강연 및 조찬 (온/오프라인)", desc: "경영, 산업 트렌드, 리더십, 인문학 등 다양한 강연을 통해 사회의 리더로서 올바른 경영 철학을 고민하는 시간. 미래를 바라보는 지혜와 창조적 영감을 얻을 수 있습니다.", place: "서울 FamilyOffice S 세미나룸 및 온라인 접속", target: "FamilyOffice S VIP 고객", freq: "월1회" },
  { title: "CEO 명경재(明鏡齋)", subtitle: "법인CEO 고객을 위한 소수정예 인문학 클럽", desc: "명경재는 매우 맑은 거울에 자신을 비추며 함께 공부하는 곳을 의미합니다. 책의 저자와 함께 하는 강연을 통해 자신의 내면을 돌아보고, 자유로운 소통으로 인문학적 혜안을 나눕니다.", place: "서울 FamilyOffice S 세미나룸", target: "FamilyOffice S VIP 고객", freq: "반기 1회" },
  { title: "100년 기업 차세대 CEO 과정", subtitle: "경영 2,3세 가업승계 재직자 고객을 위한 교육 과정", desc: "가업승계의 방향과 트렌드를 선도하는 비즈니스 사례를 통해 실질적인 경영 노하우를 습득할 수 있는 다양한 커리큘럼 제공. 사업의 확장과 발전을 도모하며, 교육생들 간의 상호 네트워크를 구축합니다.", place: "서울 FamilyOffice S 세미나룸", target: "가업승계 재직 중인 경영 2,3세", freq: "연1회" },
  { title: "Global Insight Program", subtitle: "가업승계 대상 재학생 고객을 위한 과정", desc: "가문의 시작, 발전, 승계, 가치는 4가지 CORE VALUE에 입각하여 가문의 시작인 '나'로부터 나의 가족, 근원을 탐색하고 미래를 정립합니다. 미래 경영 리더로서의 경영 방향에 가이드를 제공합니다.", place: "서울 FamilyOffice S 세미나룸 및 외부 장소", target: "FamilyOffice S VIP 고객의 자녀", freq: "연1회" }
];

export const ASSET_PROGRAMS: SpecialProgram[] = [
  { title: "예술자산클래스 ART", subtitle: "문화 예술에 관심있는 고객을 위한 과정", desc: "예술은 인문학적 소양과 예술적 감각 뿐 아니라, 자테크의 방법으로까지 활용되고 있습니다. 강연, 전시회/경매 관람 등 예술을 다각도로 바라보는 관점을 키웁니다.", place: "서울 FamilyOffice S 세미나룸", target: "예술에 관심이 있는 FamilyOffice S VIP 고객", freq: "반기 1회" },
  { title: "WM 부동산 아카데미", subtitle: "부동산 투자/세금 교육 및 유망 상권 필드트립 과정", desc: "부동산은 가문을 이어나갈 중점 자산인 만큼 장기적인 안목과 관리가 필요합니다. 관련 세법/투자 강의 및 수도권 주요지역 물건 답사를 통해 실전 감각을 키웁니다.", place: "FamilyOffice S 세미나룸 및 현장 필드트립", target: "부동산 투자에 관심이 있는 FamilyOffice S VIP 고객", freq: "연1회" },
  { title: "WM VIP 여성고객 초청 프로그램", subtitle: "4060 여성고객을 위한 문화 참여 프로그램", desc: "VIP 여성고객의 품격과 여유를 위해, 시즌별 여성들의 주요 관심사에 대한 강연 및 명소 투어를 통한 힐링과 삶의 여유를 느끼실 수 있습니다.", place: "서울 FamilyOffice S 세미나룸", target: "VIP 여성고객", freq: "연 1회" },
