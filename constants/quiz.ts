...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  // PART 1. Financial Health
  {
    ...
    description: '회사가 이 플랜을 끝까지 유지할 체력이 있는지 확인하는 단계입니다.',
    weight: 1,
    options: [
      {
        id: 'A',
        label: '순이익 2억 원 미만',
        value: 'low',
        scores: { 세무: 3, 보험: 2, 승계: 1, 자산: 3, 투자: 2, 법인: 1, 인사: 1, 특허: 3 },
      },
      {
        id: 'B',
        label: '순이익 2~3억 원 (납입 여력 양호)',
        value: 'medium',
        scores: { 세무: 7, 보험: 6, 승계: 4, 자산: 5, 투자: 4, 법인: 4, 인사: 3, 특허: 2 },
      },
      {
        id: 'C',
        label: '순이익 3억 원 이상',
        value: 'high',
        scores: { 세무: 9, 보험: 8, 승계: 7, 자산: 8, 투자: 7, 법인: 7, 인사: 5, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '여유 자금 부족',
        value: 'insufficient',
        scores: { 세무: 2, 보험: 1, 승계: 1, 자산: 2, 투자: 1, 법인: 1, 인사: 1, 특허: 2 },
      },
      {
        id: 'B',
        label: '월 잉여금의 30% 이내로 보험료 납입 가능',
        value: 'sufficient',
        scores: { 세무: 8, 보험: 8, 승계: 5, 자산: 6, 투자: 5, 법인: 4, 인사: 2, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '없음',
        value: 'none',
        scores: { 세무: 5, 보험: 5, 승계: 5, 자산: 5, 투자: 5, 법인: 5, 인사: 5, 특허: 5 },
      },
      {
        id: 'B',
        label: '있음 (가지급금 해결 필요)',
        value: 'exist',
        scores: { 세무: 10, 보험: 7, 승계: 6, 자산: 4, 투자: 2, 법인: 8, 인사: 1, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '없음',
        value: 'none',
        scores: { 세무: 5, 보험: 7, 승계: 5, 자산: 5, 투자: 5, 법인: 5, 인사: 5, 특허: 5 },
      },
      {
        id: 'B',
        label: '있음 (리모델링 고려)',
        value: 'exist',
        scores: { 세무: 6, 보험: 9, 승계: 5, 자산: 5, 투자: 5, 법인: 4, 인사: 2, 특허: 1 },
      },
    ],
  },
    ...
    options: [
      {
        ...
        value: 'low',
        scores: { 세무: 6, 보험: 8, 승계: 3, 자산: 4, 투자: 3, 법인: 3, 인사: 5, 특허: 2 },
      },
      {
        id: 'B',
        label: '1.2억 원 초과 (퇴직금 플랜/CEO 플랜 유리)',
        value: 'high',
        scores: { 세무: 8, 보험: 10, 승계: 6, 자산: 7, 투자: 6, 법인: 6, 인사: 3, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '예 (1인/가족 법인)',
        value: 'family',
        scores: { 세무: 8, 보험: 7, 승계: 8, 자산: 8, 투자: 7, 법인: 9, 인사: 4, 특허: 2 },
      },
      {
        id: 'B',
        label: '아니오 (타인 지분 있음)',
        value: 'others',
        scores: { 세무: 6, 보험: 4, 승계: 4, 자산: 4, 투자: 4, 법인: 7, 인사: 6, 특허: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '예',
        value: 'yes',
        scores: { 세무: 7, 보험: 6, 승계: 7, 자산: 6, 투자: 5, 법인: 6, 인사: 5, 특허: 1 },
      },
      {
        id: 'B',
        label: '아니오',
        value: 'no',
        scores: { 세무: 5, 보험: 5, 승계: 4, 자산: 4, 투자: 4, 법인: 5, 인사: 4, 특허: 2 },
      },
    ],
  },
  {
    ...
    description: '자산이 회사에 묶여 있고 개인 현금 유동성이 부족한지 확인합니다.',
    weight: 1,
    options: [
      {
        id: 'A',
        label: '개인 현금 충분함',
        value: 'sufficient',
        scores: { 세무: 4, 보험: 4, 승계: 5, 자산: 8, 투자: 9, 법인: 3, 인사: 2, 특허: 2 },
      },
      {
        id: 'B',
        label: '부족함/회사 자산에 묶여 있음 (개인 유동성 확보 필요)',
        value: 'insufficient',
        scores: { 세무: 7, 보험: 8, 승계: 4, 자산: 6, 투자: 4, 법인: 5, 인사: 2, 특허: 1 },
      },
    ],
  },
    ...
    options: [
      {
        ...
        label: '최근(3년 내) 정비함',
        value: 'recent',
        scores: { 세무: 3, 보험: 3, 승계: 4, 자산: 4, 투자: 4, 법인: 2, 인사: 3, 특허: 2 },
      },
      {
        id: 'B',
        label: '오래됨/기억 안 남 (정비 필요)',
        value: 'old',
        scores: { 세무: 8, 보험: 6, 승계: 5, 자산: 3, 투자: 2, 법인: 10, 인사: 4, 특허: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '명시되어 있음',
        value: 'yes',
        scores: { 세무: 3, 보험: 4, 승계: 4, 자산: 4, 투자: 3, 법인: 2, 인사: 3, 특허: 2 },
      },
      {
        id: 'B',
        label: '없음/모름 (규정 정비 시급)',
        value: 'no',
        scores: { 세무: 9, 보험: 7, 승계: 5, 자산: 3, 투자: 2, 법인: 10, 인사: 4, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '실시하고 있음',
        value: 'yes',
        scores: { 세무: 4, 보험: 3, 승계: 4, 자산: 6, 투자: 5, 법인: 3, 인사: 3, 특허: 2 },
      },
      {
        id: 'B',
        label: '안 함 (전략 수립 필요)',
        value: 'no',
        scores: { 세무: 8, 보험: 5, 승계: 5, 자산: 5, 투자: 4, 법인: 9, 인사: 3, 특허: 1 },
      },
    ],
  },
    ...
    options: [
      {
        ...
        label: '있음 (승계 계획 필요)',
        value: 'yes',
        scores: { 세무: 9, 보험: 8, 승계: 10, 자산: 7, 투자: 5, 법인: 8, 인사: 4, 특허: 2 },
      },
      {
        id: 'B',
        label: '없음/매각 고려',
        value: 'no',
        scores: { 세무: 6, 보험: 3, 승계: 2, 자산: 9, 투자: 8, 법인: 5, 인사: 3, 특허: 2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '5년 미만',
        value: 'short',
        scores: { 세무: 5, 보험: 4, 승계: 8, 자산: 8, 투자: 6, 법인: 5, 인사: 3, 특허: 2 },
      },
      {
        id: 'B',
        label: '7~10년 이상 (CEO 플랜 적기)',
        value: 'long',
        scores: { 세무: 8, 보험: 10, 승계: 7, 자산: 7, 투자: 5, 법인: 6, 인사: 3, 특허: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: '준비됨',
        value: 'prepared',
        scores: { 세무: 3, 보험: 2, 승계: 4, 자산: 5, 투자: 4, 법인: 3, 인사: 2, 특허: 2 },
      },
      {
        id: 'B',
        label: '준비 안 됨 (리스크 헤지 필요)',
        value: 'unprepared',
        scores: { 세무: 5, 보험: 10, 승계: 6, 자산: 4, 투자: 2, 법인: 4, 인사: 2, 특허: 1 },
      },
    ],
  },
];
