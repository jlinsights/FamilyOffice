...
export const FAMILYOFFICE_PODCAST_SHOW: PodcastShow = {
  ...
  description:
    '전문가와 함께하는 자산관리 토크 - 복잡한 자산관리와 세무 전략을 쉽게 풀어드리는 오디오 콘텐츠',
  spotifyUrl:
    'https://open.spotify.com/show/6BvRGd3OODaKyJtVl1GN46?si=FYutRxkCTLiMK9vckK26Bg',
...
export const PODCAST_CATEGORIES: Record<
  PodcastCategory,
  {
    name: string;
    description: string;
...
export const BLOG_TO_PODCAST_CATEGORY_MAPPING: Record<
  string,
  PodcastCategory[]
> = {
  // Direct mappings
...
export const DEFAULT_PODCAST_EPISODES: PodcastEpisode[] = [
  {
    ...
    description:
      '새해를 맞아 글로벌 경제 전망과 주요 투자 테마를 살펴봅니다. 미국 연준의 금리 정책, 중국 경제 회복세, 그리고 한국 시장의 기회요인을 전문가와 함께 논의합니다.',
  ...
  },
  {
    ...
    description:
      '중견기업 CEO들이 가장 궁금해하는 가족법인 설립 과정과 세무 혜택을 상세히 설명합니다. 실제 사례를 통해 절세 효과와 주의사항을 알아봅니다.',
  ...
  },
  {
    ...
    description:
      '100년 기업으로 나아가기 위한 체계적인 승계 계획 수립 방법을 제시합니다. 경영권 승계, 재산 승계, 그리고 리더십 개발까지 포괄적으로 다룹니다.',
  ...
  },
  {
    ...
    description:
      '중견기업 CEO를 위한 맞춤형 패밀리오피스 구축 전략을 소개합니다. 조직 구성, 투자 정책, 거버넌스 설계 등 실무 중심으로 설명드립니다.',
  ...
  },
  {
    ...
    description:
      '핀테크 기술을 활용한 효율적인 자산관리 방법을 소개합니다. 로보어드바이저, 디지털 뱅킹, 포트폴리오 관리 툴의 실제 활용 사례를 다룹니다.',
  ...
  },
  {
    ...
    description:
      '해외 선진 패밀리오피스의 운영 방식과 투자 전략을 분석합니다. 싱가포르, 홍콩, 스위스 등 주요 금융 허브의 사례를 통해 국내 적용 방안을 모색합니다.',
