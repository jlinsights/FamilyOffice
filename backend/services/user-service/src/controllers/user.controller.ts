...
export class UserController {
  ...
  async createUser(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const rateLimitResult = await rateLimiter.checkLimit(rateLimitKey, 10, 3600); // 10회/시간
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'create_user', Date.now() - startTime);
  ...
  async login(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const rateLimitResult = await rateLimiter.checkLimit(rateLimitKey, 5, 900); // 5회/15분
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'login', Date.now() - startTime);
  ...
  async getUser(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_user', Date.now() - startTime);
  ...
  async getUsers(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const context = this.createTenantContext(req);
      const result = await this.userService.getUsers(filter, sort, pagination, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_users', Date.now() - startTime);
  ...
  async updateUser(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'update_user', Date.now() - startTime);
  ...
  async deleteUser(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'delete_user', Date.now() - startTime);
  ...
  async createFamilyMember(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const familyMember = await this.userService.createFamilyMember(request, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'create_family_member', Date.now() - startTime);
  ...
  async validateSession(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const session = await this.userService.validateSession(sessionId, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'validate_session', Date.now() - startTime);
  ...
  async logout(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'logout', Date.now() - startTime);
  ...
  async setupTwoFactor(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'setup_two_factor', Date.now() - startTime);
  ...
  async requestPasswordReset(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const rateLimitResult = await rateLimiter.checkLimit(rateLimitKey, 3, 3600); // 3회/시간
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'request_password_reset', Date.now() - startTime);
  ...
  async changePassword(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'change_password', Date.now() - startTime);
  ...
  async getUserProfile(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_user_profile', Date.now() - startTime);
  ...
  async getUserPermissions(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const permissions = await this.userService.getUserPermissions(userId, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_user_permissions', Date.now() - startTime);
  ...
  async getFamilyHierarchy(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const hierarchy = await this.userService.getFamilyHierarchy(familyGroupId, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_family_hierarchy', Date.now() - startTime);
  ...
  async getSessionInfo(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const sessionInfo = await this.userService.getSessionInfo(sessionId, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_session_info', Date.now() - startTime);
  ...
  async getLoginHistory(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_login_history', Date.now() - startTime);
  ...
  async getSecuritySettings(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const settings = await this.userService.getSecuritySettings(userId, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'get_security_settings', Date.now() - startTime);
  ...
  async updateSecuritySettings(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const updatedSettings = await this.userService.updateSecuritySettings(userId, settings, context);

      // 메트릭 기록
      metricsCollector.recordApiCall('user_service', 'update_security_settings', Date.now() - startTime);
