...
export const verifyToken = (token: string): any => {
  try {
    ...
    logger.error('JWT 토큰 검증 실패', { error: error instanceof Error ? error.message : 'Unknown error' });
...
export const verifyRefreshToken = (token: string): any => {
  try {
    ...
    logger.error('리프레시 토큰 검증 실패', { error: error instanceof Error ? error.message : 'Unknown error' });
