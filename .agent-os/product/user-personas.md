# User Personas - FamilyOffice S

**Document Purpose**: Detailed user personas for FamilyOffice S platform targeting Korean mid-market company CEOs.

**Last Updated**: December 24, 2024

---

## Primary Persona: Mid-Market CEO (핵심 타겟)

### Persona 1: 김철수 (Kim Chul-soo) - Manufacturing Company CEO 【Tier 1: Premium Segment】
...
- **Annual Revenue**: ₩450 billion (매출 300억~600억 구간)
- **Operating Profit**: ₩35 billion (영업이익 20억~50억)
- **Net Profit**: ₩25 billion annually (순이익 15억 이상)
- **Retained Earnings**: ₩350 billion accumulated (이익잉여금 300억 이상)
- **Debt Ratio**: 65% (부채비율 100% 미만, 무차입 경영 선호)
- **Employees**: 180 people
- **Location**: Gyeonggi-do (경기도)
- **Education**: Seoul National University, Mechanical Engineering
...
2. **Financial Goals**:
   ...
   - Minimize inheritance tax (estimated ₩15 billion burden)
   - Diversify personal wealth beyond company equity
3. **Business Goals**:
   - Prepare next generation for leadership
   - Protect family wealth during succession
...
1. **가업 승계 (Business Succession)**:
   ...
   - Worried about forced asset sales to pay inheritance taxes
   - Son (28) needs preparation for CEO role

2. **상속세 재원 마련 (Inheritance Tax Funding)**:
   - Cash shortage for tax payment (현금 부족)
   - 60% of assets tied up in real estate/land/buildings (자산의 60%가 부동산)
   - Retained earnings ₩350B mostly in company stock
   - Need liquid assets for ₩150B tax liability

3. **차명주식 정리 (Nominee Share Cleanup)**:
   - Past nominee trust shares need to be resolved (과거 명의신탁 주식)
   - Legal risks from undisclosed beneficial ownership
   - Complex unwinding process with tax implications
   - Needs expert guidance for compliance

4. **CEO 1인 지분 집중 (Concentrated Ownership)**:
   - Holds 85% of company shares (CEO 1인 지분 80% 이상)
   - Massive inheritance tax exposure due to concentration
   - Limited succession planning options
   - Need to redistribute ownership without losing control

5. **보수적 경영 스타일 (Conservative Management Style)**:
   - Prefers stability over aggressive growth
   - Uncomfortable with complex financial structures
   - Values long-term family legacy over short-term gains
...
- **Preferred Contact**: 9 AM - 6 PM weekdays, KakaoTalk preferred
...
- **Frequency**: Weekly insights (Monday/Friday mornings)
...
1. **Research Phase** (2-3 weeks):
   ...
   - Ask peer CEOs for recommendations

2. **Evaluation Phase** (1-2 weeks):
   - Compare 3-4 service providers
   - Check credentials and client success stories
   - Prefer face-to-face initial consultation

3. **Decision Criteria**:
   - Trust and credibility (most important)
   - Industry-specific expertise (manufacturing knowledge)
...
- **Evaluation**: Face-to-face consultation (prefers in-person), family office tour
- **Decision**: Comprehensive proposal with legacy preservation focus
...
- Family wealth diversified beyond company
- Peace of mind about financial future

---

### Persona 2: 이영희 (Lee Young-hee) - IT/Venture CEO 【Tier 2: Volume Segment】
...
- **Annual Revenue**: ₩180 billion (매출 100억~300억 구간)
- **Operating Profit**: ₩12 billion (영업이익 7억~20억)
- **Net Profit**: ₩8 billion annually (순이익 5억 이상)
- **Retained Earnings**: ₩65 billion accumulated (이익잉여금 30억~100억)
- **Debt Ratio**: 150% (부채비율 200% 미만, 투자 확대로 부채 존재)
- **Employees**: 120 people
- **Location**: Gangnam, Seoul (강남)
- **Education**: KAIST, Computer Science + MBA
...
2. **Financial Goals**:
   ...
   - Stock option tax optimization for employees
   - Diversify assets before exit event
3. **Business Goals**:
   - Prepare for IPO or strategic acquisition
   - Protect founder equity during growth
...
1. **가지급금 문제 (Corporate Loan Issues)**:
   ...
   - IRS scrutiny and potential tax adjustments
   - Needs proper restructuring strategy

2. **법인세 절감 (Corporate Tax Burden)**:
   - Corporate tax increasing annually with profit growth
   - Tax rate: 22% on ₩12B operating profit = ₩2.64B tax
   - Seeking legal tax optimization strategies
   - Need expert guidance on deductions and credits

3. **CEO 은퇴 자금 (CEO Retirement Fund)**:
   - Built successful company but no personal retirement fund
   - Most wealth tied up in company stock
   - CEO severance package not properly prepared
   - Need to extract wealth tax-efficiently

4. **현금 확보 어려움 (Cash Flow Constraints)**:
   - Company profitable but CEO's personal cash limited
   - ₩65B retained earnings mostly reinvested in business
   - Difficult to access corporate cash for personal use
   - Need dividend strategy or salary optimization

5. **성장 지향 스타일 (Growth-Oriented Mindset)**:
   - Prefers aggressive expansion over conservative approach
   - Open to complex financial structures if ROI is clear
...
- **Preferred Contact**: Flexible hours (early morning or evening), async preferred
...
- **Frequency**: Real-time alerts, weekly deep dives
...
1. **Research Phase** (1 week):
   ...
   - Data-driven comparison of options

2. **Evaluation Phase** (3-5 days):
   - Expects online onboarding
   - Reviews case studies of similar exits
   - Checks digital platform UX/UI

3. **Decision Criteria**:
   - Tech-savvy service delivery (must have dashboard)
   - Speed and efficiency (time is money)
   - Exit strategy expertise (IPO/M&A experience)
   - Modern approach (not traditional wealth management)
...
- **Evaluation**: Cal.com video consultation (prefers virtual), ROI calculator demo
- **Decision**: Data-driven proposal with clear cost-benefit analysis
...
- Diversified portfolio ready for exit proceeds
- Digital-first advisory experience

---

### Persona 3: 최진우 (Choi Jin-woo) - Service Industry CEO 【Tier 3: Door Opener Segment】
...
- **Annual Revenue**: ₩75 billion (매출 50억~100억 구간)
- **Operating Profit**: ₩5 billion (영업이익 3억~7억)
- **Net Profit**: ₩3.5 billion annually (순이익 2억 이상)
- **Retained Earnings**: ₩12 billion accumulated (이익잉여금 10억 내외)
- **Debt Ratio**: 180% (부채비율 250% 미만)
- **Employees**: 35 people
- **Location**: Seongnam, Gyeonggi-do (성남)
- **Education**: Konkuk University, Business Administration
...
2. **Financial Goals**:
   ...
   - Optimize tax-efficient compensation for family executives
3. **Business Goals**:
   - Grow to ₩100B revenue within 3 years
...
1. **노무 리스크 (Labor Risk)**:
   ...
   - Need compliance with 중대재해처벌법 (Serious Accident Punishment Act)
   - Anxious about potential CEO criminal liability

2. **가족 임원 혜택 (Family Executive Benefits)**:
   - Wife (이사/director) and son (부장/department head) are registered executives
   - Currently receiving salaries but no additional benefits
   - Want to provide health insurance and medical benefits
   - Looking for tax-efficient ways to compensate family members

3. **복지 투자 고민 (Employee Welfare Investment)**:
   - Employees requesting better welfare benefits
   - Need to expand employee benefits but don't know where to start
   - Budget constraints for comprehensive welfare program
   - Want cost-effective solutions that improve retention

4. **건강 관리 (Health Management)**:
   - CEO and family lack regular health check-ups
   - Concerned about work-life balance and health
   - Need access to premium medical services
   - Want preventive healthcare for family

5. **성장기 특유 과제 (Growth Stage Challenges)**:
   - Cash flow management during rapid growth
   - Need to professionalize HR and benefits systems
   - Balancing growth investment vs. profit margins
...
- **Preferred Contact**: 10 AM - 8 PM (flexible), KakaoTalk or phone call
...
- **Frequency**: Bi-weekly tips, urgent alerts for law changes
...
1. **Research Phase** (1 week):
   ...
   - Consult with labor consultant

2. **Evaluation Phase** (3-5 days):
   - Compare 2-3 providers based on price and coverage
   - Check customer reviews and testimonials
   - Prefer simple, transparent pricing

3. **Decision Criteria**:
   - Affordability (₩30-100만 monthly budget per criteria)
   - Ease of implementation (turnkey solutions preferred)
   - Practical benefits (visible employee satisfaction)
   - Compliance support (labor law guidance)
...
- **Evaluation**: Simple online quote (Cal.com), comparison with competitors
- **Decision**: Clear proposal with employee + family coverage breakdown
...
- **가족 혜택**: 배우자/자녀 임원 복리후생 (합법적 세제 혜택)
...
- Affordable monthly premium (₩30-100만 within budget)
- Easy claims process and quick reimbursement

---

### Persona 4: 박민수 (Park Min-soo) - Construction Contractor CEO 【Tier 1: Premium Segment】

**타겟 정의**: "돈은 많은데 세금이 무서운 장수기업" (시공사, NOT 시행사)
...
- **Annual Revenue**: ₩380 billion (매출 300억~600억 구간)
- **Operating Profit**: ₩28 billion (영업이익 20억~50억)
- **Net Profit**: ₩18 billion annually (순이익 15억 이상)
- **Retained Earnings**: ₩320 billion accumulated (이익잉여금 300억 이상)
- **Debt Ratio**: 95% (부채비율 100% 미만, conservative financing)
- **Employees**: 250 people
- **Location**: Busan (부산)
- **Education**: Hanyang University, Civil Engineering
...
2. **Financial Goals**:
   ...
   - Optimize real estate portfolio (10 properties)
   - Retirement planning (5-7 years)
3. **Business Goals**:
   - Navigate construction industry volatility
   - Protect against project failures
...
1. **가업 승계 & 자녀 진로 (Succession Planning)**:
   ...
   - 35년 일군 회사의 미래가 불투명
   - Considering selling business upon retirement in 5-7 years
   - Inheritance tax burden estimated at ₩130 billion
   - Need exit strategy that maximizes wealth preservation

2. **상속세 재원 & 부동산 집중 (Tax Funding & Real Estate)**:
   - 10 properties worth ₩180 billion (60% of total assets)
   - Cash shortage for ₩130B inheritance tax liability
   - Real estate portfolio needs liquidity planning
   - Worried about forced asset sales to pay taxes

3. **중대재해처벌법 & 산업 리스크 (Safety Law & Industry Risk)**:
   - Concerned about 중대재해처벌법 (Serious Accident Punishment Act)
   - Construction site accidents could lead to CEO criminal liability
   - Need comprehensive liability insurance and compliance
   - Exposure to project failures and contractor disputes

4. **개인 자산 보호 (Personal Asset Protection)**:
   - Personal assets tied to business guarantees and project financing
   - Worried about creditor claims in case of project failures
   - Need legal structure to separate personal and business liability
   - Estate planning to protect family wealth

5. **지역 핸디캡 (Regional Disadvantage)**:
   - Based in Busan, feels disconnected from Seoul premium services
   - Prefers face-to-face meetings but willing to travel to Seoul
   - Limited access to specialized wealth management advisors
...
- **Preferred Contact**: 10 AM - 4 PM weekdays, phone/KakaoTalk
...
- **Frequency**: Bi-weekly updates, urgent alerts for regulatory changes
...
2. **Evaluation Phase** (2 weeks):
   - Prefer in-person initial meeting (willing to travel to Seoul)
   - Review detailed proposal with wife
   - Check references from similar companies

3. **Decision Criteria**:
   - Construction industry expertise (must understand unique risks)
   - Legal and insurance knowledge (중대재해처벌법 compliance)
   - Regional service (can visit Busan or hybrid meetings)
   - Conservative approach (prefer proven strategies)
...
- **Evaluation**: Face-to-face meeting (willing to travel to Seoul), legal compliance review
- **Decision**: Comprehensive proposal with asset protection and exit strategy
...
- **명예 제공**: 건설업계 세미나 초청 강연, 산업 공헌 스토리 기록
...
- Real estate portfolio optimized
- Peace of mind about family security

---

## Secondary Personas (부차적 타겟)

### Persona 5: 정수진 (Jung Soo-jin) - CFO/재무담당자 【Influencer for Tier 1, 2 & 3】
...
- Include CFO in planning process for continuity

---

### Persona 6: 이준호 (Lee Jun-ho) - 2세 경영인 (Next-Gen Heir) 【Tier 1 Focus】
...
- Location: Seoul (returned from US 3 years ago)
...
- Build long-term relationship for future business
...
**Update Frequency**: Quarterly review, annual refresh
