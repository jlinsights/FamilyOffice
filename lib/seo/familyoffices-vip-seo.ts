...
export const FAMILYOFFICES_VIP_SEO = {
  ...
  metadataTemplate: {
    ...
    description:
      '대기업이 제공할 수 없는 진정한 개인맞춤 서비스. 독립 전문가가 직접 관리하는 중소기업 오너·개인사업자 전용 프리미엄 자산관리.',
    keywords: [
      '독립 자산관리',
      '개인맞춤 설계',
      '전문 컨설팅',
  ...
  pageConfigs: {
    home: {
      ...
      description:
        '대기업 서비스에 만족하지 못하는 분들을 위한 독립 전문가의 개인맞춤 패밀리오피스. 중소기업 오너·개인사업자 전용.',
      focusKeywords: [
        '독립 자산관리',
        '개인맞춤',
        '전문 컨설팅',
    ...
    'independent-advisory': {
      ...
      description:
        '이해상충 없는 순수한 독립 투자자문. 고객 이익만을 추구하는 투명하고 객관적인 자산관리 서비스.',
    ...
    'personalized-portfolio': {
      ...
      description:
        '획일화된 상품이 아닌 개인의 상황과 목표에 완벽히 맞춤화된 포트폴리오. 전문가가 직접 설계하고 관리.',
      focusKeywords: [
        '개인맞춤 포트폴리오',
        '맞춤화',
        '개인 상황',
    ...
    'sme-owner-services': {
      ...
      description:
        '중소기업 오너와 개인사업자를 위한 특화 서비스. 사업과 개인 자산을 통합 관리하는 맞춤형 솔루션.',
    ...
    'boutique-service': {
      ...
      description:
        '소수 고객만을 위한 프리미엄 부티크 서비스. 대기업에서 경험할 수 없는 개인적이고 세심한 관리.',
...
export function generateFamilyOfficesVIPMetadata(pageName?: string): Metadata {
  const config = pageName
    ? (FAMILYOFFICES_VIP_SEO.pageConfigs as any)[pageName]
    : null;
