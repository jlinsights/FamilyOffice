...
export class InstantAnswerSystem {
    ...
    const coreAnswers: InstantAnswer[] = [
      {
        ...
        detailedAnswer:
          '패밀리오피스는 중소중견기업 CEO와 고액자산가를 위한 종합 자산관리 서비스입니다. 가업승계, 세무최적화, 리스크 관리를 원스톱으로 제공하며, 특히 연매출 100억 이상 기업에 최적화되어 있습니다. 삼성생명의 25년 전문성과 1000억+ 운용실적을 바탕으로 맞춤형 솔루션을 제공합니다.',
      ...
      },
      {
        ...
        shortAnswer:
          '기업 규모에 따라 맞춤 견적을 제공하며, 절세 효과로 비용 이상의 가치를 창출합니다.',
        detailedAnswer:
          '가업승계 비용은 기업 규모, 자산 규모, 복잡도에 따라 차이가 있습니다. 일반적으로 상속세를 30-70% 절약할 수 있어 컨설팅 비용보다 훨씬 큰 절세 효과를 얻을 수 있습니다. 무료 상담을 통해 정확한 비용과 예상 절세 효과를 계산해드립니다.',
      ...
      },
      {
        ...
        shortAnswer:
          '증여 활용, 가업승계 특례, 경영권 프리미엄 할인 등으로 30-70% 절세 가능합니다.',
        detailedAnswer:
          '상속세 절세는 ①매년 증여공제 활용한 단계적 이전 ②가업승계 특례로 최대 90% 감면 ③경영권 프리미엄 할인 ④납부유예 제도 활용 등을 종합적으로 적용합니다. 특히 기업가치 상승 전 미리 이전하면 대폭적인 절세 효과를 얻을 수 있습니다.',
      ...
      },
      {
        ...
        shortAnswer:
          '연매출 100억 이상이라면 상당한 절세와 리스크 관리 효과를 얻을 수 있습니다.',
        detailedAnswer:
          '연매출 100억 이상 또는 자산 50억 이상의 중소중견기업이라면 패밀리오피스를 통해 ①상속세 절약 ②경영 리스크 관리 ③자산 포트폴리오 최적화 ④가업승계 체계적 준비 등의 효과를 얻을 수 있습니다. 특히 기업가치가 성장하는 시점에 시작하면 더 큰 절세 효과를 기대할 수 있습니다.',
      ...
      },
      {
        ...
        shortAnswer:
          '1000억+ 운용실적과 25년 전문성을 바탕으로 한 통합 패밀리오피스 서비스입니다.',
        detailedAnswer:
          '삼성생명은 ①국내 최대 생명보험사의 1000억+ 운용실적 ②25년간의 전문성과 노하우 ③가업승계부터 세무최적화까지 원스톱 서비스 ④300+ 성공사례 기반의 검증된 방법론 ⑤BMAD Method 기반 맞춤 전략으로 차별화됩니다.',
    ...
    const processAnswers: InstantAnswer[] = [
      {
        ...
        shortAnswer:
          '현황 분석 → 전략 수립 → 단계적 실행 → 지속 관리의 4단계로 진행됩니다.',
        detailedAnswer:
          '가업승계는 ①현황 분석(기업가치 평가, 세무 리스크 진단) ②전략 수립(절세 방안, 승계 구조 설계) ③단계적 실행(증여/상속 실행, 경영권 이전) ④지속 관리(사후 관리, 추가 최적화)의 4단계로 체계적으로 진행됩니다. 전체 과정은 통상 2-5년이 소요됩니다.',
      ...
      },
      {
        ...
        shortAnswer:
          '무료 상담 후 즉시 현황 분석을 시작하며, 보통 1-2주 내 전략 수립이 완료됩니다.',
        detailedAnswer:
          '무료 상담을 통해 현황을 파악한 후 ①1주차: 기업 및 자산 현황 분석 ②2주차: 맞춤 전략 수립 및 제안서 작성 ③3주차: 전략 확정 및 실행 계획 수립 ④4주차부터: 본격적인 실행 단계로 진입합니다. 긴급한 경우 더 빠른 진행도 가능합니다.',
    ...
    const technicalAnswers: InstantAnswer[] = [
      {
        ...
        shortAnswer:
          '일반적으로 증여세가 상속세보다 10%p 낮아 장기적으로 유리합니다.',
        detailedAnswer:
          '증여세는 상속세보다 10%p 낮은 세율을 적용받습니다. 또한 ①매년 증여공제(배우자 6억, 자녀 5천만원) ②10년 단위 리셋 ③기업가치 상승 전 이전으로 절세 효과가 큽니다. 단, 개별 상황에 따라 다르므로 정확한 세무 분석이 필요합니다.',
      ...
      },
      {
        ...
        detailedAnswer:
          '한국 세법상 거주자는 국내외 모든 자산이 상속세 과세 대상입니다. 다만 ①외국에서 납부한 세금은 공제 ②조세조약으로 이중과세 방지 ③적절한 구조 설계로 세부담 최적화가 가능합니다. 해외 자산 보유 시 사전 세무 계획이 매우 중요합니다.',
  ...
  private calculateSimilarity(query: string, answer: InstantAnswer): number {
    ...
    // 질문 제목과의 유사도 (40% 가중치)
    const questionScore = this.tokenOverlap(
      queryTokens,
      answer.question.toLowerCase().split(' ')
    );
    ...
    // 답변 내용과의 유사도 (25% 가중치)
    const contentScore = this.tokenOverlap(
      queryTokens,
      answer.shortAnswer.toLowerCase().split(' ')
    );
  ...
  public formatForAI(
    ...
    aiEngine: 'chatgpt' | 'perplexity' | 'claude'
  ): string {
    switch (aiEngine) {
      case 'chatgpt':
...
${answer.actionCall}`;
  ...
  // 카테고리별 답변 조회
  public getAnswersByCategory(
    category: InstantAnswer['category']
  ): InstantAnswer[] {
