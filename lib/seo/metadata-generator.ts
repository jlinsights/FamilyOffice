...
export const PAGE_SEO_CONFIGS: Record<string, SEOConfig> = {
  home: {
    ...
    description:
      '중견기업 CEO를 위한 전문 패밀리오피스 서비스. 기업승계, 자산관리, 세무최적화, 리스크관리를 한번에. 삼성생명 30년 경험의 전문가들이 맞춤형 솔루션을 제공합니다.',
    keywords: [
      '패밀리오피스',
      '자산관리서비스',
      '삼성생명',
  ...
  services: {
    ...
    description:
      '고액자산가를 위한 종합 자산관리 서비스. 포트폴리오 관리, 투자자문, 세무 컨설팅, 보험설계까지 원스톱 서비스로 제공합니다.',
    keywords: [
      '자산관리서비스',
      '프라이빗뱅킹',
      '포트폴리오관리',
  ...
  businessSuccession: {
    ...
    description:
      '성공적인 기업승계를 위한 전략 컨설팅. 승계 계획 수립부터 세무 최적화, 경영권 이전까지 체계적으로 지원합니다.',
    keywords: [
      '기업승계',
      '가업승계',
      '승계계획',
  ...
  taxStrategy: {
    ...
    description:
      '상속세, 증여세 절세를 위한 전문 세무 컨설팅. 합법적인 절세 전략으로 세무 리스크를 최소화하고 자산 보전을 실현합니다.',
  ...
  blog: {
    ...
    description:
      '자산관리 전문가들의 인사이트와 시장 분석을 제공합니다. 투자 전략, 세무 팁, 시장 동향까지 전문 정보를 확인하세요.',
  ...
  education: {
    ...
    description:
      'CEO와 차세대 경영진을 위한 전문 자산관리 교육. 실무 중심의 커리큘럼으로 체계적인 자산관리 역량을 키워보세요.',
    keywords: [
      'CEO 자산관리 교육',
      '차세대 경영진 교육',
      '자산관리교육',
