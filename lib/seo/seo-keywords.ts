...
export const targetKeywords: Record<string, KeywordData> = {
  ...
  taxPlan: {
    ...
    metaDescription:
      '성공한 기업가를 위한 맞춤형 절세플랜. 법인세·소득세·상속세 통합 최적화로 세금 40% 절감. 전문가 무료 진단으로 최적 절세전략 설계.',
    localRelevance: 9,
  ...
  familyCorporation: {
    ...
    metaDescription:
      '가족법인으로 상속세 50% 절감! 설립부터 운영, 세무관리까지 완벽 가이드. 전문가 상담으로 최적 가족법인 구조 설계. 성공사례 200+건 보유.',
    localRelevance: 9,
  ...
  policyFunding: {
    ...
    metaDescription:
      '정책자금 신청 성공률 95%! 연 1.5~3.5% 저금리 대출, 보조금 신청까지. 전문가가 최적 정책자금 매칭. 무료 상담으로 즉시 확인.',
  },
  ...
  businessCertification: {
    ...
    metaDescription:
      '기업인증으로 세제혜택 극대화! 벤처기업, 이노비즈, ISO 인증별 혜택 비교. 정책자금 우대, 세액공제까지. 전문가 무료 컨설팅.',
  },
  ...
  businessSuccession: {
    ...
    metaDescription:
      '가업승계 성공률 95% 달성! 세금 40% 절감, 경영권 안정화, 차세대 교육까지. 300개 기업 성공사례 기반 맞춤형 가업승계 로드맵. 무료 진단 서비스 제공',
  },
  ...
  inheritanceGift: {
    ...
    metaDescription:
      '상속세 50% 절감 가능! 전문가가 알려주는 상속증여 완벽 절세 전략. 계산기 제공, 무료 세무 상담, 성공사례 300+건. 지금 바로 확인하세요.',
  },
  ...
  corporateCertification: {
    ...
    metaDescription:
      '벤처기업, 이노비즈, ISO 등 기업인증 완벽 가이드. 인증별 혜택 비교, 신청 절차, 준비사항까지. 정책자금 우대, 세제혜택 최대화 방법 공개.',
  },
  ...
  policyFunds: {
    ...
    metaDescription:
      '중소기업 정책자금 완벽 가이드. 연 1.5~3.5% 저금리 대출, 보조금 신청방법, 자격요건, 신청절차까지. 전문가 무료 상담으로 최적 자금 매칭.',
  },
  ...
  samsungLife: {
    ...
    metaDescription:
      '삼성생명 1000억+ 검증된 운용실적. 프리미엄 패밀리오피스 서비스, 전문 컨설턴트 네트워크, VVIP 고객 전용 혜택을 확인하세요.',
  },
  ...
  samsungGFC: {
    ...
    metaDescription:
      '삼성생명 GFC(기업재무컨설턴트) 채용. 연봉 상위 1%, 전문 교육, 프리미엄 고객 매칭. 경력자 우대, 즉시 상담 가능. 성공한 미래를 설계하세요.',
  },
  ...
  samsungFire: {
    ...
    metaDescription:
      '삼성화재 기업보험 완벽 가이드. 중대재해처벌법 대응보험, 임원배상책임보험, 영업배상책임보험 등 기업 리스크 완전 보장.',
  },
  ...
  seriousAccidentLaw: {
    ...
    metaDescription:
      '중대재해처벌법 완벽 대응 가이드. 안전관리체계 구축, 경영책임자 보험, 법적 리스크 완전 차단. 전문가 무료 진단으로 완벽한 준비를.',
  },
  ...
  groupInsurance: {
    ...
    metaDescription:
      '임직원 단체보험 완벽 설계. 복리후생비 100% 손금처리, 직원 비과세 혜택, 사기 진작 효과까지. 맞춤형 단체보험 설계 상담.',
  },
  ...
  keyPersonInsurance: {
    ...
    metaDescription:
      '경영인정기보험으로 기업 핵심인물 리스크 완전 보장. 사망·질병 시 기업 손실 보상, 보험료 손금처리, 해약환급금 활용. 맞춤 설계 상담.',
  },
  ...
  healthInsurance: {
    ...
    metaDescription:
      '기업 맞춤형 건강보험 솔루션. 임직원 건강관리, 의료비 절감, 복리후생 개선까지. 기업과 직원 모두 만족하는 건강보험 설계.',
  },
};
...
export function calculateSEOScore(
  ...
  if (density < 1) {
    suggestions.push(
      `키워드 "${targetKeyword}" 사용 빈도를 늘려주세요 (현재: ${density.toFixed(1)}%)`
    );
  } else if (density > 5) {
    suggestions.push(
      `키워드 "${targetKeyword}" 사용을 줄여주세요. 과도한 키워드 스터핑 위험 (현재: ${density.toFixed(1)}%)`
    );
  } else {
    score += 20;
  }
  ...
  if (
    h1Match &&
    h1Match[1]?.toLowerCase().includes(targetKeyword.toLowerCase())
  ) {
    score += 25;
  } else {
  ...
  if (metaDesc && metaDesc[1]) {
    ...
    if (descLength >= 120 && descLength <= 160) {
      ...
      suggestions.push(
        `메타 설명 길이를 120-160자로 조정해주세요 (현재: ${descLength}자)`
      );
    }
  }
  ...
  if (contentLength >= 1000) {
    ...
    suggestions.push(
      `콘텐츠 길이를 늘려주세요 (현재: ${contentLength}자, 권장: 1000자 이상)`
    );
  }
...
export function calculateKeywordPriority(
  ...
  const difficultyScore =
    difficulty === 'low' ? 30 : difficulty === 'medium' ? 20 : 10;
  const valueScore =
    businessValue === 'high' ? 30 : businessValue === 'medium' ? 20 : 10;
...
export function getContentRecommendations(currentKeywords: string[]): {
  ...
  const missingPages = allTargetKeywords.filter(
    keyword => !currentKeywords.includes(targetKeywords[keyword]?.primary || '')
  );
  ...
  const opportunityKeywords = aiSearchKeywords.filter(
    keyword => !currentKeywords.some(current => keyword.includes(current))
  );
