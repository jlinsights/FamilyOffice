...
export const SAMSUNGLIFE_VIP_SEO = {
  ...
  metadataTemplate: {
    ...
    description:
      '대기업부터 중견기업까지, 삼성생명과 함께하는 기업 전용 프리미엄 금융 서비스. 기업보험·법인세절감·경영진보장·승계계획 통합 솔루션 제공.',
    keywords: [
      '삼성생명 기업서비스',
      '법인보험 전문',
      '기업 자산관리',
  ...
  pageConfigs: {
    home: {
      title: '삼성생명 VIP | 기업 전용 프리미엄 금융 솔루션',
      description:
        '대기업·중견기업 CEO를 위한 삼성생명 VIP 서비스. 기업보험·법인세절감·경영진보장·승계계획 통합 솔루션.',
    ...
    'corporate-insurance': {
      ...
      description:
        '기업재해보장보험부터 경영진보장보험까지. 삼성생명의 노하우로 기업 리스크를 완벽 관리하는 맞춤형 보험 솔루션.',
    ...
    'tax-optimization': {
      ...
      description:
        '합법적 법인세 절감부터 기업 세무 최적화까지. 삼성생명 세무 전문가가 제공하는 기업 맞춤형 절세 전략.',
    ...
    'succession-planning': {
      ...
      description:
        '안정적인 경영권 승계부터 가업승계까지. 삼성생명이 설계하는 체계적인 기업 승계 솔루션.',
    ...
    'enterprise-services': {
      ...
      description:
        '대기업 계열사부터 상장기업까지. 규모와 복잡성을 이해하는 삼성생명의 기업 전용 프리미엄 서비스.',
...
export function generateSamsungLifeVIPMetadata(pageName?: string): Metadata {
  const config = pageName
    ? (SAMSUNGLIFE_VIP_SEO.pageConfigs as any)[pageName]
    : null;
