...
export const NAVER_BLOG_CONFIG: NaverBlogConfig = {
  personalBlog: {
    ...
    blogId: 'lim_jaehong',
    name: '패밀리오피스 전문가 임재홍',
    description: '15년 경험의 패밀리오피스 전문가가 전하는 가업승계, 절세전략, 자산관리 실무 노하우',
    categories: [
      '가업승계 전략',
      '절세 노하우',
      '법인세무 가이드',
    ...
    contentStrategy: '실무 중심의 전문 콘텐츠, 사례 기반 가이드, 정책 변화 실시간 업데이트'
  },
...
export const CONTENT_MAPPING_STRATEGY = {
  ...
  siteToPersonalBlog: {
    ...
    '/program': {
      ...
      description: '성공적인 가업승계를 위한 단계별 교육 프로그램을 안내합니다.'
    },
    '/blog': {
...
export class NaverBlogIntegration {
  static generateBlogPost(siteContent: any, targetPlatform: 'personal' | 'premium') {
