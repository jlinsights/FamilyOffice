      ...
      'samsunglife.vip': [
        {
          ...
          content:
            '기업 규모와 개인 선호에 따른 최적의 자산관리 서비스 선택 가이드',
  ...
  seoSynergy: {
    ...
    structuredDataLinking: {
      organization: {
        ...
        sameAs: ['https://samsunglife.vip', 'https://familyoffices.vip'],
        department: [
          {
            '@type': 'Organization',
...
// 통합 SEO 스코어 계산
export function calculateCombinedSEOScore(
  domain1Metrics: any,
  domain2Metrics: any
) {
  return {
    combinedAuthority:
      (domain1Metrics.authority + domain2Metrics.authority) * 0.7,
    crossLinkValue:
      domain1Metrics.internalLinks * domain2Metrics.internalLinks * 0.1,
    keywordCoverage:
      (domain1Metrics.keywordCount + domain2Metrics.keywordCount) * 0.8,
