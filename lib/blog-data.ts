...
<div className="backdrop-blur-sm bg-slate-100/80 dark:bg-slate-800/80 border-2 border-slate-300/50 dark:border-slate-600/50 p-6 rounded-2xl my-10 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-slate-100/90 dark:hover:bg-slate-800/90">
  ...
  'deposit-protection-update': {
    id: 'deposit-protection-update',
    title: '예금자보호 한도 1억원 상향 조정 안내',
    excerpt: '2025년 9월 1일부터 예금자보호 한도가 기존 5천만원에서 1억원으로 상향됩니다. FamilyOffice S가 고객님의 자산 보호를 위해 변경사항과 대응 전략을 상세히 안내드립니다.',
    content: `<div className="font-sans leading-relaxed max-w-4xl mx-auto text-base text-foreground bg-background px-5">

<header className="text-center mb-10 py-8 border-b-4 border-primary">
    <h1 className="text-primary mb-4 text-3xl md:text-4xl font-bold leading-tight">2025년 9월 1일부터 예금자보호 한도 상향(1억) 안내</h1>
    <p className="text-muted-foreground text-lg font-normal leading-relaxed">고객의 혼란이 발생하지 않도록 9/1일부터는 예금자보호 한도가 1억으로 기재된 안내자료를 활용하여 설명하시기 바랍니다.</p>
    <div className="mt-5 text-muted-foreground text-sm">
        <strong>FamilyOffice S</strong> 공식 발표 | 2025년 8월 22일 | 중요 공지사항
    </div>
</header>

<div className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground p-8 rounded-2xl mb-10">
    <h2 className="text-primary-foreground mb-5 text-xl font-bold">📢 중요 공지사항</h2>
    <div className="bg-white/10 dark:bg-black/20 p-5 rounded-xl">
        <p className="text-primary-foreground text-base leading-relaxed font-semibold mb-3">
            예금자보호법 개정에 따라 2025년 9월 1일부터 예금자보호 한도가 기존 5천만원에서 1억원으로 상향 조정됩니다.
        </p>
        <p className="text-primary-foreground text-sm leading-relaxed">
            본 변경사항은 모든 금융기관의 예금보험 대상 금융상품에 동일하게 적용되며, FamilyOffice S는 고객님의 자산 보호를 위해 사전에 충분한 안내와 대비책을 마련하였습니다.
        </p>
    </div>
</div>

<section className="mb-12">
    <h2 className="text-slate-800 dark:text-slate-200 mb-6 text-2xl font-bold border-b-2 border-slate-200 dark:border-slate-700 pb-3">📊 주요 변경사항 Q&A</h2>
    
    <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 p-6 rounded-xl mb-6">
        <h3 className="text-blue-800 dark:text-blue-200 mb-4 text-lg font-semibold">Q. 예금보호 한도 1억원은 언제부터, 어떻게 적용되나요?</h3>
        <div className="bg-white dark:bg-slate-900 p-5 rounded-lg">
            <p className="text-slate-700 dark:text-slate-300 text-base leading-relaxed mb-3">
                <strong>가입시점</strong>에 상관없이, <strong className="text-blue-600 dark:text-blue-400">'25.9.1 이전에 가입한 상품도 1억원까지 보호됩니다.</strong>
            </p>
            <div className="bg-blue-100 dark:bg-blue-800/30 p-4 rounded-lg">
                <p className="m-0 text-sm text-blue-800 dark:text-blue-200">
                    ✅ 2025년 9월 1일 이전 가입 상품도 자동으로 1억원까지 보호<br/>
                    ✅ 별도의 추가 절차나 신청 없이 자동 적용
                </p>
            </div>
        </div>
    </div>
    ...
    <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 p-6 rounded-xl mb-6">
        <h3 className="text-green-800 dark:text-green-200 mb-4 text-lg font-semibold">Q. 보험계약은 어떻게 보호되나요?</h3>
        <div className="bg-white dark:bg-slate-900 p-5 rounded-lg">
            <p className="text-slate-700 dark:text-slate-300 text-base leading-relaxed mb-3">
                <strong className="text-green-600 dark:text-green-400">해약환급금이 1억원까지 보호됩니다.</strong> 만약 사고보험금이 있다면 해약환급금과 별도로 <strong className="text-green-600 dark:text-green-400">사고보험금도 1억원까지 보호됩니다.</strong>
            </p>
            <div className="bg-green-100 dark:bg-green-800/30 p-4 rounded-lg">
                <ul className="m-0 pl-5 text-sm text-green-800 dark:text-green-200">
                    <li className="mb-2">해약환급금: 최대 1억원 보호</li>
                    <li className="mb-2">사고보험금: 해약환급금과 별도로 최대 1억원 보호</li>
                    <li>총 보호한도: 최대 2억원까지 가능</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 p-6 rounded-xl mb-6">
        <h3 className="text-amber-800 dark:text-amber-200 mb-4 text-lg font-semibold">Q. 별도로 필요한 절차가 있나요?</h3>
        <div className="bg-white dark:bg-slate-900 p-5 rounded-lg">
            <p className="text-slate-700 dark:text-slate-300 text-base leading-relaxed mb-3">
                별도 신청 없이 계약을 유지하고 있는 <strong className="text-amber-600 dark:text-amber-400">모든 고객에게 9월1일 이후 자동으로 상향된 예금보호한도가 적용됩니다.</strong>
            </p>
            <div className="bg-amber-100 dark:bg-amber-800/30 p-4 rounded-lg">
                <p className="m-0 text-sm text-amber-800 dark:text-amber-200 font-semibold">
                    📌 고객님께서 하실 일: 없음 (자동 적용)
                </p>
            </div>
        </div>
    ...
    <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 p-6 rounded-xl">
        <h3 className="text-purple-800 dark:text-purple-200 mb-4 text-lg font-semibold">Q. 5천만원 표기된 자료는 언제까지 사용할 수 있나요?</h3>
        <div className="bg-white dark:bg-slate-900 p-5 rounded-lg">
            <p className="text-slate-700 dark:text-slate-300 text-base leading-relaxed mb-3">
                한도 상향은 9월1일입니다. 고객이 오해하는 일이 없도록 <strong className="text-purple-600 dark:text-purple-400">8월31일까지는 5천만원으로 표기된 자료를 사용해주세요.</strong>
            </p>
            <div className="bg-purple-100 dark:bg-purple-800/30 p-4 rounded-lg">
                <ul className="m-0 pl-5 text-sm text-purple-800 dark:text-purple-200">
                    <li className="mb-2">~8월 31일: 5천만원 표기 자료 사용</li>
                    <li>9월 1일~: 1억원 표기 자료 사용 (FamilyOffice S에서 제공)</li>
                </ul>
            </div>
        </div>
    </div>
...
<section className="mb-12">
    <h2 className="text-slate-800 dark:text-slate-200 mb-6 text-2xl font-bold border-b-2 border-slate-200 dark:border-slate-700 pb-3">📌 중요 안내사항</h2>
    
    <div className="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 p-6 rounded-r-xl">
        <p className="text-red-800 dark:text-red-200 text-base leading-relaxed font-semibold mb-3">
            ※ 예금보호한도 상향을 사유로 개인·신용정보를 요구하는 전화·문자 등은 금융사기이므로 주의하시기 바랍니다.
        </p>
        <p className="m-0 text-red-700 dark:text-red-300 text-sm">
            예금자보호 한도 상향 적용을 위해 별도의 개인정보나 계좌정보를 요구하는 경우는 없습니다. 의심스러운 연락을 받으시면 즉시 FamilyOffice S 고객센터로 문의해 주시기 바랍니다.
        </p>
    </div>
</section>

<section className="mb-12">
    <h2 className="text-slate-800 dark:text-slate-200 mb-6 text-2xl font-bold border-b-2 border-slate-200 dark:border-slate-700 pb-3">💼 FamilyOffice S의 대응 전략</h2>
    
    <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 p-8 rounded-2xl">
        <h3 className="text-slate-800 dark:text-slate-200 mb-6 text-xl font-semibold">고객 자산 보호를 위한 3단계 전략</h3>
        
        <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-blue-500 text-white rounded-full flex items-center justify-center mb-4 font-bold text-lg">1</div>
                <h4 className="text-slate-800 dark:text-slate-200 mb-3 font-semibold">포트폴리오 재구성</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm">
                    상향된 보호한도를 활용한 최적의 자산 배분 전략 수립
                </p>
            </div>
            
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center mb-4 font-bold text-lg">2</div>
                <h4 className="text-slate-800 dark:text-slate-200 mb-3 font-semibold">리스크 관리 강화</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm">
                    금융기관별 분산 투자 전략 재검토 및 조정
                </p>
            </div>
            
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-green-500 text-white rounded-full flex items-center justify-center mb-4 font-bold text-lg">3</div>
                <h4 className="text-slate-800 dark:text-slate-200 mb-3 font-semibold">맞춤형 컨설팅</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm">
                    개별 고객의 자산 규모와 투자 성향에 따른 1:1 상담
                </p>
            </div>
        </div>
    </div>
...
<section className="mb-12">
    <h2 className="text-slate-800 dark:text-slate-200 mb-6 text-2xl font-bold border-b-2 border-slate-200 dark:border-slate-700 pb-3">📞 문의 및 상담</h2>
    
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-900/30 p-8 rounded-2xl text-center">
        <h3 className="text-slate-800 dark:text-slate-200 mb-4 text-xl font-semibold">FamilyOffice S 고객 지원</h3>
        <p className="text-slate-600 dark:text-slate-400 mb-6">
            예금자보호 한도 상향과 관련된 궁금하신 사항이나<br/>
            맞춤형 자산관리 상담을 원하시는 경우 언제든지 문의해 주세요.
        </p>
        
        <div className="inline-flex flex-col gap-3 text-left">
            <div className="flex items-center gap-3">
                <span className="text-blue-600 dark:text-blue-400 font-semibold">전화:</span>
                <span className="text-slate-700 dark:text-slate-300">502-5550-8700</span>
            </div>
            <div className="flex items-center gap-3">
                <span className="text-blue-600 dark:text-blue-400 font-semibold">이메일:</span>
                <span className="text-slate-700 dark:text-slate-300">cs@familyoffices.vip</span>
            </div>
            <div className="flex items-center gap-3">
                <span className="text-blue-600 dark:text-blue-400 font-semibold">운영시간:</span>
                <span className="text-slate-700 dark:text-slate-300">평일 09:00 - 18:00</span>
            </div>
        </div>
    </div>
</section>
