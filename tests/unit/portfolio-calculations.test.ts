...
describe('Portfolio Calculations', () => {
  ...
  describe('Position Value Calculations', () => {
    ...
    test('should calculate position value correctly', () => {
      ...
      expect(value).toBe(18000.00)
    })
    
    test('should return 0 for invalid position data', () => {
      const invalidPositions = [
        { symbol: 'AAPL', shares: 0, averagePrice: 150, currentPrice: 180, currency: 'USD' },
        { symbol: 'AAPL', shares: -100, averagePrice: 150, currentPrice: 180, currency: 'USD' },
        { symbol: 'AAPL', shares: 100, averagePrice: 150, currentPrice: 0, currency: 'USD' },
        { symbol: 'AAPL', shares: 100, averagePrice: 150, currentPrice: -180, currency: 'USD' }
      ]
    ...
    test('should calculate position cost correctly', () => {
      ...
      expect(cost).toBe(10000.00)
    })
    
    test('should return 0 for invalid cost calculation', () => {
      const invalidPositions = [
        { symbol: 'TSLA', shares: 0, averagePrice: 200, currentPrice: 250, currency: 'USD' },
        { symbol: 'TSLA', shares: 50, averagePrice: 0, currentPrice: 250, currency: 'USD' },
        { symbol: 'TSLA', shares: -50, averagePrice: 200, currentPrice: 250, currency: 'USD' }
      ]
  ...
  describe('Unrealized Gain Calculations', () => {
    ...
    test('should round gain and gain percent correctly', () => {
      ...
      expect(result.gainPercent).toBeCloseTo(10.0110, 4) // Rounded to 4 decimal places
    })
  })
  ...
  describe('Portfolio Value and Allocation', () => {
    ...
    const testPositions: Position[] = [
      { symbol: 'AAPL', shares: 100, averagePrice: 150, currentPrice: 180, currency: 'USD' },
      { symbol: 'TSLA', shares: 50, averagePrice: 200, currentPrice: 250, currency: 'USD' },
      { symbol: '005930.KS', shares: 500, averagePrice: 70000, currentPrice: 75000, currency: 'KRW' }
    ]
    ...
    test('should calculate portfolio allocation correctly', () => {
      ...
      expect(allocation['005930.KS']).toBeCloseTo((37500000 / totalValue) * 100, 2)
  ...
  describe('Portfolio Metrics', () => {
    ...
    const testPositions: Position[] = [
      { symbol: 'AAPL', shares: 100, averagePrice: 150, currentPrice: 180, currency: 'USD' },
      { symbol: 'TSLA', shares: 50, averagePrice: 200, currentPrice: 220, currency: 'USD' }
    ]
    ...
    test('should calculate day change when previous value provided', () => {
      ...
      const metrics = calculatePortfolioMetrics(testPositions, 5000, previousValue)
    ...
    test('should handle zero total cost', () => {
      const freePositions: Position[] = [
        { symbol: 'FREE', shares: 100, averagePrice: 0, currentPrice: 10, currency: 'USD' }
      ]
  ...
  describe('Return Calculations', () => {
    ...
    test('should calculate annualized return correctly', () => {
      ...
      const annualizedReturn = calculateAnnualizedReturn(startValue, endValue, years)
  ...
  describe('Risk Metrics', () => {
    ...
    test('should calculate Sharpe ratio correctly', () => {
      ...
      const sharpeRatio = calculateSharpeRatio(portfolioReturn, riskFreeRate, volatility)
  ...
  describe('Beta and Alpha Calculations', () => {
    ...
    test('should calculate alpha correctly', () => {
      ...
      const alpha = calculateAlpha(portfolioReturn, riskFreeRate, beta, benchmarkReturn)
  ...
  describe('Performance Metrics Integration', () => {
    ...
    test('should calculate comprehensive performance metrics', () => {
      ...
      const metrics = calculatePerformanceMetrics(portfolioValues, benchmarkValues, riskFreeRate)
  ...
  describe('Portfolio Rebalancing', () => {
    ...
    test('should calculate rebalancing requirements correctly', () => {
      ...
      const rebalancing = calculateRebalancing(currentAllocation, targetAllocation, totalValue, threshold)
    ...
    test('should handle missing current allocation', () => {
      ...
      const rebalancing = calculateRebalancing(currentAllocation, targetAllocation, totalValue)
