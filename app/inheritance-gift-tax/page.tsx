...
const deductionLimits = {
  inheritance: {
    basic: { title: '기초공제', amount: 200000000, description: '상속인 수에 관계없이 2억원' },
    spouse: { title: '배우자공제', amount: 600000000, description: '최소 5억원, 실제 상속분의 한도 내에서 최대 30억원' },
    child: { title: '자녀공제', amount: 50000000, description: '미성년자 1인당 5천만원, 미성년자는 연령에 따라 추가' },
    other: { title: '기타 인적공제', amount: 50000000, description: '직계존속, 장애인, 고령자 각 5천만원' },
    funeral: { title: '장례비', amount: 5000000, description: '실제 소요된 금액, 최대 500만원' },
    debt: { title: '채무부담', amount: 0, description: '사실상 상속인이 부담하는 피상속인의 채무' }
  },
  gift: {
    spouse: { title: '배우자', amount: 600000000, description: '10년간 6억원' },
    child: { title: '직계비속(자녀)', amount: 50000000, description: '10년간 5천만원(미성년자 2천만원)' },
    parent: { title: '직계존속(부모)', amount: 50000000, description: '10년간 5천만원' },
    other: { title: '기타 친족', amount: 10000000, description: '10년간 1천만원' },
...
const frequentQuestions = [
  {
    ...
    answer: '피상속인이 상속 개시일 현재 소유하고 있던 모든 재산(금전으로 환가할 수 있는 경제적 가치가 있는 모든 것)이 상속세 과세대상입니다. 여기에는 현금, 예금, 부동산, 유가증권, 골프회원권 등이 포함됩니다.',
    tags: ['기본개념', '과세대상']
  },
  {
    category: '상속세 신고',
    question: '상속세 신고는 언제까지 해야 하나요?',
    answer: '상속개시일이 속하는 달의 말일로부터 6개월 이내에 납세지 관할세무서에 신고·납부해야 합니다. 3개월의 연장 신청이 가능하며, 정당한 사유가 있는 경우 승인됩니다.',
    tags: ['신고기한', '연장신청']
  },
  {
    category: '증여세 기본',
    question: '증여세 신고대상은 어떻게 되나요?',
    answer: '증여받은 재산가액에서 증여재산공제를 차감한 과세표준이 있는 경우 신고해야 합니다. 배우자 6억원, 직계비속 5천만원(미성년자 2천만원), 직계존속 5천만원, 기타 친족 1천만원, 타인 500만원의 공제한도가 있습니다.',
    tags: ['신고대상', '공제한도']
  },
  {
    category: '증여 추정',
    question: '증여추정이란 무엇인가요?',
    answer: '직계존비속, 형제자매, 배우자 등 특수관계자 간에 재산을 무상 또는 현저히 낮은 대가로 양도하거나 경제적 이익을 제공한 경우 증여로 추정하는 제도입니다. 부동산 양도, 금전 대여, 채무 면제 등이 해당됩니다.',
    tags: ['증여추정', '특수관계']
  },
  {
    category: '재산평가',
    question: '상속재산은 어떻게 평가하나요?',
    answer: '상속개시일 현재의 시가로 평가하는 것이 원칙입니다. 시가를 확인하기 어려운 경우에는 ①감정평가액 ②매매사례가액 ③공시지가 등의 기준으로 평가하며, 이도 없으면 ④국세청 고시가액을 적용합니다.',
    tags: ['재산평가', '시가산정']
  },
  {
    category: '공제제도',
    question: '상속세 기초공제 2억원은 언제부터 적용되나요?',
    answer: '2013년 1월 1일 이후 발생한 상속분부터 기초공제가 2억원으로 적용됩니다. 이전에는 5억원이었으나, 세수 확보를 위해 인하되었습니다. 다만 다른 인적공제와 함께 활용하면 실질적인 공제 효과를 극대화할 수 있습니다.',
    tags: ['기초공제', '공제변경']
  },
  {
    category: '납부방법',
    question: '상속세를 분납할 수 있나요?',
    answer: '상속세(증여세 포함) 납부세액이 2천만원을 초과하고, 금전납부가 곤란한 사유가 있는 경우 최대 5년에 걸쳐 분할납부할 수 있습니다. 분납기간 중에는 연 4.6%의 이자상당액(연부이자)을 납부해야 합니다.',
    tags: ['분납제도', '연부이자']
  },
  {
    category: '절세전략',
    question: '합법적인 상속세 절세방법은?',
    answer: '①생전증여를 통한 재산의 사전 이전 ②가업상속공제 활용 ③공익법인 출연 ④가족신탁 설립 ⑤적정한 보험 활용 등이 있습니다. 단, 조세회피 목적의 편법은 증여의제, 부당행위계산 부인 등으로 과세될 수 있어 전문가 상담이 필요합니다.',
    tags: ['절세방법', '합법적절세']
  }
];
        ...
        <section className="py-12 px-4" id="self-check">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-2">승계·증여 자가진단</h2>
              <p className="text-lg text-muted-foreground">점수 기반으로 권장 플랜을 안내해 드립니다</p>
            </div>
            <SelfCheckSuccession />
          </div>
        </section>
                  ...
                  <CardContent>
                      ...
                      {inheritanceTaxRates.map((rate, index) => (
                        <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-muted-foreground">과세표준</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-primary">{rate.rate}%</div>
                            <div className="text-sm text-muted-foreground">세율</div>
                          </div>
                          <div className="w-32">
                    ...
                    <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg">
                      <p className="text-sm text-yellow-800 dark:text-yellow-200">
                        ...
                        상속세는 초과누진세율이 적용되므로 구간별로 다른 세율이 적용됩니다.
                      </p>
                    </div>
                  </CardContent>
                </Card>
        ...
        <section className="py-12 px-4 bg-muted/30">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              {Object.entries(taxCalculator.inheritance).map(([key, scenario]) => (
                <Card key={key} className="bg-card text-card-foreground border border-border">
                    <CardHeader>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            {(scenario.totalAssets / 100000000).toFixed(0)}억원
                          </span>
                        </div>
                        <div className="space-y-2 pl-4 border-l-2 border-muted">
                          {Object.entries(scenario.deductions).map(([deductionKey, amount]) => (
                            <div key={deductionKey} className="flex justify-between text-sm">
                              <span className="text-muted-foreground">
                                {deductionKey === 'basic' ? '기초공제' : 
                                 deductionKey === 'spouse' ? '배우자공제' : 
                                 deductionKey === 'children' ? '자녀공제' : '장례비'}
                              </span>
                              <span>-{(amount / 100000000).toFixed(1)}억원</span>
                            </div>
                          ))}
                        </div>
                        <div className="flex justify-between border-t pt-2">
                          <span>과세표준</span>
                          <span className="font-semibold">
                            {(scenario.taxableAmount / 100000000).toFixed(1)}억원
                          </span>
                        </div>
                        <div className="flex justify-between font-bold text-lg text-red-600 dark:text-red-400">
                          <span>납부할 세액</span>
                          <span>{(scenario.tax / 100000000).toFixed(2)}억원</span>
                        </div>
                        <div className="text-center">
                ...
                <Card key={key} className="bg-card text-card-foreground border border-border">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between">
                          <span>증여공제</span>
                          <span>-{(scenario.deduction / 100000000).toFixed(1)}억원</span>
                        </div>
                        <div className="flex justify-between border-t pt-2">
                          <span>과세표준</span>
                          <span className="font-semibold">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                개별 세무 전략에서 <span className="font-bold text-premium-navy">통합 자산관리 솔루션</span>으로 업그레이드하세요.
                자산가와 성공한 기업가들이 선택한 차별화된 패밀리오피스 서비스를 경험해보세요.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-card text-card-foreground rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <h4 className="font-bold text-lg mb-2 text-premium-navy">가족 자산 통합관리</h4>
                  <p className="text-muted-foreground text-sm">개인자산 30억원 이상 고액자산가를 위한 종합 자산관리 서비스</p>
                </div>
                ...
                <div className="bg-card text-card-foreground rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <h4 className="font-bold text-lg mb-2 text-premium-navy">가업승계 Excellence</h4>
                  <p className="text-muted-foreground text-sm">체계적인 승계 전략으로 상속세 50% 절감과 경영권 안정화</p>
                </div>
                ...
                <div className="bg-card text-card-foreground rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <h4 className="font-bold text-lg mb-2 text-premium-navy">전용 전문가 팀</h4>
                  <p className="text-muted-foreground text-sm">세무·법무·투자 전문가가 함께하는 원스톱 VIP 서비스</p>
                </div>
              </div>
                ...
                <div className="text-center space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground">
                      복잡한 상속·증여세 제도, 전문가와 함께 최적의 절세 전략을 수립하세요
                    </p>
                  </div>
