...
export const metadata: Metadata = {
  ...
  description:
    '중소중견기업 법인 대표님들이 자주 묻는 자산관리, 세무, 보험 관련 질문과 답변. 업종별 맞춤 솔루션 FAQ',
  keywords:
    '중소중견기업 FAQ, 법인 자산관리 질문, 중대재해처벌법 FAQ, 가족법인 FAQ, 승계 설계 질문',
};
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                법인 대표님들의 <span className="text-primary">실제 고민</span>
                과 해결책
              </h2>

              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                중소중견기업 전문 자산관리 노하우로 정리한 가장 빈번한 고민들과
                FamilyOffice S의 해결 방안
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground bg-primary-foreground/5"
                asChild
              >
