                ...
                <FormControl>
                  ...
                  >
                    {[
                      ...
                      {
                        value: 'art_tour',
                        label: '전시/아트 투어 (도슨트/프리뷰)',
                      },
                      {
                        value: 'family_office_meeting',
                        label: '패밀리오피스 미팅 (자산/승계)',
                      },
                      {
                        value: 'network_inquiry',
                        label: '네트워크/라운드테이블 문의',
                      },
                      { value: 'other', label: '기타 (직접 기재)' },
                    ].map(item => (
                      <FormItem
                        key={item.value}
                        className="flex items-center space-x-3 space-y-0 border rounded-lg p-4 hover:bg-muted/50 transition-colors cursor-pointer data-[state=checked]:border-primary data-[state=checked]:bg-primary/5"
                      >
                        <FormControl>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    희망 날짜/시간 <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      placeholder="예: 5월 15일 저녁 7시 / 8월 중순"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="예: 오늘 18시까지 / 이번 주 금요일까지"
                      {...field}
                    />
                  </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="예: 조용한 공간 필요, 계단 이용 불가, 휠체어 등"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <section className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="예: 1인당 20만원 / 총 500만원 상한"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    회신 받을 곳 <span className="text-red-500">*</span>
                  </FormLabel>
                  <Select
                    onValueChange={field.onChange}
                    defaultValue={field.value}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  연락처/이메일 상세 <span className="text-red-500">*</span>
                </FormLabel>
                <FormControl>
                  <Input
                    placeholder="연락받을 번호 또는 이메일을 입력해주세요"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
