...
export const metadata: Metadata = {
  ...
  description: '중소기업을 위한 인사노무 관리 완벽 가이드. 채용부터 퇴사까지 6개 영역 36개 항목 체크리스트로 법적 리스크를 최소화하고 컴플라이언스를 강화하세요.',
  keywords: [
    '인사노무 관리',
    '노동법 준수',
    '인사 체크리스트',
  ...
  openGraph: {
    title: '인사노무 관리 가이드 | 삼성생명 핵심포인트 | FamilyOffice S',
    description: '6개 영역 36개 항목 인사노무 체크리스트. 법적 리스크 최소화와 컴플라이언스 강화를 위한 완벽 가이드를 제공합니다.',
  ...
  twitter: {
    ...
    description: '중소기업 인사노무 36개 핵심 체크포인트. 법적 리스크 관리와 컴플라이언스 강화로 안전한 경영을 실현하세요.',
  ...
  other: {
    ...
    'checklist-areas': '채용관리, 근로시간, 임금휴가, 안전보건, 노사관계, 법정의무',
