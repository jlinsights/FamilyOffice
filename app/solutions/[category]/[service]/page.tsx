...
import { ArrowLeft, ArrowRight, CheckCircle, Clock, DollarSign, Star, Target, TrendingUp, Users } from 'lucide-react';
      ...
      <main className="pt-20">
        ...
        <div className="container mx-auto px-6 py-4">
          <BreadcrumbNavigation
            customItems={[
              ...
              { name: category.title, url: `https://familyoffices.vip/solutions#${category.id}` },
              { name: service.title, url: `https://familyoffices.vip/solutions/${params.category}/${params.service}`, isCurrentPage: true },
            ]}
          />
        </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start gap-3 p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-2xl mb-8">
                ...
                <div>
                  <div className="font-bold text-slate-900 dark:text-white mb-1">추천 고객</div>
                  <div className="text-slate-600 dark:text-slate-300">{service.targetClient}</div>
                </div>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-3">
                      <div className="text-blue-400 font-bold text-sm uppercase tracking-wider">상황</div>
                      <p className="text-slate-200 leading-relaxed">{service.caseStudy.situation}</p>
                    </div>

                    {/* Solution */}
                    <div className="space-y-3">
                      <div className="text-emerald-400 font-bold text-sm uppercase tracking-wider">솔루션</div>
                      <p className="text-slate-200 leading-relaxed">{service.caseStudy.solution}</p>
                    </div>

                    {/* Result */}
                    <div className="space-y-3">
                      <div className="text-amber-400 font-bold text-sm uppercase tracking-wider">결과</div>
                      <p className="text-slate-200 leading-relaxed font-semibold">{service.caseStudy.result}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {service.detailedContent && (
          <>
            ...
            {/* Process */}
            {service.detailedContent.process && service.detailedContent.process.length > 0 && (
              <section className="py-16 bg-slate-50 dark:bg-slate-900/50">
                <div className="container mx-auto px-6">
                  <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-black mb-8 text-slate-900 dark:text-white">
                    ...
                    <div className="space-y-4">
                      {service.detailedContent.process.map((step, index) => (
                        ...
                        >
                          ...
                          <span className="text-slate-700 dark:text-slate-300 leading-relaxed pt-2">{step}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-8 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl border border-blue-200 dark:border-blue-800">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">비용 안내</h3>
                      </div>
                    ...
                    <div className="p-8 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 rounded-2xl border border-emerald-200 dark:border-emerald-800">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">소요 기간</h3>
                      </div>
            ...
            {/* Deliverables */}
            {service.detailedContent.deliverables && service.detailedContent.deliverables.length > 0 && (
              <section className="py-16 bg-slate-50 dark:bg-slate-900/50">
                <div className="container mx-auto px-6">
                  <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-black mb-8 text-slate-900 dark:text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {service.detailedContent.deliverables.map((deliverable, index) => (
                        <div
                          key={index}
            ...
            {/* FAQs */}
            {service.detailedContent.faqs && service.detailedContent.faqs.length > 0 && (
              <section className="py-16">
                <div className="container mx-auto px-6">
                  <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-black mb-8 text-slate-900 dark:text-white">
