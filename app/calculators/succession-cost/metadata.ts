...
export const successionCostMetadata: Metadata = {
  title:
    '가업승계 비용 계산기 2025 | 승계 전략별 세무비용 비교 - FamilyOffice S',
  description:
    '2025년 최신 세법 기준 가업승계 비용 계산기. 승계 방법별 세무비용 정확 계산, 특례 혜택 분석, AI 최적 승계 전략 제안. 전문가급 분석으로 가업승계 비용 최대 60% 절약. 무료 계산 및 전문 컨설팅.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '2025년 최신 세법 반영, 승계 방법별 비용 비교, 특례 혜택 분석. 전문가급 정확도로 최적의 가업승계 전략과 비용 절감 방안 제시.',
    images: [
      {
  ...
  twitter: {
    ...
    description:
      '2025년 최신 세법 기준 가업승계 비용 계산. 승계 방법별 비교 분석, 특례 혜택 최대 활용.',
    images: [
      'https://familyoffices.vip/images/succession-cost-calculator-twitter.jpg',
    ],
...
export const successionCostJsonLd = {
  ...
  description:
    '2025년 최신 세법 기준 가업승계 비용 계산기. 승계 방법별 세무비용 정확 계산, 특례 혜택 분석, AI 최적 승계 전략 제안.',
  url: 'https://familyoffices.vip/calculators/succession-cost',
  ...
  potentialAction: [
    {
      ...
      name: '가업승계 비용 계산하기',
      description:
        '기업 정보를 입력하여 승계 방법별 세무비용을 계산하고 최적 전략을 확인합니다',
    ...
    },
    {
      ...
      name: '승계 전략 컨설팅',
      description:
        '계산 결과를 바탕으로 맞춤형 가업승계 전략 컨설팅을 받을 수 있습니다',
