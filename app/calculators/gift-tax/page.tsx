...
import { Calculator, Gift, Users, AlertCircle, CheckCircle, TrendingDown, Heart, Shield, Clock, Target, Lightbulb, DollarSign, Calendar, PieChart, Zap, TrendingUp, BarChart3, User, Users2, Home, Building2 } from 'lucide-react';
        ...
        <div className="relative overflow-hidden bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 rounded-3xl shadow-2xl dark:shadow-slate-900/50 mb-16">
          ...
          <div className="relative px-8 py-12 text-center">
            ...
            <p className="text-xl leading-relaxed text-slate-700 dark:text-slate-300 max-w-4xl mx-auto mb-12">
              <span className="font-semibold text-green-600 dark:text-green-400">2025년 최신 세법</span> 기준으로 증여세를 정밀하게 계산하고, 
              <span className="font-semibold text-emerald-600 dark:text-emerald-400"> 분할 증여 최적화</span> 방안까지 확인하여 
              <span className="font-semibold text-teal-600 dark:text-teal-400">절세 효과</span>를 극대화하세요.
            </p>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
              {[
                { icon: Shield, title: "법적 완벽성", desc: "국세청 기준 정확도 99.9%", color: "text-green-600 dark:text-green-400" },
                { icon: Calculator, title: "정밀 계산", desc: "관계별 공제한도 자동 적용", color: "text-emerald-600 dark:text-emerald-400" },
                { icon: Clock, title: "실시간 분석", desc: "분할증여 최적화 즉시 확인", color: "text-teal-600 dark:text-teal-400" },
                { icon: Target, title: "전문가 수준", desc: "Family Office급 전략 제공", color: "text-cyan-600 dark:text-cyan-400" }
              ].map((item, index) => (
                <div key={index} className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 rounded-xl p-4 hover:shadow-lg transition-all duration-300">
                  <item.icon className={`w-8 h-8 ${item.color} mx-auto mb-2`} />
                  <h3 className="font-semibold text-slate-900 dark:text-slate-100 text-sm mb-1">{item.title}</h3>
          ...
          {[
            {
              ...
              color: "from-pink-500 to-red-500 dark:from-pink-400 dark:to-red-400"
            },
            {
              icon: DollarSign,
              title: "절세 효과",
            ...
            <div key={index} className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r opacity-20 group-hover:opacity-30 transition-opacity duration-300 rounded-2xl blur-lg" style={{backgroundImage: `linear-gradient(135deg, var(--tw-gradient-stops))`}}></div>
              <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 rounded-2xl p-6 h-full hover:shadow-xl transition-all duration-300">
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${item.color} shadow-lg mb-4`}>
                  <item.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">{item.title}</h3>
                <p className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">{item.value}</p>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">{item.benefit}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative group">
            ...
            <Card className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl dark:shadow-slate-900/20">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="relationship" className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="previousGifts" className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="giftType" className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-2">
          ...
          <div className="relative group">
            ...
            <Card className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl dark:shadow-slate-900/20">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="year" className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="splitYears" className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-2">
          ...
          <div className="relative group">
            ...
            <Card className="relative bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-emerald-900/20 dark:via-green-900/20 dark:to-teal-900/20 border border-emerald-200/50 dark:border-emerald-700/50 shadow-xl dark:shadow-slate-900/20">
              ...
              <CardContent className="space-y-4">
                {[
                  { icon: Zap, text: "분할 증여: 10년에 걸쳐 나누어 증여하면 공제 한도 내에서 무세 가능", highlight: "분할 증여" },
                  { icon: Shield, text: "가업승계 특례: 중견기업의 경우 추가 공제 혜택 활용 가능", highlight: "가업승계 특례" },
                  { icon: Target, text: "재산 유형: 부동산은 감정평가, 주식은 평가 시점 고려 필요", highlight: "재산 유형" }
                ].map((tip, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 bg-white/50 dark:bg-slate-800/30 rounded-xl border border-emerald-200/30 dark:border-emerald-700/30">
                    ...
                    <span className="text-sm leading-relaxed text-emerald-800 dark:text-emerald-200">
                      <strong className="text-emerald-900 dark:text-emerald-100">{tip.highlight}:</strong> {tip.text.replace(`${tip.highlight}: `, '')}
                    </span>
                  </div>
                ))}
              </CardContent>
        ...
        <div className="space-y-6">
            ...
            <Card className="relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-green-900/20 dark:via-emerald-900/20 dark:to-teal-900/20 border-2 border-green-200/50 dark:border-green-700/50 shadow-2xl dark:shadow-slate-900/30">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  {[
                    { label: "증여금액", value: `${giftInfo.amount.toLocaleString()}만원`, icon: DollarSign, color: "text-slate-700 dark:text-slate-300" },
                    { label: "수증자 관계", value: getRelationshipLabel(giftInfo.relationship), icon: Users2, color: "text-slate-700 dark:text-slate-300" },
                    { label: "적용 공제액", value: `-${result.actualDeduction.toLocaleString()}만원`, icon: Shield, color: "text-green-600 dark:text-green-400", highlight: true }
                  ].map((item, index) => (
                    <div key={index} className="flex justify-between items-center py-2">
                      <div className="flex items-center gap-2">
                        <item.icon className={`w-5 h-5 ${item.highlight ? item.color : 'text-slate-500 dark:text-slate-400'}`} />
                  ...
                  <div className="flex justify-between items-center py-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-600 dark:text-slate-400 font-medium">과세표준</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-900 dark:text-slate-100 font-bold text-lg">증여세액</span>
                      </div>
                  ...
                  <div className="flex justify-between items-center py-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-600 dark:text-slate-400 font-medium">실효세율</span>
                    </div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">
                ...
                {result.availableDeduction > 0 && (
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="font-semibold text-blue-900 dark:text-blue-100 block">남은 공제 한도</span>
                        <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                          <strong>{result.availableDeduction.toLocaleString()}만원</strong>까지 추가 증여 가능 (무세)
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="relative group">
              ...
              <Card className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 border-2 border-blue-200/50 dark:border-blue-700/50 shadow-2xl dark:shadow-slate-900/30">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    {[
                      { label: "권장 분할 기간", value: `${optimization.recommendedYears}년`, icon: Calendar, color: "text-blue-600 dark:text-blue-400" },
                      { label: "연간 증여액", value: `${optimization.annualAmount.toLocaleString()}만원`, icon: DollarSign, color: "text-slate-700 dark:text-slate-300" },
                      { label: "총 증여세 (분할시)", value: `${optimization.totalTax.toLocaleString()}만원`, icon: Calculator, color: "text-green-600 dark:text-green-400" }
                    ].map((item, index) => (
                      <div key={index} className="flex justify-between items-center py-2">
                        <div className="flex items-center gap-2">
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-900 dark:text-slate-100 font-bold text-lg">절세 효과</span>
                        </div>
                  ...
                  <div className="bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 border border-green-200 dark:border-green-800 rounded-xl p-6">
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-green-900 dark:text-green-100 text-lg mb-2">💰 스마트 증여 전략</h4>
                        <p className="text-green-800 dark:text-green-200 leading-relaxed">
                          <span className="font-semibold">{optimization.recommendedYears}년</span>에 걸쳐 체계적으로 나누어 증여하면 
                          <span className="font-bold text-green-600 dark:text-green-300"> {optimization.savings.toLocaleString()}만원</span>의 세금을 절약할 수 있습니다.
                          이는 <span className="font-bold">{((optimization.savings / result.tax) * 100).toFixed(0)}%</span>의 놀라운 절세 효과입니다.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="relative bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 dark:from-purple-900/20 dark:via-pink-900/20 dark:to-rose-900/20 border border-purple-200/50 dark:border-purple-700/50 shadow-xl dark:shadow-slate-900/20">
              ...
              <CardContent className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-4 p-4 bg-white/50 dark:bg-slate-800/30 rounded-xl border border-purple-200/30 dark:border-purple-700/30 hover:shadow-lg transition-all duration-300">
                    <div className="p-2 bg-purple-500/10 dark:bg-purple-400/10 rounded-lg">
                      <item.icon className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                    </div>
                    <div className="flex-1">
                      <h4 className="font-semibold text-purple-900 dark:text-purple-100 mb-1">{item.title}</h4>
                      <p className="text-sm text-purple-700 dark:text-purple-300 leading-relaxed mb-2">{item.desc}</p>
          ...
          <div className="space-y-4">
            <div className="relative group">
              ...
              <Button className="relative w-full h-16 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 dark:from-green-500 dark:to-emerald-500 dark:hover:from-green-600 dark:hover:to-emerald-600 text-white font-bold text-lg shadow-xl transition-all duration-300 rounded-xl">
                <a href="/contact?service=gift-tax" className="flex items-center gap-3 w-full justify-center">
                  <Gift className="w-6 h-6" />
                  무료 증여세 최적화 상담 신청
                  <span className="text-sm font-normal opacity-90">(24시간 내 답변)</span>
                </a>
              </Button>
            </div>
            
            <Button variant="outline" className="w-full h-14 border-2 border-blue-200 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-semibold transition-all duration-300" size="lg">
              <a href="/calculators/succession-cost" className="flex items-center gap-2 w-full justify-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="h-12 border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400">
                <a href="/calculators/inheritance-tax" className="flex items-center gap-2 w-full justify-center">
                  <Home className="w-4 h-4" />
                  상속세 계산
                </a>
              </Button>
              <Button variant="outline" className="h-12 border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400" asChild>
                <Link href="/blog" className="flex items-center gap-2 w-full justify-center">
          ...
          <div className="relative group">
            ...
            <Card className="relative bg-gradient-to-br from-orange-50 via-amber-50 to-red-50 dark:from-orange-900/20 dark:via-amber-900/20 dark:to-red-900/20 border border-orange-200/50 dark:border-orange-700/50 shadow-xl dark:shadow-slate-900/20">
              ...
              <CardContent className="space-y-4">
                {[
                  { icon: Clock, text: "증여일로부터 3개월 이내 신고·납부 (말일이 휴일인 경우 익일까지)", type: "warning" },
                  { icon: Building2, text: "부동산 및 주식의 경우 정확한 가액 평가 필요", type: "warning" },
                  { icon: AlertCircle, text: "신고 누락시 무신고 가산세 20-40% 부과", type: "danger" },
                  { icon: CheckCircle, text: "가업승계 특례 적용시 추가 혜택 가능", type: "success" }
                ].map((item, index) => {
                  const colors = {
                    warning: { bg: "bg-orange-100 dark:bg-orange-900/30", border: "border-orange-200/30 dark:border-orange-700/30", text: "text-orange-800 dark:text-orange-200", icon: "text-orange-600 dark:text-orange-400" },
                    danger: { bg: "bg-red-100 dark:bg-red-900/30", border: "border-red-200/30 dark:border-red-700/30", text: "text-red-800 dark:text-red-200", icon: "text-red-600 dark:text-red-400" },
                    success: { bg: "bg-green-100 dark:bg-green-900/30", border: "border-green-200/30 dark:border-green-700/30", text: "text-green-800 dark:text-green-200", icon: "text-green-600 dark:text-green-400" }
                  };
                  const style = colors[item.type as keyof typeof colors];
                  
                  return (
                    <div key={index} className={`flex items-start gap-3 p-3 ${style.bg} rounded-xl border ${style.border}`}>
                      <div className={`p-1.5 rounded-lg ${style.bg}`}>
                        <item.icon className={`w-4 h-4 ${style.icon}`} />
                      </div>
                      <span className={`text-sm leading-relaxed ${style.text}`}>
                        {item.text}
                      </span>
                    </div>
                  );
        ...
        <div className="mt-20 mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
              계산 결과를 바탕으로 더 정교한 <span className="font-semibold text-green-600 dark:text-green-400">Family Office급 전략</span>을 확인해보세요
            </p>
          </div>
            ...
            {[
              {
                icon: Calculator,
                title: "상속세 계산기",
                description: "상속세 예상 금액과 절세 방안을 정밀하게 계산하세요",
              ...
              },
              {
                icon: Users,
                title: "가업승계 비용 계산기",
                description: "승계 계획별 세무 비용을 비교 분석하고 최적 전략을 찾아보세요",
              ...
              },
              {
                icon: Target,
                title: "전문가 맞춤 컨설팅",
                description: "당신만의 맞춤형 증여 계획을 전문가와 함께 수립하세요",
              ...
              <div key={index} className="relative group">
                <div className={`absolute -inset-0.5 bg-gradient-to-r ${service.color} opacity-20 group-hover:opacity-30 transition-opacity duration-300 rounded-2xl blur-lg`}></div>
                <Card className="relative h-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl dark:shadow-slate-900/20 hover:shadow-2xl transition-all duration-300 cursor-pointer">
                  <CardContent className="p-8 text-center h-full flex flex-col justify-between">
                    <div>
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br ${service.color} shadow-lg mx-auto mb-6`}>
                        <service.icon className="w-8 h-8 text-white" />
                      </div>
                      <div className="mb-4">
                        <span className={`inline-block px-3 py-1 bg-gradient-to-r ${service.color} text-white text-xs font-semibold rounded-full mb-3`}>
                          {service.badge}
                        </span>
                        <h3 className="font-bold text-lg text-slate-900 dark:text-slate-100 mb-3">{service.title}</h3>
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">{service.description}</p>
                      </div>
                    </div>
                    <Button variant="outline" size="sm" className="w-full mt-4 border-2 hover:shadow-md transition-all duration-300">
                      <a href={service.link} className="w-full">
                        {service.title.includes('전문가') ? '상담 신청하기' : '계산해보기'}
                      </a>
                    </Button>
                  </CardContent>
                </Card>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                    이 계산기는 <strong className="text-slate-800 dark:text-slate-200">일반적인 증여세 예상 금액 산출</strong>을 위한 도구입니다. 
                    실제 세액은 개별 사안의 특수성, 법령 해석, 재산 평가 방법 등에 따라 달라질 수 있으므로 
                    <strong className="text-green-600 dark:text-green-400"> 정확한 세무 계획 수립</strong>을 위해서는 
                    반드시 <strong className="text-blue-600 dark:text-blue-400">전문가와 상담</strong>하시기 바랍니다.
                  </p>
