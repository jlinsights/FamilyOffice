...
export const giftTaxMetadata: Metadata = {
  title: '증여세 계산기 2025 | 분할증여 절세 전략 및 정확한 계산 - FamilyOffice S',
  description: '2025년 최신 세법 기준 증여세 계산기. 관계별 공제한도 자동 적용, 분할증여 최적화 분석, AI 절세 전략 제안. 전문가급 정확도로 증여세 최대 70% 절약 가능. 무료 계산 및 맞춤 컨설팅.',
  keywords: [
    // 🎯 BMAD Behavioral Keywords
    '증여세 계산기', '증여세 계산 방법', '2025년 증여세', '증여세 자동 계산', '증여세 시뮬레이션',
    '증여세율 계산', '증여세 공제 한도', '관계별 증여세', '분할 증여 계산', '증여세 납부액',
    
    // 🎯 BMAD Motivational Keywords  
    '증여세 절세', '증여세 절약', '증여세 줄이는 법', '증여세 최적화', '분할 증여 전략',
    '증여세 부담 경감', '증여세 합법 절세', '스마트 증여 계획', '가족 자산 이전',
    
    // 🎯 BMAD Aspirational Keywords
    '증여세 70% 절감', '분할증여 최대 효과', '증여세 무료 계산', '증여세 성공 사례',
    '10년 증여 계획', 'CEO 증여 전략', '기업 자산 증여', '가족사랑 증여',
    
    // 🎯 BMAD Decisional Keywords
    '증여세 전문가 상담', '증여세 계산 후 상담', '증여 컨설팅', '증여 전문가',
    '증여세 신고 대행', '증여세 세무 상담', '맞춤형 증여 계획', '무료 증여 상담'
  ],
  ...
  openGraph: {
    ...
    description: '2025년 최신 세법 반영, 관계별 공제한도 자동 계산, 분할증여 최적화 분석. 99.9% 정확도의 증여세 계산기로 스마트한 자산 이전 계획.',
    images: [
      {
  ...
  twitter: {
    ...
    description: '2025년 최신 세법 기준 증여세 계산. 관계별 공제한도 자동 적용, 분할증여로 최대 70% 절세.',
    images: ['https://familyoffices.vip/images/gift-tax-calculator-twitter.jpg'],
...
export const giftTaxJsonLd = {
  ...
  description: '2025년 최신 세법 기준 증여세 계산기. 관계별 공제한도 자동 적용, 분할증여 최적화 분석, AI 절세 전략 제안.',
  url: 'https://familyoffices.vip/calculators/gift-tax',
  ...
  potentialAction: [
    {
      '@type': 'UseAction',
      name: '증여세 계산하기',
      description: '증여 정보를 입력하여 증여세를 계산하고 분할증여 최적화 방안을 확인합니다',
      target: 'https://familyoffices.vip/calculators/gift-tax'
    },
    {
      '@type': 'ContactAction',
      name: '증여 전략 상담',
      description: '계산 결과를 바탕으로 맞춤형 증여 전략 상담을 받을 수 있습니다',
