...
export const metadata: Metadata = {
  title: '세무 계산기 2025 | 상속세·증여세·가업승계·연금 전문가급 계산 - FamilyOffice S',
  description: '2025년 최신 세법 반영 세무 계산기. 상속세 40% 절약, 증여세 70% 절감, 가업승계 60% 최적화, 연금 수령액 30% 증대. 99.9% 정확도의 AI 계산기로 즉시 절세 전략 확인.',
  keywords: [
    // 🎯 BMAD Behavioral Keywords (검색 의도 기반)
    '세무 계산기 2025', '상속세 계산기', '증여세 계산기', '가업승계 비용 계산기', '연금 계산기',
    '상속세 계산 방법', '증여세 계산 방법', '가업승계 비용 계산', '연금 수령액 계산',
    '2025년 세법', '세무 시뮬레이션', '세금 계산기', 'AI 세무 계산기',
    
    // 🎯 BMAD Motivational Keywords (가치 제안 중심)  
    '상속세 절세', '증여세 절약', '가업승계 최적화', '연금 수익률 극대화', '절세 전략',
    '상속세 40% 절약', '증여세 70% 절감', '가업승계 60% 최적화', '노후 자금 준비',
    '합법적 절세', '스마트 세무 관리', '패밀리오피스 세무', '중견기업 세무',
    
    // 🎯 BMAD Aspirational Keywords (목표 달성형)
    '전문가급 세무 계산', '세무 전문가 수준', 'Family Office급 서비스', 'CEO 세무 전략',
    '성공적인 자산 승계', '세대간 자산 이전', '기업 지속 성장', '풍요로운 노후',
...
export default async function CalculatorsPage() {
  ...
  const calculators = [
    ...
    {
      title: '연금 계산기',
      description: '개인연금, 퇴직연금, 국민연금을 종합적으로 계산하고 은퇴 후 수령액을 시뮬레이션합니다.',
      icon: PiggyBank,
      color: 'emerald',
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="relative text-center mb-20">
          ...
          <div className="inline-flex items-center justify-center p-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-full mb-8 shadow-sm">
            <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs font-bold rounded-full mr-2">New</span>
            <span className="text-sm text-slate-600 dark:text-slate-300 pr-2">2025년 세법 개정안 완벽 반영</span>
          </div>
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
            상속세, 증여세, 가업승계, 그리고 연금까지. <br className="hidden sm:block" />
            AI 알고리즘으로 복잡한 세금을 즉시 계산하고 최적의 절세 전략을 확인하세요.
          </p>
              ...
              >
                ...
                <CardHeader className="relative pb-4">
                  <div className="flex justify-between items-start mb-4">
                    <div className={`p-3 bg-white dark:bg-slate-800 rounded-2xl shadow-md group-hover:scale-110 transition-transform duration-300`}>
                ...
                <CardContent className="relative pt-0">
                  <div className="space-y-3 mb-6">
                    {calculator.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center gap-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <div className={`w-1.5 h-1.5 rounded-full ${colorClasses.icon.split(' ')[0]!.replace('text-', 'bg-')}`}></div>
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mb-6 p-3 bg-white/60 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-slate-700 backdrop-blur-sm">
                    <div className="text-xs text-slate-500 dark:text-slate-400 mb-1">예상 효과</div>
                  ...
                  <Button 
                    ...
                    asChild
                  >
                    <a href={calculator.href} className="flex items-center justify-center gap-2">
                      계산하기
        ...
        <div className="relative overflow-hidden bg-slate-900 dark:bg-slate-950 rounded-3xl p-10 mb-24 text-white shadow-2xl">
          ...
          <div className="relative z-10 text-center mb-12">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto text-lg">
              FamilyOffice S의 프리미엄 계산기를 통해 고객님들이 달성한 실제 성과입니다.
              <br />데이터에 기반한 정확한 분석으로 자산을 지켜드립니다.
            </p>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              ...
              <div className="text-sm text-blue-200 font-medium">누적 계산 건수</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="flex justify-center mb-4">
              ...
              <div className="text-sm text-green-200 font-medium">평균 절세율</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="flex justify-center mb-4">
              ...
              <div className="text-sm text-purple-200 font-medium">누적 절세 금액</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="flex justify-center mb-4">
              ...
              <div className="text-sm text-yellow-200 font-medium">고객 만족도</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-24">
          <div className="bg-blue-600 dark:bg-blue-900 rounded-3xl p-10 text-white flex flex-col justify-between shadow-xl relative overflow-hidden group">
            ...
            <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 w-full sm:w-auto text-lg font-bold h-14" asChild>
              <a href="/contact?service=tax-consulting" className="flex items-center justify-center gap-2">
                무료 상담 신청하기
          ...
          <div className="bg-slate-100 dark:bg-slate-800 rounded-3xl p-10 flex flex-col justify-between border border-slate-200 dark:border-slate-700 shadow-lg">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">프리미엄 리포트</h2>
              <p className="text-slate-600 dark:text-slate-300 mb-8 text-lg leading-relaxed">
                우리 가족만을 위한 맞춤형 세무 진단 리포트를 받아보세요. <br />
                상속, 증여, 가업승계의 마스터플랜을 수립해 드립니다.
              </p>
            </div>
            <Button variant="outline" size="lg" className="border-2 border-slate-300 dark:border-slate-600 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 w-full sm:w-auto text-lg font-bold h-14" asChild>
              <a href="/services/tax-optimization" className="flex items-center justify-center gap-2">
                서비스 자세히 보기
                <ArrowRight className="w-5 h-5" />
              </a>
            </Button>
