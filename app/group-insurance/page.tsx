  ...
  const insuranceProducts = [
    {
      ...
      premium: '월 1만원~',
      maxCoverage: '1억원',
      features: ['업무상/일반상해', '교통사고 보장', '골절진단비', '응급실내원비'],
  ...
  const implementationSteps = [
    {
      ...
      items: ['업종별 위험분석', '임직원 니즈조사', '기존 보험 검토', '예산 설정'],
      duration: '1주',
      color: 'from-blue-500 to-blue-600'
    },
    {
    ...
    },
    {
      ...
      items: ['보험금 청구 지원', '신입직원 추가', '보장 업그레이드', '정기 리뷰'],
      duration: '지속',
      color: 'from-orange-500 to-orange-600'
    }
  ];
          ...
          <div className="container relative mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed">
                <strong className="text-yellow-300">임직원 만족도 향상</strong>과 <strong className="text-yellow-300">복리후생비 절세</strong>
                <br />
                두 마리 토끼를 한번에 잡으세요
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {insuranceProducts.map((product, index) => (
                <Card key={index} className={`relative overflow-hidden hover:shadow-xl transition-all duration-300 ${product.popular ? 'ring-2 ring-yellow-400' : ''}`}>
                  {product.popular && (
                  ...
                  <CardHeader className="text-center">
                    <div className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-r ${product.color} flex items-center justify-center mb-4`}>
                      <product.icon className="h-8 w-8 text-white" />
                    </div>
                    <CardTitle className="text-xl font-bold text-gray-900">{product.category}</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">주요 보장</span>
                      <span className="font-semibold text-blue-600">{product.coverage}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="pt-2 border-t">
                      <div className="text-sm text-gray-600 mb-2">보장 내용</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {industryPlans.map((plan, index) => (
                <Card key={index} className="relative overflow-hidden hover:shadow-xl transition-all duration-300">
                  ...
                  <CardHeader className="text-center">
                    <CardTitle className="text-xl font-bold text-gray-900">{plan.industry}</CardTitle>
                    <div className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${
                      plan.riskLevel === '높음' ? 'bg-red-100 text-red-800' :
                      plan.riskLevel === '중간' ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">주요 위험</h4>
                      <div className="space-y-1">
                        {plan.mainRisks.map((risk, riskIndex) => (
                          <div key={riskIndex} className="flex items-center text-sm text-red-600">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">권장 보장</h4>
                      <p className="text-sm text-blue-600 font-medium">{plan.recommendedCoverage}</p>
                    </div>

                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">예상 보험료</h4>
                      <p className="text-lg font-bold text-green-600">{plan.premium}</p>
                    </div>

                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">특화 서비스</h4>
                      <div className="space-y-1">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              지금 시작하는 <span className="text-yellow-400">기업 단체보험</span>
            </h2>
          ...
          "@graph": [
            {
              ...
              "description": "기업 단체보험 완벽 가이드. 복리후생비 100% 손비처리, 임직원 만족도 향상, 절세 효과까지. 전 직원 보장 단체보험 상담.",
              "image": {
                "@type": "ImageObject",
