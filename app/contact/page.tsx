...
export const metadata: Metadata = {
  ...
  description:
    '중소중견기업 법인 대표님을 위한 전문 자산관리 서비스. 무료 상담을 통해 맞춤형 패밀리오피스 솔루션을 확인하세요.',
  keywords:
    '패밀리오피스 상담, 중소중견기업 자산관리 상담, 법인 대표 재무상담, 무료 자산관리 상담',
};
      ...
      <main className="pt-20">
        ...
        <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background dark:from-background dark:via-muted/10 dark:to-background overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
            ...
            >
              업종별 특성을 정확히 이해하는 전문가들이{' '}
              <span className="font-semibold text-foreground">
                법인 대표님만을 위한 맞춤형 자산관리 솔루션
              </span>
              을 제안해드립니다
            </p>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                왜 <span className="text-primary">FamilyOffice S</span>를
                선택해야 할까요?
              </h2>
              ...
              {[
                {
                  title: '업종별 전문성',
                  description:
                    '제조업, 건설업, IT벤처기업 등 각 업종의 특성을 정확히 이해하는 전문가들이 맞춤형 솔루션을 제공합니다.',
                  features: [
                    '중대재해처벌법 대응',
                    '정책자금 활용',
                    '가족법인 설립',
                ...
                },
                {
                  title: '법인 대표 중심',
                  description:
                    '법인 대표님의 일정과 우선순위를 최우선으로 고려한 개인 맞춤형 서비스를 제공합니다.',
                  features: [
                    '개인 맞춤형 일정',
                    '전담 전문가 배정',
                    '밀착 코칭 상담',
                ...
                },
                {
                  title: '통합 솔루션',
                  description:
                    '법인-개인 자산을 통합 관리하고, 세무-투자-승계까지 원스톱 서비스를 제공합니다.',
                  features: [
                    '법인-개인 통합관리',
                    '세무 최적화',
                    '투자 전략',
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
                중소중견기업 전문가와의 1:1 무료 상담으로
                <br />더 나은 자산관리 전략을 확인해보세요
              </p>
