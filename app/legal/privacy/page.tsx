  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 pb-20 container max-w-4xl mx-auto px-4 prose dark:prose-invert">
        ...
        <p>
          FamilyOffice S(이하 &ldquo;회사&rdquo;)는 회원의 개인정보를
          중요시하며, &ldquo;개인정보보호법&rdquo;, &ldquo;정보통신망 이용촉진
          및 정보보호 등에 관한 법률&rdquo;을 준수하고 있습니다.
        </p>

        <h2>1. 수집하는 개인정보의 항목</h2>
        <p>
          회사는 서비스 가입 및 상담, 서비스 제공 등을 위해 아래와 같은
          개인정보를 수집하고 있습니다.
        </p>
        <ul>
