...
export const metadata: Metadata = generateMetadata(
  '성공한 기업가·자산가 전용 패밀리오피스 | 법인보험 가업승계 통합솔루션',
  '【성공한 기업가·고액자산가 전용】 법인보험 × 가업승계 × 개인자산관리 통합솔루션 | 개인자산 30억+ 맞춤 설계 | 기업재해보장·경영인정기·법인종신보험·퇴직연금 + M&A 1500+ | 법인세 30% + 승계세 40% 동시절감 | 삼성생명 프리미엄 파트너 | 무료 통합진단 ☎0502-5550-8700',
  [
    // 성공한 기업가 실제 검색어
    '기업가 자산관리',
    '법인대표 가업승계',
