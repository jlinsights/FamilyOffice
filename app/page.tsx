...
import { ArrowRight, Shield, TrendingUp, CheckCircle, Building2, Settings, Crown, Star, ArrowDown, ChevronRight, PieChart, BarChart3, Briefcase, Heart, Network, GraduationCap, FileText, CheckSquare, AlertTriangle, RefreshCw, PhoneCall, Search, MessageSquare, Building, Calendar } from "lucide-react"
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="card p-6 mb-8 animate-slide-up" style={{ animationDelay: '350ms' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="text-center">
                  <p className="font-medium text-primary">서초타워</p>
                  <p className="text-muted-foreground">서울 서초구 서초대로 74길 4</p>
                </div>
                <div className="text-center flex flex-col items-center justify-center">
                  <p className="font-semibold text-primary">서울법인지역단</p>
                  <p className="text-muted-foreground">서울시 중구 세종대로 73 태평로빌딩</p>
                </div>
                <div className="text-center">
                  <p className="font-medium text-primary">그랑서울</p>
