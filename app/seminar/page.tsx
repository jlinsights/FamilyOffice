...
export default function SeminarPage() {
  ...
  const seminarStructuredData = {
    ...
    description: '이상선 박사, 황병훈 세무사 등 최고 전문가와 함께하는 CEO 전용 프리미엄 세미나. 그랜드하얏트, 신라호텔 등 최고급 호텔에서 개최. 선착순 30명 한정',
    ...
    keywords: '2025년 CEO 세미나, 가업승계 세미나 신청, 절세전략 무료 세미나, 이상선 박사, 황병훈 세무사, 그랜드하얏트 세미나, 중대재해처벌법 대응, 선착순 30명',
    about: [
      {
        '@type': 'Thing',
        name: '자산관리',
