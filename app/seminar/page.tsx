...
export const metadata: Metadata = generateMetadata(
  '2025년 CEO 세미나 일정 | 30억+ 자산가·법인대표 전용 | 가업승계·절세전략',
  '30억 이상 자산가와 법인 대표를 위한 프리미엄 클로즈드 세미나. 이상선 박사 가업승계 특강, 황병훈 세무사 절세전략. 그랜드하얏트·신라호텔 개최. UHNW 전용 비공개 세미나. 선착순 30명 ☎0502-5550-8700',
  [
    ...
    // 💵 UHNW 자산 계층 키워드 (Wealth Tier Targeting)
    '30억 이상 자산가 세미나',
    '30억+ 자산가 전용 세미나',
    '초고액자산가 세미나',
    '고액자산가 전용 교육',
    ...
    // 🏢 법인 대표/CEO 키워드 (Corporate Executive)
    '법인 대표 세미나',
    '법인 대표 전용 교육',
    '기업 오너 세미나',
    '오너 경영인 교육',
...
export default function SeminarPage() {
  ...
  const seminarStructuredData = {
    ...
    keywords:
      '2025년 CEO 세미나, 30억 이상 자산가 세미나, 초고액자산가 세미나, 법인 대표 전용, 프리미엄 클로즈드 세미나, UHNW 전용, 가업승계 세미나 신청, 절세전략, 이상선 박사, 황병훈 세무사, 그랜드하얏트 세미나, 비공개 세미나, 선착순 30명',
    about: [
      {
        '@type': 'Thing',
        name: '자산관리',
