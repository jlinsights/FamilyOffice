...
export default function PolicyFundsPage() {
  ...
  const policyFundCategories = [
    ...
    },
    {
      icon: TrendingUp,
      title: '특별지원자금',
      description: '정부 특별정책에 따른 지원 프로그램',
      funds: [
        { name: 'ESG 경영자금', rate: '1.3%', limit: '20억원', period: '7년' },
        { name: '디지털전환자금', rate: '1.5%', limit: '15억원', period: '5년' },
  ...
  const changes2025 = [
    {
      icon: TrendingDown,
      title: '금리 인하',
      description: '전 상품군 평균 0.3%p 금리 인하',
      impact: '연간 300만원 절약 (10억원 기준)',
      color: 'green'
    },
    {
      icon: Gift,
      title: '한도 확대',
      description: 'ESG 경영자금 한도 15억→20억 확대',
      impact: '5억원 추가 지원 가능',
      color: 'blue'
    },
    {
      icon: Clock,
      title: '상환기간 연장',
      description: '시설자금 최대 상환기간 5년→7년',
      impact: '월 상환액 30% 경감',
      color: 'purple'
    },
    {
      icon: Award,
      title: '심사 간소화',
      description: '벤처/이노비즈 기업 서류 50% 간소화',
      impact: '승인기간 3일 단축',
      color: 'orange'
    }
  ];
  ...
  const faqData = [
    {
      ...
      answer: '중소기업기본법상 중소기업으로 업력 6개월 이상, 신용등급 BB- 이상, 세금 체납이 없는 기업이 신청 가능합니다. 벤처기업, 이노비즈 기업, ESG 경영기업은 우대조건이 적용됩니다.'
    },
    {
      question: '정책자금과 일반 은행대출의 차이점은 무엇인가요?',
      answer: '정책자금은 정부가 지원하는 저금리 대출로 일반 시중금리보다 1-2% 낮습니다. 신용보증기금 등의 보증을 통해 담보 부담도 줄일 수 있으며, 상환 조건도 더 유리합니다.'
    },
    {
      question: '신용보증기금 보증 없이도 정책자금 신청이 가능한가요?',
      answer: '가능합니다만, 보증기관의 보증을 받으면 금리 우대, 한도 확대, 담보 부담 경감 등의 혜택이 있어 보증 신청을 권장합니다. 기업 신용등급에 따라 보증 없이도 신청 가능한 상품들이 있습니다.'
    },
    {
      question: '정책자금 신청부터 실행까지 얼마나 걸리나요?',
      answer: '일반적으로 보증기관 승인 5-7일, 은행 대출 승인 3-5일로 총 2-3주 정도 소요됩니다. 벤처기업이나 이노비즈 기업은 심사 간소화로 1-2주 내 처리가 가능합니다.'
    },
    {
      question: '2025년 새로 추가된 정책자금은 어떤 것이 있나요?',
      answer: 'ESG 경영자금 한도 확대(15억→20억), 디지털전환자금 신규 출시, 친환경시설자금 금리 인하(2.0%→1.5%) 등이 주요 변경사항입니다. 또한 청년창업자금 지원 대상도 확대되었습니다.'
    },
    {
      question: '정책자금 중복 신청이 가능한가요?',
      answer: '목적이 다른 정책자금은 중복 신청 가능합니다. 예를 들어 시설자금과 운영자금은 동시 신청할 수 있지만, 같은 목적의 자금은 중복 신청이 제한됩니다. 총 한도 내에서 관리됩니다.'
    }
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                2025년 새롭게 개선된 정책자금 제도로 더 많은 혜택을 받아보세요
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                신용보증을 통해 더 유리한 조건으로 정책자금을 지원받으세요
              </p>
            </div>
