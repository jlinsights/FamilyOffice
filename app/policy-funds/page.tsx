...
export default function PolicyFundsPage() {
  ...
  const policyFundCategories = [
    {
      ...
      title: '창업자금',
      description:
        '창업 초기 필요한 시설자금 및 운영자금 (세액감면 5년→7년 연장)',
      funds: [
        {
          name: '창업성장기술개발사업',
          rate: '1.0%',
  ...
  const applicationProcess = [
    ...
    },
    {
      ...
      details: ['대출약정 체결', '자금 지급', '사후관리 시작', '정기 점검'],
    },
  ];
      ...
      faqs: [
        {
          ...
          answer:
            '중소기업기본법상 중소기업으로 업력 6개월 이상, 신용등급 BB- 이상, 세금 체납이 없는 기업이 신청 가능합니다. 벤처기업, 이노비즈 기업, ESG 경영기업은 우대조건이 적용되며, 특히 기업부설연구소 보유기업은 추가 혜택을 받을 수 있습니다.',
        },
        {
          id: 'basic-2',
          question: '정책자금과 일반 은행대출의 차이점은 무엇인가요?',
          answer:
            '정책자금은 정부가 지원하는 저금리 대출로 일반 시중금리보다 1-2% 낮습니다. 신용보증기금 등의 보증을 통해 담보 부담도 줄일 수 있으며, 상환 조건도 더 유리합니다. 특히 R&D 목적 자금의 경우 최대 1.0% 금리로 지원받을 수 있습니다.',
        },
        {
          id: 'basic-3',
          question: '정책자금 신청부터 실행까지 얼마나 걸리나요?',
          answer:
            '일반적으로 보증기관 승인 5-7일, 은행 대출 승인 3-5일로 총 2-3주 정도 소요됩니다. 벤처기업이나 이노비즈 기업은 심사 간소화로 1-2주 내 처리가 가능하며, 2025년부터 AI 기반 자동 서류검증으로 처리기간이 더욱 단축되었습니다.',
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            '벤처기업 인증 시 보증한도가 30억원에서 50억원으로 확대되며, 금리우대 1.5%p를 받을 수 있습니다. 또한 R&D 지원사업 신청 시 10점의 가점이 주어지고, 정부조달 입찰에서 7점의 가점을 받습니다.',
        },
        {
          id: 'cert-2',
          question: '기업부설연구소 설립 시 혜택은 무엇인가요?',
          answer:
            '기업부설연구소 설립 시 연구개발비 세액공제를 최대 40%까지 받을 수 있으며, 설립지원금 최대 10억원, 연구장비 구입자금 20억원을 지원받을 수 있습니다. 상시근로자 10인 이상, 연구전담인력 3인 이상이 설립 요건입니다.',
        },
        {
          id: 'cert-3',
          question: '이노비즈, 메인비즈 기업의 정책자금 우대사항은?',
          answer:
            '이노비즈 기업은 기술혁신자금 우선지원, 보증료율 0.2%p 우대, 기보 보증한도 10억원 추가 확대 혜택을 받습니다. 메인비즈 기업은 시설자금 금리 0.3%p 우대, 운영자금 한도 50% 확대, 심사기간 30% 단축의 혜택이 있습니다.',
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            '가능합니다만, 보증기관의 보증을 받으면 금리 우대, 한도 확대, 담보 부담 경감 등의 혜택이 있어 보증 신청을 권장합니다. 기업 신용등급에 따라 보증 없이도 신청 가능한 상품들이 있으며, 2025년부터 통합보증심사 시스템으로 처리가 간소화되었습니다.',
        },
        {
          id: 'process-2',
          question: '정책자금 중복 신청이 가능한가요?',
          answer:
            '목적이 다른 정책자금은 중복 신청 가능합니다. 예를 들어 시설자금과 운영자금은 동시 신청할 수 있지만, 같은 목적의 자금은 중복 신청이 제한됩니다. 총 한도 내에서 관리되며, 2025년부터 통합한도 관리시스템으로 효율적으로 관리됩니다.',
        },
        {
          id: 'process-3',
          question: '정책자금 신청 시 필요한 주요 서류는 무엇인가요?',
          answer:
            '기본적으로 중소기업확인서, 재무제표, 사업자등록증, 사업계획서가 필요하며, 벤처/이노비즈 기업은 인증서를 추가 제출합니다. 기업부설연구소 보유기업은 연구소신고필증을 제출하면 추가 혜택을 받을 수 있습니다.',
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            'ESG 경영자금 한도 확대(15억→20억), 디지털전환자금 신규 출시, 친환경시설자금 금리 인하(2.0%→1.5%) 등이 주요 변경사항입니다. 또한 청년창업자금 지원 대상 확대, 스마트공장 구축지원 3,000억원 예산으로 최대 1억원 지원이 가능합니다.',
        },
        {
          id: 'new-2',
          question: '2025년 R&D 지원사업의 변경사항은?',
          answer:
            '혁신형 중소기업 R&D 예산이 2,500억원으로 확대되어 최대 10억원까지 지원받을 수 있습니다. 기업부설연구소 보유기업은 우선선정되며, 연구개발비 세액공제도 일반 25%에서 중소기업 40%로 상향 조정되었습니다.',
        },
        {
          id: 'new-3',
          question: '창업기업 세액감면 확대 내용은?',
          answer:
            '2025년부터 창업기업 세액감면 기간이 5년에서 7년으로 연장되었습니다. 벤처기업 특별세액감면도 20%에서 30%로 인상되어, 창업 초기 기업의 세부담을 대폭 경감할 수 있습니다.',
        },
      ],
    },
  ];
    ...
    <>
                ...
                {policyFundStats.map((stat, index) => (
                  ...
                  >
                    <CardContent className="p-6 text-center">
                      <stat.icon
                        className={`w-8 h-8 mx-auto mb-4 ${stat.color === 'green' ? 'text-emerald-600 dark:text-emerald-400' : stat.color === 'blue' ? 'text-primary' : stat.color === 'purple' ? 'text-purple-600 dark:text-purple-400' : 'text-orange-600 dark:text-orange-400'}`}
                      />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                기업부설연구소 세액공제 확대, 무상지원금 대폭 증액으로 더 많은
                혜택을 받아보세요
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {changes2025.map((change, index) => (
                <Card
                  key={index}
                  className="border border-border/40 bg-background/80 dark:bg-background/60 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-l-primary"
                >
                  <CardHeader>
                    <div
                      className={`w-12 h-12 bg-${change.color}-100 dark:bg-${change.color}-900/30 rounded-lg flex items-center justify-center mb-4`}
                    >
                      <change.icon
                  ...
                  <CardContent>
                    ...
                    <Badge
                      className={`bg-${change.color}-100 dark:bg-${change.color}-900/30 text-${change.color}-700 dark:text-${change.color}-300`}
                    >
                      {change.impact}
                    </Badge>
                  </CardContent>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {policyFundCategories.map((category, index) => (
                <Card
                  key={index}
                  className="border border-border/40 bg-background/80 dark:bg-background/60 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                >
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Badge
                        className={`bg-${category.color}-100 dark:bg-${category.color}-900/30 text-${category.color}-700 dark:text-${category.color}-300`}
                      >
                        {category.badge}
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {category.funds.map((fund, fundIndex) => (
                        <div
                          key={fundIndex}
                          className="p-4 bg-accent/20 dark:bg-accent/10 rounded-lg border border-border/20"
                        >
        ...
        <section className="py-16 md:py-24 bg-background dark:bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                2025년 통합보증심사시스템 도입으로 더 유리한 조건으로 정책자금을
                지원받으세요
              </p>
            </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {institution.features.map((feature, featureIndex) => (
                          <Badge
                            key={featureIndex}
                            variant="outline"
                            className="text-xs border-border/40 text-muted-foreground hover:bg-accent/50"
                          >
                            {feature}
                          </Badge>
                        ))}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                {applicationProcess.map((process, index) => (
                  <Card
                    key={index}
                    className="border border-border/40 bg-background/80 dark:bg-background/60 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative"
                  >
                    <CardHeader>
                      <div className="flex items-center mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <Badge
                            variant="outline"
                            className="mt-1 border-border/40 text-muted-foreground"
                          >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <Badge
                  variant="outline"
                  className="mb-4 border-purple-200 text-purple-700 dark:border-purple-400 dark:text-purple-300"
                >
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  기업부설연구소를 설립하면 정책자금뿐만 아니라 세액공제,
                  무상지원금 등 다양한 정부 지원을 받을 수 있습니다.
                </p>
              </div>
      ...
      <Script id="policy-funds-structured-data" type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            '2025년 최신 정책자금 완벽 가이드. 창업자금, 운영자금, 시설자금까지 저금리 대출정보. 중소기업 지원정책 전문가 상담',
          author: {
            '@type': 'Organization',
            name: '삼성생명 GFC',
          },
