          ...
          <div className="container mx-auto px-4">
            <Card className="max-w-3xl mx-auto bg-gradient-to-r from-emerald-600 to-blue-600 text-white border-0">
              <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                  <h3 className="text-xl font-bold mb-2">무료 상속세 계산기로 바로 계산해보세요</h3>
                  <p className="text-emerald-50">2025년 최신 세율 자동 적용, 3분이면 결과 확인</p>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto prose dark:prose-invert">
              <p className="lead text-lg">
                <strong>상속세</strong>는 피상속인(사망자)으로부터 재산을 물려받을 때 발생하는 세금으로, 
                대한민국 세법상 최고 50%(최대주주 할증 시 60%)에 달하는 높은 세율 때문에 사전 준비가 필수적입니다.
              </p>
              <p>
                2025년 현재, 많은 분들이 <strong>상속세 계산기</strong>를 찾고 계시지만 
                단순히 계산만 하는 것보다 <strong>절세 전략</strong>을 함께 수립하는 것이 훨씬 중요합니다.
              </p>
              <p>
                본 가이드에서는 상속세 계산 원리부터 실제 계산 방법, 그리고 합법적인 절세 전략까지 
                모두 알려드립니다.
              </p>
            </div>
          </div>
              ...
              <Card>
                ...
                <CardContent className="prose dark:prose-invert max-w-none">
                      ...
                      <table className="w-full border-collapse">
                        ...
                        <tbody>
                          ...
                          <tr className="bg-red-50 dark:bg-red-950/30">
                            ...
                            <td className="border p-3 font-semibold text-red-600 dark:text-red-400">50%</td>
                  ...
                  <div className="bg-amber-50 dark:bg-amber-950/30 p-4 rounded-lg border border-amber-200 dark:border-amber-800 mt-4">
                    <p className="font-semibold text-amber-900 dark:text-amber-100 mb-2">⚠️ 최대주주 할증과세</p>
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                      상장법인 지분 비율이 일정 기준을 초과하면 상속세에 20%가 추가 과세됩니다. 
                      (최대 60% 세율 적용 가능)
                    </p>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="prose dark:prose-invert max-w-none">
                    ...
                    {[
                      {
                        step: 1,
                        title: '상속재산 평가',
                        description: '피상속인의 모든 재산(부동산, 예금, 주식 등)을 시가로 평가합니다.',
                        formula: '총 상속재산'
                      },
                      {
                        step: 2,
                        title: '공제 전 상속액 계산',
                        description: '상속재산에서 채무(부채, 장례비 등)를 차감합니다.',
                        formula: '상속재산 - 채무 = 공제 전 상속액'
                      },
                      {
                        step: 3,
                        title: '각종 공제 적용',
                        description: '기초공제, 배우자공제, 자녀공제 등을 차감합니다.',
                        formula: '공제 전 상속액 - 각종 공제 = 과세표준'
                      },
                      {
                        step: 4,
                        title: '세율 적용',
                        description: '과세표준에 따라 10%~50% 세율을 적용합니다.',
                        formula: '과세표준 × 세율 - 누진공제 = 산출세액'
                      },
                      {
                        step: 5,
                        title: '최종 납부세액',
                        description: '세액공제(증여세액공제 등)를 적용하여 최종 납부액을 계산합니다.',
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800 mt-6">
                    <p className="font-semibold text-blue-900 dark:text-blue-100 mb-2">💡 계산 예시</p>
                    <div className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                      <p>총 상속재산: 20억원</p>
                      <p>채무: 2억원</p>
                      <p>배우자공제: 10억원, 기초공제: 2억원</p>
                      <p className="font-semibold pt-2">→ 과세표준: 6억원</p>
                      <p className="font-semibold">→ 상속세: 약 1억 2천만원 (20% 세율 적용)</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
