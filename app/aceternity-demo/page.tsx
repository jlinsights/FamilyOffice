...
const testimonials = [
  {
    quote: "FamilyOffice S의 자산 관리 서비스는 정말 탁월합니다. 우리 가족의 재정 목표를 체계적으로 관리할 수 있게 되었습니다.",
    name: "김철수",
    title: "삼성전자 부회장",
  },
  {
    quote: "상속 계획과 세무 최적화에서 전문적인 컨설팅을 받았습니다. 차세대 승계 준비가 완벽하게 되었습니다.",
    name: "이영희",
    title: "현대그룹 회장",
  },
  {
    quote: "글로벌 투자 포트폴리오 구성에서 뛰어난 성과를 얻었습니다. 리스크 관리도 완벽합니다.",
    name: "박민수",
    title: "LG전자 대표이사",
  },
  {
    quote: "가족 거버넌스 시스템 구축에서 체계적인 도움을 받았습니다. 다음 세대 교육도 훌륭합니다.",
    name: "최지현",
    title: "SK하이닉스 부회장",
  },
];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <Button className="mt-8 bg-white text-black hover:bg-gray-200" size="lg">
            상담 신청하기
          </Button>
        </div>
        ...
        <HeroHighlight containerClassName="h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
              30년 이상의 경험과 전문성으로 한국 재벌가문들의 자산을 관리해온 노하우를
              바탕으로 맞춤형 솔루션을 제공합니다.
            </p>
          </div>
        </HeroHighlight>
      ...
      <section className="py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            한국 대기업 총수들이 신뢰하는 FamilyOffice S의 서비스 품질을 확인해보세요
          </p>
        </div>
        <InfiniteMovingCards
          items={testimonials}
