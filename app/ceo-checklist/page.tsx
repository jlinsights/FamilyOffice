...
const checklistCategories = {
  ...
  succession: {
    ...
    items: [
      ...
      {
        id: 'next-gen-education',
        label: '차세대 경영자 교육 프로그램',
        critical: true,
      },
      {
        id: 'inheritance-gift-tax',
        label: '상속·증여세 절세 전략 수립',
        critical: true,
      },
...
const CEOChecklistPage = () => {
  ...
  const calculateCategoryProgress = (
    category: keyof typeof checklistCategories
  ) => {
  ...
  const calculateOverallProgress = () => {
    const allItems = Object.values(checklistCategories).flatMap(
      cat => cat.items
    );
  ...
  const calculateCriticalProgress = () => {
    ...
    const checkedCritical = criticalItems.filter(item =>
      checkedItems.has(item.id)
    ).length;
              ...
              <Card className="border-orange-200 bg-orange-50/80 backdrop-blur-sm dark:border-orange-800/30 dark:bg-orange-950/20">
                ...
                <CardContent>
                  ...
                  <Progress
                    ...
                    className="h-2 bg-orange-100 dark:bg-orange-950/50"
                  />
                </CardContent>
              </Card>
              ...
              <TabsContent value="all" className="space-y-6">
                {Object.entries(checklistCategories).map(([key, category]) => {
                  ...
                  const progress = calculateCategoryProgress(
                    key as keyof typeof checklistCategories
                  );
                        ...
                        <div className="space-y-3">
                          {category.items.map(item => (
                            ...
                            >
                              ...
                              >
                                <span
                                  className={item.critical ? 'font-medium' : ''}
                                >
                                  {item.label}
                                </span>
                                {item.critical && (
              ...
              <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold mb-4 font-playfair">
                    <span className="text-premium-gold">CEO 경영진단</span>을
                    넘어선{' '}
                  ...
                  <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                    ...
                    으로 업그레이드하세요. 성공한 CEO들이 선택한 차별화된
                    패밀리오피스 서비스를 경험해보세요.
                  </p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white/60 dark:bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 border border-amber-100 dark:border-amber-900/30 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <h4 className="font-bold text-lg mb-2 text-premium-navy dark:text-amber-300">
                        경영·재무 통합관리
                      </h4>
                      <p className="text-muted-foreground text-sm">
                        기업 경영진단부터 자산관리까지 원스톱 통합 솔루션
                      </p>
                    </div>
                    ...
                    <div className="bg-white/60 dark:bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 border border-blue-100 dark:border-blue-900/30 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <h4 className="font-bold text-lg mb-2 text-premium-navy dark:text-blue-300">
                        전략적 성장지원
                      </h4>
                      <p className="text-muted-foreground text-sm">
                        CEO 개인 자산과 기업 성장을 동시에 고려한 장기 전략
                      </p>
                    </div>
                    ...
                    <div className="bg-white/60 dark:bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 border border-purple-100 dark:border-purple-900/30 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <h4 className="font-bold text-lg mb-2 text-premium-navy dark:text-purple-300">
                        리스크 총괄관리
                      </h4>
                      <p className="text-muted-foreground text-sm">
                        경영·세무·법무·보험을 통합한 종합 리스크관리
                      </p>
                    </div>
                  </div>
                ...
                <div className="text-center space-y-8">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground dark:text-gray-300">
                      {criticalProgress < 50 &&
                        '필수 항목의 준비가 시급합니다. 전문가 상담을 권해드립니다.'}
                      {criticalProgress >= 50 &&
                        criticalProgress < 80 &&
                        '양호한 수준이나 몇 가지 개선이 필요합니다.'}
                      {criticalProgress >= 80 &&
                        '우수한 경영 관리 수준입니다. 지속적인 관리가 중요합니다.'}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                    ...
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full h-full min-h-[3.5rem] dark:bg-slate-800 dark:text-white dark:border-slate-700 dark:hover:bg-slate-700"
                    >
              ...
              {criticalProgress >= 50 && criticalProgress < 80 && (
                <>
                  ...
                  <Card className="border-purple-200 bg-purple-50/50 backdrop-blur-sm dark:border-purple-800/30 dark:bg-purple-950/20">
                    ...
                    <CardContent>
                      <p className="text-sm mb-4 text-card-foreground/80">
                        차세대 경영자 교육과 지분 구조 최적화로 안정적인 승계를
                        준비하세요.
                      </p>
                      <Button variant="outline" size="sm" className="w-full">
                        승계 컨설팅
              ...
              {criticalProgress >= 80 && (
                <>
                  <Card className="border-green-300 bg-green-50/70 backdrop-blur-sm dark:border-green-700/40 dark:bg-green-950/30">
                    ...
                    <CardContent>
                      <p className="text-sm mb-4 text-card-foreground/80">
                        훌륭한 경영 관리 수준입니다. 지속적인 모니터링과 개선을
                        추천드립니다.
                      </p>
                      <Button variant="outline" size="sm" className="w-full">
                        프리미엄 자문 서비스
