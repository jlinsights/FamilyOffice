...
export default function MembershipContent() {
  ...
  const tiers = [
    ...
    },
    {
      name: 'Elite',
      tier: 'Premium',
      desc: '전담 컨시어지가 일상의 모든 선택을 대신하는 맞춤 라이프 매니지먼트',
      features: [
    ...
    <div className="font-sans text-slate-800 bg-background min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">
        ...
        >
          ...
          <div
            className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-amber-500/10 rounded-full blur-[100px] animate-pulse"
            ...
            <FadeIn delay={0.2} direction="down">
              <div className="flex justify-center mb-14">
                <div className="relative group">
                  ...
                  <Badge
                    variant="outline"
                    className="relative px-6 py-2 text-sm border-amber-500/30 text-amber-200/90 bg-slate-900/80 hover:bg-slate-900/90 backdrop-blur-xl transition-all duration-300 shadow-lg"
                  >
        ...
        <section
          id="philosophy"
          className="section bg-white dark:bg-slate-900 py-24 md:py-32 relative overflow-hidden"
        >
          ...
          <div className="container relative z-10">
            <FadeIn direction="up">
              <div className="text-center mb-20">
                <Badge
                  variant="outline"
                  className="mb-6 px-4 py-1.5 border-amber-500/30 text-amber-700 dark:text-amber-400 bg-amber-50/50 dark:bg-amber-500/10"
                >
            ...
            <FadeIn direction="up" delay={0.2} stagger={0.15}>
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={idx}
                    className="group relative p-8 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-200 dark:border-slate-700/50 hover:border-amber-500/30 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-3"
                  >
                    {/* Hover Glow */}
                    ...
                    {/* Icon */}
                    <div
                      className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                    >
                      <div className="text-white">{item.icon}</div>
                    </div>

                    <div className="relative z-10">
                      <p className="text-xs text-amber-600 dark:text-amber-400 font-semibold uppercase tracking-widest mb-2">
                        {item.subtitle}
                      </p>
        ...
        <section
          id="benefits"
          className="section bg-slate-950 text-white relative overflow-hidden py-24 md:py-32"
        >
          {/* Premium Background Effects */}
          ...
          <div className="container relative z-10">
            <FadeIn direction="up">
              <div className="mb-20 max-w-3xl">
                <Badge
                  variant="outline"
                  className="mb-6 px-4 py-1.5 border-amber-500/30 text-amber-400 bg-amber-500/10"
                >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  ...
                  >
                    ...
                    {/* Icon with Gradient */}
                    <div
                      className={`relative inline-flex p-4 rounded-2xl bg-gradient-to-br ${service.gradient} shadow-lg mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                    >
        ...
        <section
          id="membership"
          className="section bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-900/95 dark:to-slate-900 relative overflow-hidden"
        >
          {/* Decorative Elements */}
            ...
            <FadeIn direction="up">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed text-balance">
                  자산 규모와 라이프스타일을 분석해 최적의 멤버십을
                  추천드립니다.
                  <br className="hidden md:block" />
                  Foundation부터 Legacy까지, 당신의 상황에 맞는 등급을
                  제안합니다.
                </p>
              </div>
            </FadeIn>
                ...
                {tiers.map((tier, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Tier Icon */}
                      <div
                        className={`w-12 h-12 mb-6 rounded-xl flex items-center justify-center bg-gradient-to-br ${colors.gradient} shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
                        {index === 0 && (
                      ...
                      <div className="mb-4 relative z-10">
                        <h3
                          className={`text-2xl font-bold mb-2 ${tier.isPopular ? 'text-white' : 'text-foreground'}`}
                        >
                          {tier.name}
                        </h3>
                        <p
                          className={`text-xs font-semibold uppercase tracking-widest ${tier.isPopular ? 'text-blue-300' : `text-${colors.accent}-600 dark:text-${colors.accent}-400`}`}
                        >
                          {tier.tier}
                        </p>
                      </div>
                      <div
                        className={`mb-6 pb-6 border-b relative z-10 ${tier.isPopular ? 'border-slate-700' : 'border-slate-200 dark:border-slate-700'}`}
                      >
                        <p
                          className={`text-sm leading-relaxed min-h-[60px] ${tier.isPopular ? 'text-slate-300' : 'text-muted-foreground'}`}
                        >
                          {tier.desc}
                        </p>
                      </div>
                      <ul className="space-y-4 mb-8 flex-grow relative z-10">
                        {tier.features.map((feature, idx) => (
                          <li key={idx} className="flex items-start text-sm">
                            <div
                              className={`w-5 h-5 rounded-full flex items-center justify-center mr-3 flex-shrink-0 ${tier.isPopular ? 'bg-blue-500/20' : 'bg-slate-100 dark:bg-slate-700'}`}
                            >
                              <Check
                                className={`h-3 w-3 ${tier.isPopular ? 'text-blue-400' : `text-${colors.accent}-500`}`}
                              />
                            </div>
                            <span
                              className={
          ...
          <div className="container relative z-10">
            <FadeIn direction="up">
              <div className="text-center mb-20">
                <Badge
                  variant="outline"
                  className="mb-6 px-4 py-1.5 border-slate-300 dark:border-slate-700 text-slate-600 dark:text-slate-400 bg-slate-100/50 dark:bg-slate-800/50"
                >
                ...
                {[
                  {
                    step: '01',
                    title: '간단 진단',
                    desc: '10분 설문을 통해 목적과 취향, 제약사항을 파악합니다.',
                    icon: <FileText className="h-5 w-5" />,
                  },
                  {
                    step: '02',
                    title: '등급 제안',
                    desc: '고객님의 상황에 최적화된 멤버십 등급과 범위를 제안드립니다.',
                    icon: <Star className="h-5 w-5" />,
                  },
                  {
                    step: '03',
                    title: '온보딩',
                    desc: '선호/금기사항, 캘린더, 예산, 동행자 정보를 등록합니다.',
                    icon: <Users className="h-5 w-5" />,
                  },
                  {
                    step: '04',
                    title: '실행 & 큐레이션',
                    desc: '요청 시 기획안 제시 후 예약 및 섭외, 사후 정리까지 수행합니다.',
                  ...
                  <div key={index} className="relative group">
                    ...
                    {index < 3 && (
                      <ArrowRight
                        className="hidden md:block absolute top-8 -right-3 text-amber-500/30 z-20"
                        size={20}
                      />
                    )}
                  </div>
        ...
        <section
          id="faq"
          className="section bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 py-24 md:py-32 relative overflow-hidden"
        >
          {/* Decorative Elements */}
          ...
          <FadeIn direction="up">
            <div className="max-w-4xl mx-auto px-6 relative z-10">
              <div className="text-center mb-16">
                <Badge
                  variant="outline"
                  className="mb-6 px-4 py-1.5 border-slate-300 dark:border-slate-700 text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-800/50"
                >
                  FAQ
                </Badge>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <span className="font-semibold text-foreground text-sm sm:text-base md:text-lg pr-2 sm:pr-4">
                          {faq.q}
                        </span>
                      </div>
                      <div
                      ...
                      >
                        <ChevronDown
                          className={`flex-shrink-0 transition-colors ${activeFaq === index ? 'text-amber-500' : 'text-muted-foreground'}`}
                          size={16}
                        />
                      </div>
                    </button>
              ...
              <div className="mt-24 text-center relative">
                ...
                <div className="relative bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-3xl p-12 shadow-xl">
                  ...
                  <p className="text-muted-foreground mb-10 text-lg max-w-2xl mx-auto">
                    10분이면 충분합니다. 자산 구조와 라이프스타일을 분석해
                    <br className="hidden md:block" />
          ...
          <div className="container">
            <FadeIn direction="up">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <span className="text-xl font-serif font-bold text-white tracking-tight block mb-4">
                    FamilyOffice S Premium Membership
                  </span>
                  <p className="text-sm max-w-lg leading-relaxed text-slate-400 mb-4">
                    시간, 선택, 품격을 관리하는 프라이빗 컨시어지 서비스.
                    <br />
                    아트·트래블·라이프스타일 큐레이션과 자산관리를 통합한
                    <br />
                    독립적인 멤버십 프로그램입니다.
                  </p>
                ...
                <div className="md:pl-8">
                  ...
                  <ul className="text-sm space-y-2 text-slate-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        기획·섭외·우선권 제공이 핵심이며, 실비(항공·숙박·식음료
                        등)는 멤버 부담
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="h-4 w-4 text-amber-500 mt-0.5 flex-shrink-0" />
                      <span>
                        예약 보증금 제도 운용 (노쇼 방지 및 서비스 품질 유지)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="h-4 w-4 text-amber-500 mt-0.5 flex-shrink-0" />
              ...
              <div className="border-t border-slate-800 pt-8 mt-8 text-xs text-slate-500 leading-relaxed">
                <p className="mb-3 font-bold text-slate-400 text-sm">
                  중요 공지사항 (Legal Disclaimer)
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1.5">
                      <li>
                        본 멤버십은 보험 상품 및 금융상품의 체결·유지와{' '}
                        <span className="text-amber-500 font-semibold">
                          완전히 분리
                        </span>
                        된 독립적인 라이프스타일 서비스입니다.
                      </li>
                      <li>
                        보험 가입 여부와 관계없이 자산 규모 및 서비스 니즈만으로
                        가입·이용 가능합니다.
                      </li>
                      <li>
                        멤버십 가입이 보험 상품 구매를 조건으로 하거나, 보험
                        가입으로 인한 특별 이익이 아님을 명시합니다.
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1.5">
                      <li>
                        여행·호텔·전시·이벤트 등은 기획·섭외·우선권 제공이
                        중심이며, 실비는 멤버 부담입니다.
                      </li>
                      <li>
                        전문가(세무·법무·의료) 연결 서비스는 멤버십에 포함되나,
                        실제 자문 용역 비용은 별도입니다.
                      </li>
                      <li>
                        제휴 파트너사의 서비스 품질 및 가격 변동에 대한 직접
                        책임은 해당 파트너사에 있습니다.
                      </li>
                    </ul>
                  </div>
