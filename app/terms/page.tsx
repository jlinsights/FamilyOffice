            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="pl-4 space-y-4">
                  <p>① 이용자 약관(이하 &ldquo;본 약관&rdquo;)은 이용자가 에서 제공하는 인터넷 관련 서비스(이하 &ldquo;서비스&rdquo;)를 이용함에 있어 이용자와 의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
                  <p>② 이용자가 되고자 하는 자가 패밀리오피스가 정한 소정의 절차를 거쳐서 &ldquo;동의&rdquo; 단추를 누르면 본 약관에 동의하는 것으로 간주합니다.</p>
              ...
              <section>
                ...
                <div className="pl-4">
                  <p>&ldquo;이용자&rdquo;란 패밀리오피스에 접속하여 본 약관에 따라 홈페이지에 회원으로 가입하여 패밀리오피스가 제공하는 서비스를 받는 자를 말합니다.</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="pl-4 space-y-4">
                  <p>① 이용자가 되고자 하는 자는 패밀리오피스가 정한 가입 양식에 따라 회원정보를 기입하고 &ldquo;가입하기&rdquo; 단추를 누르는 방법으로 회원 가입을 신청합니다.</p>
