...
export const metadata: Metadata = {
  ...
  description:
    'FamilyOffice S 개인정보처리방침을 확인하세요. 개인정보 수집, 이용, 보관에 관한 상세한 정책을 제공합니다.',
      ...
      <main className="pt-20">
        ...
        <section className="relative w-full min-h-[60vh] flex flex-col items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background dark:from-background dark:via-muted/10 dark:to-background pt-20">
          <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
            ...
            >
              FamilyOffice S의 개인정보 수집, 이용, 보관에 관한 상세한 정책을
              확인하세요
            </p>
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <div className="pl-4 space-y-4">
                    <p>
                      FamilyOffice S(&apos;회사&apos;라 함)는 다음의 목적을
                    ...
                    <p>
                      자산관리 상담, 맞춤형 서비스 제공, 본인인증, 서비스 제공에
                      관한 계약 이행 및 서비스 제공에 따른 요금정산 목적으로
                      개인정보를 처리합니다.
                    </p>
                    ...
                    <p>
                      ...
                      접속빈도 파악 또는 회원의 서비스 이용에 대한 통계 등을
                      목적으로 개인정보를 처리합니다.
                    </p>
                  </div>
                </section>
                  ...
                  <div className="pl-4 space-y-4">
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg mt-4">
                      ...
                      <ul className="space-y-2">
                        <li>
                          • <strong>회원가입 및 관리:</strong> 회원탈퇴 시까지
                          (단, 관련 법령에 보존의무가 있는 경우 해당 기간까지)
                        </li>
                        <li>
                          • <strong>자산관리 서비스 제공:</strong> 서비스 종료
                          후 3년
                        </li>
                        <li>
                        ...
                        <li>
                          • <strong>표시·광고에 관한 기록:</strong> 6개월
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <section>
                  ...
                  <div className="pl-4 space-y-4">
                    <p>
                      ① 회사는 개인정보를 제1조(개인정보의 처리목적)에서 명시한
                      범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한
                      규정 등 개인정보보호법 제17조 및 제18조에 해당하는
                      경우에만 개인정보를 제3자에게 제공합니다.
                    </p>

                    <p>
                      ② 회사는 다음과 같이 개인정보를 제3자에게 제공하고
                      있습니다.
                    </p>
                ...
                <section>
                  ...
                  <div className="pl-4 space-y-4">
                    ...
                    <p>
                      ② 제1항에 따른 권리 행사는 회사에 대해 서면, 전화,
                      전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 회사는
                      이에 대해 지체없이 조치하겠습니다.
                    </p>
                    ...
                    <p>
                      ...
                      경우 개인정보보호법 시행규칙 별지 제11호 서식에 따른
                      위임장을 제출하셔야 합니다.
                    </p>
                  </div>
                </section>
                  ...
                  <div className="pl-4 space-y-4">
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg mt-4">
                      ...
                      <ul className="space-y-2 text-sm">
                        <li>
                          • <strong>전자적 파일형태:</strong> 기록을 재생할 수
                          없도록 로우레벨포맷(Low Level Format) 등의 방법을
                          이용하여 파기
                        </li>
                        <li>
                          • <strong>종이 문서:</strong> 분쇄기로 분쇄하거나
                          소각하여 파기
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="pl-4 space-y-4">
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg mt-4">
                      ...
                      <ul className="space-y-2">
                        ...
                        <li>• 직책: 개인정보보호책임자</li>
                        <li>
                          • 연락처: 0502-5550-8700, info@familyoffices.vip
                        </li>
                      </ul>
                    ...
                    <p>
                      ...
                      발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
                      등에 관한 사항을 개인정보 보호책임자 및 담당부서로
                      문의하실 수 있습니다. 회사는 정보주체의 문의에 대해
                ...
                <section>
                  ...
                  <div className="pl-4 space-y-4">
                    <p>
                      정보주체는 아래의 기관에 대해 개인정보 침해신고, 상담등을
                      문의하실 수 있습니다.
                    </p>
                    <p className="text-sm text-muted-foreground">
                      (아래의 기관은 회사와는 별개의 기관으로서, 회사의 자체적인
                      개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg mt-4 space-y-4">
                      <div>
                        <h3 className="font-semibold">
                          ▶ 개인정보보호위원회 : (국번없이) 1833-6972
                          (privacy.go.kr)
                        </h3>
                      </div>
                      <div>
                        <h3 className="font-semibold">
                          ▶ 개인정보 침해신고센터 : (국번없이) privacy.go.kr
                        </h3>
                      </div>
                      <div>
                        <h3 className="font-semibold">
