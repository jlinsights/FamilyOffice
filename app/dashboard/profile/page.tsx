    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 dark:bg-[#0f172a] pt-24 pb-16 transition-colors duration-500">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-3xl font-playfair font-bold text-slate-900 dark:text-white mb-2">계정 설정</h1>
            ...
            <UserProfile 
              ...
              appearance={{
                elements: {
                  ...
                  navbarButton: "text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800",
                  ...
                  profileSectionPrimaryButton: "bg-premium-navy text-white hover:opacity-90 transition-opacity",
                  ...
                  formFieldInput: "bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white",
