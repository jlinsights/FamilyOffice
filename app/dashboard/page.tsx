              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="group relative p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 shadow-premium dark:shadow-none hover:border-premium-gold/50 transition-all duration-300">
                  ...
                  <p className="text-2xl font-playfair font-bold text-premium-navy dark:text-premium-navy-enhanced">
                    Standard{' '}
                    <span className="text-sm font-sans font-normal text-slate-500 dark:text-slate-500">
                      Plan
                    </span>
                  </p>
                ...
                <div className="group relative p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 shadow-premium dark:shadow-none hover:border-premium-gold/50 transition-all duration-300">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2 min-h-[3rem]">
                    접수된 상담 내역을 검토하고 있습니다. 곧 담당자가 배정될
                    예정입니다.
                  </p>
                  <Link
                    href="/structure-check"
                    className="inline-flex items-center text-sm font-medium text-slate-900 dark:text-white mt-4 hover:text-premium-gold transition-colors"
                  >
                    구조 점검 요청 <ChevronRight className="w-4 h-4 ml-1" />
                  </Link>
                </div>
              </div>
              ...
              <div className="sticky top-24">
                <div className="glass-premium-enhanced rounded-3xl p-1 overflow-hidden relative group">
                  ...
                  <div className="bg-white/90 dark:bg-slate-950/90 backdrop-blur-md rounded-[20px] p-6 mobile-card-padding flex flex-col items-center text-center relative overflow-hidden">
                    ...
                    {/* User Info */}
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1 z-10 font-playfair">
                      {fullName}
                    </h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 z-10 font-medium">
                      {email}
                    </p>
                    ...
                    <div className="w-full bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 mb-6 border border-slate-100 dark:border-slate-800 flex items-center justify-between group-hover:border-premium-gold/30 transition-colors">
                      <div className="text-left">
                        ...
                        <p className="text-lg font-bold text-premium-navy dark:text-premium-navy-enhanced">
                          Standard
                        </p>
                      </div>
...
function QuickActionCard({
  ...
  return (
    <Link
      href={href}
      className="group p-5 rounded-2xl bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 hover:border-premium-gold hover:shadow-premium-gold transition-all duration-300 flex flex-col items-start gap-4"
    >
      ...
      <div>
        <h4 className="font-bold text-slate-900 dark:text-white mb-1 group-hover:underline decoration-premium-gold/50 underline-offset-4">
          {title}
        </h4>
