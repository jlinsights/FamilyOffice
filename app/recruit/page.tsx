  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50/30 to-white dark:from-gray-900 dark:via-gray-900/50 dark:to-gray-900">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="py-20 bg-gradient-to-r from-primary/10 to-blue-600/10 dark:from-primary/20 dark:to-blue-600/20">
          <div className="container mx-auto px-6 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-slide-up text-gray-900 dark:text-white">
              함께 성장할 <span className="text-primary dark:text-emerald-300">인재</span>를 찾습니다
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up dark:text-gray-200" style={{ animationDelay: '200ms' }}>
              글로벌 자산관리 전문가로 성장하고 싶은 분들을 기다립니다.<br />
              패밀리오피스 S에서 당신의 커리어를 한 단계 높여보세요.
            </p>
          </div>
        </section>
