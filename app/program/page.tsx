      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        ...
        <h1 className="font-black text-5xl md:text-7xl lg:text-8xl leading-tight mb-8 tracking-tight text-white">
          <span className="block mb-2">
              <TextReveal delay={0.4} type="word">성공한 기업가와</TextReveal>
          </span>
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
              <TextReveal delay={0.6} type="word">자산가들의 공간</TextReveal>
          </span>
        </h1>
        ...
        <FadeIn delay={0.8} className="max-w-3xl mx-auto mb-12">
            <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
             검증된 500+ 기업가와 함께하는<br className="md:hidden" /> 프리미엄 네트워킹 & 통합자산관리 클럽
            </p>
        </FadeIn>

        {/* CTA Buttons */}
        <FadeIn delay={1.0} className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Link
