      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl shadow-2xl border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          <CardContent className="text-center p-8">
            ...
            <p className="text-muted-foreground mb-6">프로필을 보려면 먼저 로그인해주세요.</p>
                ...
                <div className="space-y-4">
                  ...
                  {userRecord?.kakao_id && (
                    <div className="grid gap-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">연동 일시:</span>
                        <span>{userRecord.updated_at ? new Date(userRecord.updated_at).toLocaleDateString('ko-KR') : '알 수 없음'}</span>
                      </div>
                    </div>
                  )}
                </div>
