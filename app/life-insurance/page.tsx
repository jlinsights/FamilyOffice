      ...
      <main className="pt-20">
        ...
        <div className="container mx-auto px-6 py-4">
          <BreadcrumbNavigation customItems={[
            ...
            { name: '개인/법인 종신보험', url: 'https://familyoffices.vip/life-insurance', isCurrentPage: true }
          ]} />
        </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
                <strong>중견기업 CEO</strong>와 <strong>고액자산가 (30억+)</strong>를 위한<br />
                <span className="text-primary font-semibold">평생보장 + 상속세 해결 + 퇴직금 확보</span> 통합 솔루션
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-primary mb-1">평생</div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                왜 <span className="text-primary">CEO에게</span> 종신보험이 필수인가?
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                성공한 기업가일수록 <strong>예측 불가능한 리스크</strong>에 대비해야 합니다.<br />
                종신보험은 <span className="font-semibold text-primary">CEO 유고시 기업 안정성 확보</span>부터 <span className="font-semibold text-primary">체계적인 가업승계</span>까지 해결하는 핵심 도구입니다.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="text-center hover:shadow-xl hover:shadow-black/5 dark:hover:shadow-white/5 transition-all duration-300 border-primary/50 dark:border-primary/30 bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-primary">종신보험 솔루션</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    <strong>평생보장</strong> + <strong>세무혜택</strong><br />
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                ...
                <span className="font-semibold text-primary">최적의 조합</span>으로 설계하는 것이 핵심입니다.
              </p>
            </div>
                      ...
                      <tbody>
                        {comparisonData.map((item, index) => (
                          <tr key={index} className="border-b hover:bg-muted/30">
                            ...
                            <td className="py-4 px-4 text-center text-sm">{item.personal}</td>
                            <td className="py-4 px-4 text-center text-sm">{item.corporate}</td>
                            <td className="py-4 px-4 text-center text-sm font-medium text-green-600">{item.advantage}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <div className="font-semibold">상속세 비과세 혜택</div>
                          <div className="text-sm text-muted-foreground">법정상속인 수령 시 상속세 과세 제외</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">사망 즉시 보험금으로 상속세 납부 가능</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">기업 리스크와 분리된 안전한 자산</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                        <div className="font-semibold text-orange-800 dark:text-orange-200 mb-2">추천 설계 방법</div>
                        <div className="text-sm space-y-1">
                          <div>• <strong>보험금액:</strong> 예상 상속세의 120-150%</div>
                          <div>• <strong>수익자:</strong> 배우자 + 자녀 비율 설정</div>
                          <div>• <strong>납입방법:</strong> 전기납 또는 단축납</div>
                          <div>• <strong>연계상품:</strong> 배우자 종신보험 동시 가입</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <div className="font-semibold">보험료 100% 손금처리</div>
                          <div className="text-sm text-muted-foreground">법인세 절감으로 실질 보험료 부담 감소</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <div className="font-semibold">해약환급금 퇴직금 활용</div>
                          <div className="text-sm text-muted-foreground">CEO 퇴직시 목돈 확보 + 세무상 유리</div>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">금융기관 평가 시 CEO 리스크 관리 인정</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                        <div className="font-semibold text-green-800 dark:text-green-200 mb-2">추천 설계 방법</div>
                        <div className="text-sm space-y-1">
                          <div>• <strong>보험금액:</strong> 연매출의 50-100%</div>
                          <div>• <strong>수익자:</strong> 법인 (일부 가족 수익자)</div>
                          <div>• <strong>납입방법:</strong> 정기납 (현금흐름 고려)</div>
                          <div>• <strong>연계활용:</strong> 임원퇴직금 + 상속자금</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                <strong>중견기업 CEO</strong>들이 종신보험으로 얻은 <strong>실제 성과</strong>를 확인해보세요.<br />
                평균 <span className="font-semibold text-primary">50% 이상 절세</span> + <span className="font-semibold text-primary">완벽한 리스크 관리</span>를 달성했습니다.
              </p>
            </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                        <h4 className="font-semibold mb-3 text-center">핵심 수치</h4>
                        <div className="space-y-3">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-muted-foreground">보험료</span>
                            <span className="font-semibold text-primary">{successCases[selectedCase]?.premium}</span>
                          </div>
                          <div className="flex justify-between items-center">
        ...
        <section className="py-20 bg-muted/20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                <span className="text-primary">종신보험 전문 설계</span> 프로세스
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                <strong>20년 경력</strong>의 전문가가 <strong>체계적인 6단계 프로세스</strong>로<br />
                CEO님만의 <span className="font-semibold text-primary">최적 종신보험</span>을 설계합니다.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "기업 규모, 개인 자산, 가족 구성원, 기존 보험 현황을 종합 분석",
                  duration: "1주",
                  details: ["기업 재무현황 분석", "개인 자산구조 파악", "기존 보험 점검", "리스크 요인 진단"]
                },
                {
                  step: "2단계", 
                  title: "세무 시뮬레이션",
                  icon: <Calculator className="h-6 w-6" />,
                  description: "상속세 예상액, 법인세 절감효과, 개인소득세 영향도를 정밀 계산",
                  duration: "3-5일",
                  details: ["상속세 산출", "법인세 절감액 계산", "개인세 영향 분석", "최적 납입방법 도출"]
                },
                {
                  step: "3단계",
                  title: "맞춤 설계 제안", 
                  icon: <Target className="h-6 w-6" />,
                  description: "개인/법인 종신보험 최적 조합과 보장금액, 납입방법을 제안",
                  duration: "1주",
                  details: ["개인/법인 비율 설계", "보장금액 산정", "납입기간 최적화", "수익자 구조 설계"]
                },
                {
                  step: "4단계",
                  title: "보험사 선정",
                  icon: <Award className="h-6 w-6" />,
                  description: "수익률, 안정성, 서비스를 종합 비교하여 최적 보험사 선정",
                  duration: "3-5일", 
                  details: ["보험사별 수익률 비교", "재무건전성 분석", "상품 특약 비교", "서비스 품질 평가"]
                },
                {
                  step: "5단계",
                  title: "계약 체결",
                  icon: <FileCheck className="h-6 w-6" />,
                  description: "계약서 검토, 건강진단, 서류 준비부터 계약 완료까지 전 과정 지원",
                  duration: "2주",
                  details: ["계약서 상세 검토", "건강진단 지원", "필요서류 준비", "계약 체결 완료"]
                },
                {
                  step: "6단계",
                  title: "지속 관리",
                  icon: <Users className="h-6 w-6" />,
                  description: "연 1회 정기점검, 세법 변화 대응, 보장내용 최적화 등 평생 관리",
                  duration: "평생",
                ...
                <Card key={index} className="hover:shadow-lg hover:shadow-black/5 dark:hover:shadow-white/5 transition-all duration-300 group bg-gradient-to-br from-card to-card/50 dark:from-card/80 dark:to-card/30">
                  <CardHeader>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <Badge variant="outline" className="mb-2">{process.step}</Badge>
        ...
        <section className="py-20 bg-gradient-to-r from-primary/10 to-blue-600/10">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              <strong>20년 경력 전문가</strong>가 CEO님의 상황에 최적화된<br />
              <span className="font-semibold text-primary">개인/법인 종신보험 통합 설계</span>를 무료로 제공합니다.
            </p>
            
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto mb-8">
              <h3 className="font-semibold text-lg mb-4">🎯 무료 설계에 포함된 내용</h3>
            ...
            <div className="text-sm text-muted-foreground mt-6 space-y-1">
              <div>💡 평균 상담 시간: 60분 | 설계 완료: 1주일 | 추가 비용: 무료</div>
