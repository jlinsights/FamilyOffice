...
export const metadata: Metadata = {
  title:
    '개인/법인 종신보험 | FamilyOffice S - 평생보장 + 세무최적화 통합 솔루션',
  description:
    'CEO와 고액자산가를 위한 개인/법인 종신보험 전문 설계. 평생보장 사망보험금, 해약환급금 퇴직금 활용, 상속세 납부재원 확보, 법인 손금처리로 세무최적화까지. 삼성생명 1000억+ 실적.',
  keywords: [
    '개인종신보험',
    '법인종신보험',
    '종신보험 설계',
  ...
  openGraph: {
    ...
    description:
      'CEO와 고액자산가를 위한 종신보험 전문 설계. 평생보장 + 상속세 납부재원 + 세무최적화 통합 솔루션. 삼성생명 1000억+ 실적으로 검증된 신뢰성.',
  ...
  twitter: {
    ...
    description:
      'CEO와 고액자산가를 위한 종신보험 전문 설계. 평생보장 + 세무최적화 통합 솔루션.',
