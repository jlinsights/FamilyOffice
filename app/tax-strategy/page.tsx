      ...
      <main className="pt-20">
        ...
        <section className="relative w-full min-h-[85vh] flex flex-col items-center justify-center bg-gradient-to-br from-background via-muted/20 to-background overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
            ...
            >
              삼성생명과 함께하는 <span className="font-semibold text-primary">체계적인 절세 전략</span>으로{' '}
              <span className="font-semibold text-emerald-600">법인세 30%, 소득세 40%, 상속세 50%</span> 절감을 경험하세요
            </p>
            ...
            >
              ...
              />
              <Button variant="outline" size="lg" className="font-bold px-8 py-4 text-lg shadow-lg" asChild>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
              {[
                { value: "40%", label: "평균 절세율", color: "text-emerald-600" },
                { value: "500+", label: "성공 사례", color: "text-blue-600" },
                { value: "20년", label: "전문 경력", color: "text-purple-600" },
                { value: "98%", label: "고객 만족도", color: "text-orange-600" }
              ].map((stat, index) => (
                <div key={index} className="text-center p-4 bg-white/50 dark:bg-gray-900/50 rounded-xl backdrop-blur-sm border border-white/20">
        ...
        <section ref={statsSectionRef} className="py-20 bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-900/10 dark:to-blue-900/10">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
                <span className="text-primary">나의 절세 효과</span> 미리 확인하기
              </h2>
                  ...
                  <CardContent className="relative z-10">
                    <div className="space-y-4 mb-6">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">절세 전</span>
        ...
        <section id="strategies" className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-12">
                삼성생명과 함께하는 검증된 절세 전략으로 세금 부담을 혁신적으로 줄여보세요
              </p>
            </div>

            <Tabs defaultValue="corporate" className="w-full">
              <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-3 mb-12">
                <TabsTrigger value="corporate" className="text-sm font-semibold">
                  법인 절세
                </TabsTrigger>
                <TabsTrigger value="personal" className="text-sm font-semibold">
                  개인 절세
                </TabsTrigger>
                <TabsTrigger value="succession" className="text-sm font-semibold">
                  승계 절세
                </TabsTrigger>
              </TabsList>
                  ...
                  {[
                    ...
                    <Card key={index} className="group bg-card dark:bg-card/80 border-border/40 dark:border-border hover:shadow-2xl dark:hover:shadow-white/5 transition-all duration-500 relative overflow-hidden">
                      ...
                      <CardHeader className="relative z-10">
                        ...
                        <CardTitle className="text-xl font-bold mb-2">{strategy.title}</CardTitle>
                        <CardDescription className="text-sm">{strategy.description}</CardDescription>
                      </CardHeader>

                      <CardContent className="relative z-10">
                        <div className="space-y-3 mb-6">
                          {strategy.benefits.slice(0, 3).map((benefit, benefitIndex) => (
                  ...
                  {[
                    {
                      ...
                      requirements: ["10년 이상 사업 영위", "후계자 승계 의지", "고용 유지 의무"],
                      icon: Target,
                      processSteps: [
                        "가업승계 계획 수립",
                        "요건 충족 여부 검토", 
                    ...
                    },
                    {
                      ...
                      requirements: ["자녀의 경영 의지", "충분한 사업 자금", "단계적 승계 계획"],
                      icon: Users,
                      processSteps: [
                        "자녀법인 설립 전략",
                        "사업이관 계획 수립",
                    ...
                    <Card key={index} className="group bg-card dark:bg-card/80 border-border/40 dark:border-border hover:shadow-xl dark:hover:shadow-white/5 transition-all duration-500">
                      <CardHeader>
                        ...
                        <CardTitle className="text-2xl font-bold mb-3">{strategy.title}</CardTitle>
                          ...
                          <div>
                            ...
                            <div className="space-y-1">
                              {strategy.requirements.map((req, reqIndex) => (
                                <div key={reqIndex} className="text-sm text-muted-foreground">
                                  • {req}
                                </div>
                              ))}
                            </div>
              ...
              {[
                {
                  ...
                  timeline: "18개월",
                  ceo: "김○○ 회장",
                  testimonial: "체계적인 승계 계획으로 자녀들에게 부담 없이 사업을 물려줄 수 있게 되었습니다."
                },
                {
                  company: "IT기업 S사",
                  industry: "소프트웨어 개발",
                  ...
                  timeline: "12개월",
                  ceo: "박○○ 대표",
                  testimonial: "절세와 동시에 기업의 안정성까지 확보할 수 있는 최적의 솔루션이었습니다."
                },
                {
                  company: "건설업 D사",
                  industry: "종합건설업",
                ...
                <Card key={index} className="group bg-card dark:bg-card/80 border-border/40 dark:border-border hover:shadow-2xl dark:hover:shadow-white/5 transition-all duration-500 relative overflow-hidden">
                  ...
                  <CardHeader className="relative z-10">
                    ...
                    <CardTitle className="text-xl font-bold mb-2">{story.company}</CardTitle>
        ...
        <section className="py-20 bg-gradient-to-r from-emerald-600/10 to-blue-600/10">
          <div className="container mx-auto px-6 text-center">
            <div className="flex justify-center mb-6">
              <Badge variant="outline" size="lg" className="bg-white/80 dark:bg-gray-900/80">
                <Calculator className="h-3 w-3 mr-1" />
                전문가 상담
              </Badge>
            </div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              당신만의 <span className="text-primary">절세 전략</span>을 설계하세요
            </h2>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              삼성생명과 함께하는 <span className="font-bold text-emerald-600">맞춤형 절세 컨설팅</span>으로<br />
            ...
            <div className="flex justify-center mb-8">
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 max-w-md">
                <div className="flex items-center justify-center text-red-600 dark:text-red-400 mb-2">
                  ⏰ <span className="ml-2 font-semibold">세법 개정 전 마지막 기회</span>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CalComPopup
                ...
                eventType="consultation"
                trigger={
                  <Button size="lg" className="bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-white font-bold px-8 py-4 shadow-xl">
                    무료 절세 진단 받기 (30분 상담)
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                }
              />
              <Button size="lg" variant="outline" asChild className="border-primary/60 text-primary hover:bg-primary/10 font-bold px-8 py-4">
                <Link
            ...
            <div className="text-sm text-muted-foreground mt-6 space-y-1">
              <div>🎁 <strong>상담 혜택:</strong> 개인 맞춤 절세 리포트 무료 제공</div>
              <div>⚡ <strong>상담 시간:</strong> 30-45분 전문가 직접 상담</div>
              <div>💯 <strong>만족도:</strong> 98% 고객 만족 · 100% 솔루션 제안</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
                <span className="text-primary">CEO 경영 진단</span>으로 전체적인 준비도를 점검하세요
              </h2>

              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                절세 전략 외에도 리스크 관리, 가업승계, 성장전략 등 5대 핵심 영역의 준비도를 
                <span className="font-semibold text-primary"> 무료로 진단</span>받아보세요
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                <Card className="border-blue-200 bg-blue-50/50 dark:bg-blue-950/20">
                  <CardContent className="pt-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">중대재해처벌법, 기업보험 등</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-green-200 bg-green-50/50 dark:bg-green-950/20">
                  <CardContent className="pt-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">승계 계획, 차세대 교육 등</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-purple-200 bg-purple-50/50 dark:bg-purple-950/20">
                  <CardContent className="pt-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">M&A, 디지털 전환 등</p>
                  </CardContent>
                </Card>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="px-8 py-4 text-lg font-bold bg-blue-600 hover:bg-blue-700" asChild>
              ...
              <p className="text-sm text-muted-foreground mt-6">
                ✅ 5개 영역 30개 항목 진단 · 🆓 무료 분석 리포트 · ⚡ 즉시 결과 확인
              </p>
            </div>
          </div>
        </section>
