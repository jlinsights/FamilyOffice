  ...
  const faqItems = [
    {
      ...
      answer:
        '법인 대표이사 및 임원, 연봉 1억 이상 또는 지분 보유 핵심 인재, 사업자등록증을 보유한 개인사업자, 전문직 종사자 등이 가입 가능합니다.',
    },
    {
      question: '어떤 세제 혜택을 받을 수 있나요?',
      answer:
        '납입 시 법인세 비용처리 및 소득공제 혜택이 있으며, 수령 시 퇴직소득세(일시수령) 또는 연금소득세(연금수령) 적용으로 절세 효과가 있습니다. 또한 상속세 재원 마련에도 유리합니다.',
    },
    {
      question: '연금 전환은 언제부터 가능한가요?',
      answer:
        '일반적으로 만 55세부터 연금 전환이 가능하며, 종신연금, 확정연금, 상속연금 등 다양한 수령 방식을 선택할 수 있습니다. 연금소득세가 적용되어 세금 부담을 줄일 수 있습니다.',
    },
    {
      question: '원금 손실 위험은 없나요?',
      answer:
        '경영인정기보험은 최저보증이율이 적용되고 납입원금 100%가 보장되는 안전한 상품입니다. 예금자보호법 적용 및 금융감독원의 관리감독을 받아 안심하고 가입하실 수 있습니다.',
    },
    {
      question: '중도해지 시 손해는 어느 정도인가요?',
      answer:
        '초기 5년 이내 해지 시 해지환급금이 납입원금보다 적을 수 있습니다. 하지만 5년 이후부터 환급률이 상승하며, 10년 이상 유지 시 원금 회복 및 이익이 발생합니다.',
    },
    {
      question: '경영인정기보험 가입 상담은 어떻게 받나요?',
      answer:
        '삼성생명 GFC 전문가와 1:1 맞춤 상담이 가능합니다. 전화(0502-5550-8700), 온라인 예약, 방문 상담을 통해 기업 상황에 맞는 최적의 플랜을 제안받으실 수 있습니다.',
    },
  ];
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background dark:from-background dark:via-muted/10 dark:to-background">
          ...
          <div className="container relative mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-foreground">
                경영인정기보험
                <br />
                <span className="bg-gradient-to-r from-primary via-blue-700 to-amber-600 bg-clip-text text-transparent">
                  완벽 가이드
                </span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-muted-foreground leading-relaxed">
                ...
                <strong className="text-foreground">법인세 절약</strong>
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
                <div className="glass-premium-enhanced rounded-2xl p-6 hover-premium transition-all duration-500 border-glow">
                  ...
                  <p className="text-sm text-stat-description font-medium">
                    법인세 절약효과
                  </p>
                </div>
                <div className="glass-premium-enhanced rounded-2xl p-6 hover-premium transition-all duration-500 border-glow">
        ...
        <section
          ...
          className="py-20 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {insuranceProducts.map((product, index) => (
                <Card
                  key={index}
                  className={`relative overflow-hidden ${product.popular ? 'ring-2 ring-yellow-400' : ''} hover:shadow-xl transition-all duration-300`}
                >
                  {product.popular && (
                ...
                items={[
                      ...
                      <div className="space-y-3">
                        ...
                        <ul className="space-y-2 text-gray-700">
                          <li className="flex items-start">
                            <CheckCircle className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                            <span>
                              <strong>법인 대표이사, 임원</strong>: 등기부등본상
                              확인 가능한 임원
                            </span>
                          </li>
                          <li className="flex items-start">
                            <CheckCircle className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                            <span>
                              <strong>핵심 인재</strong>: 연봉 1억 이상 또는
                              지분 보유 임직원
                            </span>
                          </li>
                          <li className="flex items-start">
                            <CheckCircle className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                            <span>
                              <strong>개인사업자</strong>: 사업자등록증 보유 및
                              일정 소득 증명
                            </span>
                          </li>
                          <li className="flex items-start">
                            <CheckCircle className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                            <span>
                              <strong>전문직</strong>: 의사, 변호사, 회계사 등
                              전문 자격증 보유자
                            </span>
                          </li>
                        </ul>
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg">
                          <ul className="space-y-2 text-gray-700">
                            <li className="flex items-center">
                              <CheckCircle className="w-4 h-4 text-green-500 mr-2 flex-shrink-0" />
                              <span>
                                <strong>연금개시 연령</strong>: 만 55세부터 가능
                                (상품에 따라 차이)
                              </span>
                            </li>
                            <li className="flex items-center">
                  ...
                  },
                  {
                    ...
                    answer: (
                      <div className="space-y-3">
                        <p>
                          삼성생명 GFC 전문가와 1:1 맞춤 상담을 받으실 수
                          있습니다:
                        </p>
      ...
      {/* Structured Data */}
      <Script
        id="key-person-insurance-structured-data"
          ...
          '@graph': [
            {
              ...
              description:
                'CEO·핵심임직원 전용 보험상품으로 퇴직금·상속세 절세와 연금보험 전환 혜택까지. 삼성생명 GFC 전문가 상담.',
              image: {
                '@type': 'ImageObject',
            ...
            },
            {
              ...
              name: '경영인정기보험 상담',
              description:
                'CEO·핵심임직원을 위한 전용 보험상품 상담 및 설계 서비스',
              provider: {
                '@type': 'Organization',
                name: '패밀리오피스 S',
