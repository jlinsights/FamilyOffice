...
const featuredResources = [
  {
    ...
    description:
      '산업재해로 인한 리스크 관리 전략과 솔루션, 기업재해보장보험 등 리스크 관리 방안 제시',
    fileSize: '2.8 MB',
    format: 'PDF',
    date: '2025.01.28',
    downloads: 125,
    isPremium: false,
    downloadUrl:
      'https://pub-66c6dc2fd6894c5687d260702159ac9a.r2.dev/23%200228_%20%EB%8B%A8%EC%B2%B4%20%EC%A0%9C%EC%95%88%EC%84%9C(%EC%8A%B9%EC%9D%B8%E5%AE%8C).pdf',
  },
  {
    category: 'CEO 보장자산',
    title: '가정과 회사의 중심인 CEO는 보장자산이 필요합니다',
    description:
      '산재 혜택을 받지 못하는 CEO를 위한 보장자산 가이드. 건강보험, 재직中 보험료 납입, 수익자 지정 전략',
    fileSize: '4.5 MB',
    format: 'PDF',
    date: '2025.01.15',
    downloads: 890,
  ...
  },
  {
    ...
    description:
      '불확실한 시장 환경에서 안정적인 수익을 추구하는 포트폴리오 구성 전략',
    fileSize: '3.2 MB',
    format: 'PDF',
    date: '2025.01.10',
    downloads: 1250,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="max-w-xl mx-auto flex gap-2">
                <Input placeholder="자료 검색..." className="flex-1" />
                <Button>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-foreground">추천 자료</h2>
                ...
                <div className="space-y-6">
                  <Card className="bg-card">
                    <CardContent className="p-6">
                      ...
                      <p className="text-card-foreground/80 mb-4">
                        회원 가입 후 무료로 다운로드 가능한 자료입니다. 시장
                        동향, 기본 투자 가이드 등 유용한 정보를 제공합니다.
                      </p>
                      <Button variant="outline" size="sm">
                        무료 자료 보기
                      </Button>
                  ...
                  <Card className="bg-card">
                    <CardContent className="p-6">
                      ...
                      <p className="text-card-foreground/80 mb-4">
                        특정 주제나 업종에 대한 맞춤형 자료가 필요하신가요?
                        전문가가 직접 작성하는 맞춤 리포트를 요청하세요.
                      </p>
                      <Button variant="outline" size="sm">
                        자료 요청하기
                      </Button>
              ...
              <div>
                ...
                <div className="mt-8 p-6 bg-primary/10 rounded-lg">
                  ...
                  <p className="text-sm text-foreground/70">
                    ...
                    뉴스레터 구독자는 신규 자료 알림을 가장 먼저 받아보실 수
                    있습니다.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent text-white border-white hover:bg-white/10 dark:text-white dark:border-white"
              >
                자료 요청하기
              </Button>
            </div>
