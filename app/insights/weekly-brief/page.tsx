...
const valuePropositions = [
  ...
  },
  {
    ...
    title: '실무 적용 가능한 정보',
    description:
      '이론이 아닌 실제 경영 현장에서 바로 활용할 수 있는 실용적 인사이트',
  },
  {
    icon: Users,
    title: '전문가 네트워크 인사이트',
...
const recentIssues = [
  {
    ...
    excerpt:
      '상속세 과세표준 구간 조정과 세율 변화가 중견기업에 미치는 영향을 분석했습니다.',
    readTime: '4분',
  ...
  },
  {
    ...
    excerpt:
      '전통적인 기업 가치 평가 방식에서 벗어나 AI 역량을 반영한 새로운 평가 모델을 제시합니다.',
    readTime: '5분',
  ...
  },
  {
    ...
    excerpt:
      '새해를 맞아 주요 투자은행들의 경제 전망을 종합하여 한국 중견기업을 위한 자산배분 가이드를 정리했습니다.',
    readTime: '6분',
  ...
  },
  {
    ...
    excerpt:
      '자산 규모별 패밀리오피스 형태와 설립 과정에서 반드시 체크해야 할 법적, 세무적 요소들을 정리했습니다.',
    readTime: '5분',
...
const testimonials = [
  {
    ...
    company: '제조업 A사',
    content:
      '매주 받는 뉴스레터를 통해 시장 변화를 빠르게 파악하고 있습니다. 특히 업종별 분석이 도움이 됩니다.',
    rating: 5,
  },
  {
    name: '이○○ 회장',
    company: '건설업 B그룹',
    content:
      '상속세 관련 내용이 매우 실용적이었습니다. 전문가의 조언을 쉽게 이해할 수 있어 좋습니다.',
    rating: 5,
  },
  {
    name: '박○○ 대표',
    company: 'IT기업 C사',
    content:
      '글로벌 시장 동향과 국내 시장을 연결해서 설명해주는 점이 특히 유용합니다.',
    rating: 5,
  },
];
...
export default function WeeklyBriefPage() {
  const [recentPosts, setRecentPosts] =
    useState<NewsletterPost[]>(recentIssues);
              ...
              <div className="subscription-form max-w-2xl mx-auto mb-16">
                <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 text-center">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-foreground">
                        {newsletterStats.establishedYear}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        시작년도
                      </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                영상과 팟캐스트로 더 깊이 있는 전문가 분석을 만나보세요
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-3">
                      중대재해처벌법 시대, 산재보험으로 없었질 수 없는
                      민사배상금 리스크. CEO 개인과 법인 모두를 지키는 마지막
                      방패를 준비하세요.
                    </p>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-muted-foreground mb-3">
                      개별 전문가에서 &apos;전문가 팀&apos;으로. 중견기업
                      경영진의 복잡한 자산을 오케스트라처럼 조화롭게 관리하는
                      패밀리오피스 전략.
                    </p>
                    <div className="flex gap-2">
              ...
              <TabsContent value="podcast" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    />
                    <p className="text-muted-foreground mb-3">
                      이번 주 뉴스레터 핵심 내용을 오디오로 들으며 더 깊이 있는
                      전문가 분석과 해설을 제공합니다. 통근길이나 운동 중에도
                      편리하게 들어보세요.
                    </p>
                    <div className="flex gap-2">
                      <Badge variant="secondary">오디오 버전</Badge>
                      <Badge variant="secondary">심층 해설</Badge>
                      <Badge variant="secondary">전문가 분석</Badge>
                    </div>
                  </div>
                  <div>
                    <SpotifyEmbed
                    ...
                    />
                    <p className="text-muted-foreground mb-3">
                      여러 중견기업 CEO들과 전문가가 함께하는 라운드테이블
                      토론입니다. 2025년 자산관리 전략과 시장 전망에 대한 다양한
                      관점을 나눕니다.
                    </p>
                    <div className="flex gap-2">
                      <Badge variant="secondary">라운드테이블</Badge>
                      <Badge variant="secondary">CEO 토론</Badge>
                      <Badge variant="secondary">2025 전략</Badge>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {recentPosts.map((issue, index) => (
                <Card
                  key={index}
                  className="card-modern bg-card hover:shadow-lg transition-all duration-300 overflow-hidden group"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                {testimonials.map((testimonial, index) => (
                  <Card
                    key={index}
                    className="bg-card hover:shadow-md transition-shadow duration-300"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                기업승계와 자산관리 전문가들이 검증한 양질의 콘텐츠를 정기적으로
                제공합니다
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          국내 대기업 및 글로벌 외국계 기업 출신으로 중견기업
                          자산관리 경험과 전문성을 보유하고 있습니다.
                          패밀리오피스 설계, 가업승계 전략, 세무최적화 등
                          통합적인 솔루션으로 기업과 가족의 지속가능한 성장을
                          지원합니다.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-primary/5 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      매주 월요일과 금요일 오전 7:30, 중소중견기업 CEO를 위한
                      맞춤형 인사이트를 제공합니다. 5분 내 읽을 수 있는 핵심
                      정보로 경영 의사결정을 지원합니다.
                    </p>
                    <div className="space-y-4">
                      <Link
        ...
        <section className="py-20 bg-gradient-to-r from-primary to-primary/80">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8">
              매주 월요일과 금요일 오전 7시 30분, 당신의 투자 결정을 돕는
              인사이트가 도착합니다
            </p>
            ...
            <div className="space-y-4 max-w-md mx-auto">
              ...
              <div className="text-sm text-primary-foreground/70">또는</div>
