  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'ISO 통합인증(9001/14001/45001)은 품질/환경/안전 관리시스템을 통합하여 운영하는 것으로, 개별 인증 대비 비용 절감과 관리 효율성이 높습니다. 중소기업 대출금리 1.5% 우대, 입찰가산점 최대 7점, 정부조달 우선권 등의 혜택도 받을 수 있어 국제 경쟁력 향상에 도움이 됩니다.'
        },
        {
          question: '장애인 표준사업장 인증의 실질적인 혜택은 무엇인가요?',
          answer: '장애인 표준사업장은 근로자 10명 이상, 장애인 근로자 30% 이상 고용 시 인증받을 수 있으며, 고용장려금 최대 15억원, 무상지원금 최대 10억원, 시설자금 융자 5% 금리 등 파격적인 혜택을 받을 수 있습니다. 또한 법인세 면제까지 가능해 높은 수익성을 기대할 수 있습니다.'
        },
        {
          question: '메인비즈 인증과 다른 인증들의 차별화된 장점은 무엇인가요?',
          answer: '메인비즈는 경영혁신 인증으로 기술 중심의 벤처·이노비즈와 차별화됩니다. 경영시스템, 인적자원관리, 마케팅 역량을 종합 평가하여 법인세 18% 적용, 신용보증 우대, 정책자금 우선 지원을 받을 수 있습니다. 특히 서비스업, 유통업 등 비제조업에서 취득하기 유리하며, R&D 비중이 낮아도 경영혁신 역량으로 인증받을 수 있어 업종 제약이 적은 것이 장점입니다.'
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: '기업 성장 로드맵은 기업의 현재 단계를 진단하고, 다음 단계로의 발전을 위한 맞춤형 인증 전략을 제시합니다. Phase 1(설립) → Phase 2(성장기반) → Phase 3(사업확장) → Phase 4(Exit)로 구분하여, 각 단계별 최적의 인증과 지원 프로그램을 안내합니다. 전문 컨설턴트와 상담을 통해 개별 기업에 맞는 로드맵을 수립할 수 있습니다.'
        }
      ]
    }
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background dark:from-background dark:via-muted/10 dark:to-background">
        ...
        <section className="py-16 bg-white dark:bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4 bg-orange-100 text-orange-700 dark:bg-orange-100/20 dark:text-orange-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {changes2025.map((change, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-blue-500 dark:border-l-blue-400 dark:bg-background/80 dark:border-border/50">
                  <CardHeader>
                    <div className={`w-12 h-12 bg-${change.color}-100 dark:bg-${change.color}-100/20 rounded-lg flex items-center justify-center mb-4`}>
                      <change.icon className={`w-6 h-6 text-${change.color}-600 dark:text-${change.color}-400`} />
                    </div>
                    <CardTitle className="text-lg dark:text-white">{change.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-300 mb-3">{change.description}</p>
                    <Badge className={`bg-${change.color}-100 text-${change.color}-700 dark:bg-${change.color}-100/20 dark:text-${change.color}-300`}>
                      {change.impact}
                    </Badge>
                  </CardContent>
                </Card>
        ...
        {/* 주요 기업인증 종류 */}
        <section id="certifications" className="py-16 bg-gray-50 dark:bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4 bg-blue-100 text-blue-700 dark:bg-blue-100/20 dark:text-blue-300">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {certificationTypes.map((cert, index) => (
                <Card key={index} className="hover:shadow-xl transition-all duration-300 dark:bg-background/80 dark:border-border/50">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-12 h-12 bg-${cert.color}-100 dark:bg-${cert.color}-100/20 rounded-lg flex items-center justify-center`}>
                        <cert.icon className={`w-6 h-6 text-${cert.color}-600 dark:text-${cert.color}-400`} />
                      </div>
                      <Badge className={`bg-${cert.color}-100 text-${cert.color}-700 dark:bg-${cert.color}-100/20 dark:text-${cert.color}-300`}>
                        {cert.badge}
                      </Badge>
                    </div>
                    <CardTitle className="text-xl dark:text-white">{cert.title}</CardTitle>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-white mb-3">신청 요건</h4>
                        <div className="space-y-2">
                          {cert.requirements.map((req, reqIndex) => (
                            <div key={reqIndex} className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {cert.benefits.map((benefit, benefitIndex) => (
                            <div key={benefitIndex} className="flex items-start text-sm text-gray-600 dark:text-gray-300">
        ...
        <section className="py-16 bg-white dark:bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4 bg-green-100 text-green-700 dark:bg-green-100/20 dark:text-green-300">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {taxBenefits.map((benefit, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-l-green-500 dark:border-l-green-400 dark:bg-background/80 dark:border-border/50">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <CardTitle className="text-xl dark:text-white">{benefit.certification}</CardTitle>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{benefit.corporateTax}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">법인세율</p>
                      </div>
                      ...
                      <div>
                        <p className="text-lg font-semibold text-gray-500 dark:text-gray-400 line-through">{benefit.originalRate}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">일반 세율</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-3">추가 세제혜택</h4>
                    <div className="space-y-2">
                      {benefit.additionalBenefits.map((additional, additionalIndex) => (
                        <div key={additionalIndex} className="flex items-center text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <div className="text-center">
                <h3 className="text-xl font-bold text-blue-900 dark:text-blue-300 mb-3">세제혜택 계산 예시</h3>
                <p className="text-blue-700 dark:text-blue-400 mb-4">
                  연매출 10억원, 순이익 2억원 기업 기준
                </p>
                <div className="grid md:grid-cols-4 gap-4 text-center">
                  <div>
                    <p className="font-bold text-blue-600 dark:text-blue-400">벤처기업</p>
                    <p className="text-2xl font-bold dark:text-white">2,000만원</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">(10% 적용)</p>
                  </div>
                  <div>
                    <p className="font-bold text-green-600 dark:text-green-400">이노비즈</p>
                    <p className="text-2xl font-bold dark:text-white">3,000만원</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">(15% 적용)</p>
                  </div>
                  <div>
                    <p className="font-bold text-purple-600 dark:text-purple-400">메인비즈</p>
                    <p className="text-2xl font-bold dark:text-white">3,600만원</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">(18% 적용)</p>
                  </div>
                  <div>
                    <p className="font-bold text-gray-600 dark:text-gray-400">일반기업</p>
                    <p className="text-2xl font-bold dark:text-white">5,000만원</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">(25% 적용)</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-50 via-purple-50 to-teal-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-teal-900/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground dark:text-gray-300 max-w-2xl mx-auto">
                설립부터 Exit까지, 성장 단계에 맞는 최적의 인증 전략을 제시합니다
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {gfcRoadmap.map((phase, index) => (
                <Card key={index} className="hover:shadow-xl transition-all duration-300 relative dark:bg-background/80 dark:border-border/50">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-12 h-12 bg-${phase.color}-100 dark:bg-${phase.color}-100/20 rounded-lg flex items-center justify-center`}>
                    ...
                    <CardTitle className="text-xl mb-2 dark:text-white">{phase.title}</CardTitle>
                  ...
                  <CardContent>
                    <div className="mb-4">
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">추천 인증</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">핵심 활동</h4>
                      <div className="space-y-1">
                        {phase.keyActivities.slice(0, 3).map((activity, actIndex) => (
                          <div key={actIndex} className="flex items-start text-xs text-gray-600 dark:text-gray-300">
                            <CheckCircle className="w-3 h-3 mr-2 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                            <span>{activity}</span>
                          </div>
                        ))}
                        {phase.keyActivities.length > 3 && (
                          <p className="text-xs text-gray-500 dark:text-gray-400">+{phase.keyActivities.length - 3}개 추가</p>
                        )}
                      </div>
                    </div>
                  </CardContent>
        ...
        <section className="py-16 bg-gray-50 dark:bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4 bg-purple-100 text-purple-700 dark:bg-purple-100/20 dark:text-purple-300">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {industryStrategies.map((strategy, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow duration-300 dark:bg-background/80 dark:border-border/50">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        <strategy.icon className="w-8 h-8 text-blue-600 dark:text-blue-400 mr-3" />
                        <CardTitle className="text-xl dark:text-white">{strategy.industry}</CardTitle>
                      </div>
                      <Badge className="bg-green-100 text-green-700 dark:bg-green-100/20 dark:text-green-300">
                    ...
                    <div className="flex gap-2 mb-4">
                      <span className="text-sm text-gray-600 dark:text-gray-300">추천 인증:</span>
                  ...
                  <CardContent>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-3">성공 핵심 포인트</h4>
                    <div className="space-y-2">
                      {strategy.keyPoints.map((point, pointIndex) => (
                        <div key={pointIndex} className="flex items-start text-sm text-gray-600 dark:text-gray-300">
        ...
        <section className="py-16 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4 bg-indigo-100 text-indigo-700 dark:bg-indigo-100/20 dark:text-indigo-300">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-5 gap-6">
                {applicationProcess.map((process, index) => (
                  <Card key={index} className="hover:shadow-lg transition-shadow duration-300 relative text-center dark:bg-background/80 dark:border-border/50">
                    <CardHeader>
                      ...
                      <CardTitle className="text-lg dark:text-white">{process.title}</CardTitle>
                      <Badge variant="outline" className="mx-auto">
                        {process.duration}
                      </Badge>
                      <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">{process.description}</p>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2 text-left">
                        {process.details.map((detail, detailIndex) => (
                          <div key={detailIndex} className="flex items-start text-xs text-gray-600 dark:text-gray-300">
                            <CheckCircle className="w-3 h-3 mr-2 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                            <span>{detail}</span>
                          </div>
                        ))}
            ...
            <div className="text-center mt-16">
              <div className="bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-12">
                ...
                <p className="text-muted-foreground dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                  기업인증 전문가가 직접 상담해드립니다. 무료 상담을 통해 맞춤형 인증 전략을 수립하세요.
                </p>
                <Link href="/contact">
                  <Button className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300">
                    무료 전문가 상담 예약
      ...
      <Script id="business-certification-structured-data" type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Article",
          "headline": "2025년 기업인증 완벽 가이드 | 벤처/이노비즈/메인비즈/장애인표준사업장 인증 혜택 총정리",
          "description": "2025년 최신 기업인증 완벽 가이드. 벤처기업 인증부터 장애인표준사업장(최대 15억원 지원), ISO 통합인증까지 혜택과 신청방법. 성장 로드맵 제공. 기업인증 전문가 상담",
          "author": {
            "@type": "Organization",
            "name": "삼성생명"
          },
