...
export const metadata: Metadata = {
  ...
  description:
    '10분 진단으로 당신에게 꼭 맞는 멤버십 등급과 운영 방식을 제안받으세요. Foundation부터 Legacy까지 자산 규모와 라이프스타일에 맞는 최적의 등급을 찾아드립니다.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <main className="pt-20 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 animate-slide-up">
            ...
            <div className="grid grid-cols-2 gap-3 mt-8 sm:hidden">
              {[
                ...
                <div
                  key={item.step}
                  className="flex items-center gap-2 p-2 rounded-lg bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50"
                >
          ...
          <div
            className="bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-xl p-6 md:p-10 animate-slide-up"
