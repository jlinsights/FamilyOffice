...
export const metadata: Metadata = {
  ...
  description: '성공한 CEO의 삶을 완벽하게 케어하는 VVIP 멤버십에 로그인하세요.',
};
          ...
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                성공한 CEO의 삶을 완벽하게 케어하는<br className="hidden md:block" />
                <span className="font-semibold">통합 프리미엄 솔루션</span>을 경험하세요.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 p-6 bg-card/30 backdrop-blur-sm rounded-lg border border-border/20">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">CEO 자산기준</div>
              </div>
              <div className="text-center">
