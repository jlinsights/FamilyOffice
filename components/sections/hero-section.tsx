      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black mb-8 tracking-tight leading-[1.1] font-serif">
          <span className="block text-white mb-2">
             <TextReveal delay={0.4} type="char">百年</TextReveal>
          </span>
          <span className="block mt-2">
             <FadeIn delay={0.6} direction="up" className="inline-block">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-400 to-indigo-400">永續</span>
             </FadeIn>
          </span>
        </h1>
        ...
        <FadeIn delay={0.8} className="max-w-2xl mx-auto mb-12">
          <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
            성공한 기업가를 위한 프리미엄 자산관리 파트너.<br className="hidden md:block" />
            단순한 자산 증식을 넘어, 백년영속 가문의 유산을 설계합니다.
          </p>
        </FadeIn>

        {/* CTA Buttons */}
        <FadeIn delay={1.0} className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <CalComPopup
          ...
          <Link href="/membership" className="w-full sm:w-auto">
             <Button variant="outline" size="lg" className="w-full h-14 px-8 text-lg bg-white/5 border-white/10 text-white hover:bg-white/10 hover:text-white rounded-full backdrop-blur-sm transition-all duration-300">
