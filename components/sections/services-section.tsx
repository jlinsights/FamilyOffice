...
const mainPageServices = [
  {
    ...
    serviceCount: 4,
    keyFeatures: ["정관 및 배당 컨설팅", "CEO유고시 리스크 관리", "임원소득보장플랜", "법인 운영 컨설팅"]
  },
  {
    id: "hr-support",
    icon: Users,
    ...
    serviceCount: 4,
    keyFeatures: ["고용지원금 컨설팅", "노무관리 컨설팅", "사내근로복지기금", "인사제도 설계"]
  },
  {
    id: "tax-accounting",
    icon: Calculator,
    ...
    serviceCount: 4,
    keyFeatures: ["세무조정계산서", "법인세 최적화", "개인세 최적화", "세무 리스크 관리"]
  },
  {
    ...
    serviceCount: 4,
    keyFeatures: ["투자 포트폴리오 관리", "정책자금 활용", "자금조달 최적화", "리스크 헤지"]
  },
  {
    id: "asset-management",
    icon: Building2,
    ...
    serviceCount: 4,
    keyFeatures: ["자산 구조 최적화", "보험 설계", "자산 분산 전략", "리스크 관리"]
  },
  {
    ...
    serviceCount: 4,
    keyFeatures: ["승계 전략 수립", "M&A Advisory", "지배구조 최적화", "세대 간 갈등 해결"]
  },
  {
    ...
    serviceCount: 4,
    keyFeatures: ["가족법인 설립", "자녀법인 설립", "MSO 구조화", "법인 구조 재편"]
  },
  {
