...
export const StructureCheckHeroSection = memo(function StructureCheckHeroSection() {
  return (
    <section className="relative w-full py-16 lg:py-24 bg-gradient-to-br from-background via-background to-muted/20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-4 text-center text-lg md:text-xl text-muted-foreground leading-relaxed">
          ...
          <p>
            <span className="font-medium text-foreground">지금 상황에서 무엇을 결정해야 하는지,</span>
            <br />
            <span className="font-medium text-foreground">아직 결정을 미뤄도 되는 문제는 무엇인지</span>
            <br />
            를 정리하는 자리입니다.
          </p>
        </div>
