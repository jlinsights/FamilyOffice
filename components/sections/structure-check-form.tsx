...
export const StructureCheckFormSection = memo(
  function StructureCheckFormSection() {
    return (
          ...
          <div className="mt-12 max-w-2xl mx-auto">
            <Card className="bg-muted/30 dark:bg-muted/10 border-border">
              <CardContent className="p-6">
                <h3 className="font-bold text-center mb-4 text-foreground">
                  안내
                </h3>
                <ul className="space-y-2 text-sm text-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>
                      점검 이후 실행 단계는 필요할 경우에만 별도로 논의합니다.
                    </span>
                  </li>
                </ul>
              </CardContent>
