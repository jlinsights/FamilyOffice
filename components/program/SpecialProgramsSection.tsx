  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 text-xs mt-auto">
        <Badge
          variant="outline"
          className="bg-background/80 border-primary/20 text-foreground"
        >
          장소: {place}
        </Badge>
...
export function SpecialProgramsSection({
  ...
  ceoPrograms: SpecialProgram[];
  assetPrograms: SpecialProgram[];
}) {
  return (
    <section className="section bg-gradient-to-b from-background via-muted/10 to-background py-20">
      <div className="container">
        <div className="text-center mb-16">
          <Badge
            variant="secondary"
            className="mb-4 animate-fade-in text-base px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary font-semibold"
          >
            VIP & CEO 특화 프로그램
          </Badge>
          ...
          >
            깊이 있는 자산관리, 차별화된 고객 참여, 세대이전, 원스톱 솔루션을
            경험하세요.
          </p>
        </div>
        {/* 법인 CEO 프로그램 */}
        <div className="mb-16">
          <h3 className="text-xl font-semibold mb-8 text-primary text-center">
            법인 CEO 고객님을 위한 프로그램
          </h3>
