...
export function SmartCTASystem({
  ...
  const [ctaVariant, setCTAVariant] = useState<
    'default' | 'urgent' | 'value' | 'social'
  >('default');
  const [showProgressiveDisclosure, setShowProgressiveDisclosure] =
    useState(false);
    ...
    const messages = {
      inheritance: {
        default: {
          title: '상속세 전문가 무료 상담',
          description:
            '계산 결과를 바탕으로 맞춤형 상속세 절세 전략을 받아보세요',
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center gap-3 p-3 bg-white/50 dark:bg-slate-800/30 rounded-xl"
                    >
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    onClick={() =>
                      window.open('/contact?service=tax-consultation', '_blank')
                    }
                  >
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-2 p-3 bg-white/60 dark:bg-slate-800/40 rounded-lg"
                >
