...
import { isAllowedScriptSource, isSafeHTMLContent } from '@/lib/security/html-sanitizer';
...
export default function ExternalScripts() {
  ...
  if (!isAllowedScriptSource(hubspotSrc)) {
    securityLogger.security('Blocked HubSpot script from unauthorized source', { source: hubspotSrc });
    return null;
  }
