              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge
                      variant="outline"
                      className="dark:bg-gray-700 dark:text-gray-200 dark:border-gray-500"
                    >
                      완료
                    </Badge>
                  </div>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 p-3 rounded-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {seminar.videoUrl && (
                        <Badge
                          variant="secondary"
                          className="text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300 border-blue-200 dark:border-blue-700"
                        >
                      ...
                      {seminar.presentationUrl && (
                        <Badge
                          variant="secondary"
                          className="text-xs bg-purple-100 text-purple-800 dark:bg-purple-900/40 dark:text-purple-300 border-purple-200 dark:border-purple-700"
                        >
                  ...
                  <div className="w-full grid grid-cols-2 gap-2">
                    {seminar.videoUrl && (
                      <Button
                        variant="default"
                        size="sm"
                        className="group dark:bg-primary/80 dark:text-white dark:hover:bg-primary/90"
                      >
                    ...
                    {seminar.presentationUrl && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="group dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600 dark:hover:bg-gray-700"
                      >
                    ...
                    {!seminar.videoUrl && !seminar.presentationUrl && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="col-span-2 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600 dark:hover:bg-gray-700"
                      >
                        자세히 보기
                      </Button>
                    )}
