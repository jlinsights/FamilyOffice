            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 ${category.bgColor} rounded-full mb-4 group-hover:scale-110 transition-transform duration-300 dark:bg-primary/30`}
                  >
                    <Icon
                      className={`h-8 w-8 ${category.color} dark:text-primary`}
                    />
                  </div>
