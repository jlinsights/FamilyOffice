          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className={cn(
                ...
                (data.kospi?.change || 0) >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"
              )}>
                ...
                <span>
                  {(data.kospi?.change || 0) >= 0 ? '+' : ''}{formatNumber(data.kospi?.change || 0)}
                </span>
                <span>({(data.kospi?.changePercent || 0) >= 0 ? '+' : ''}{(data.kospi?.changePercent || 0).toFixed(2)}%)</span>
              </div>
        ...
        <Card className="hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className={cn(
                "flex items-center gap-1 text-sm",
                (data.kosdaq?.change || 0) >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"
              )}>
                ...
                <span>
                  {(data.kosdaq?.change || 0) >= 0 ? '+' : ''}{formatNumber(data.kosdaq?.change || 0)}
                </span>
                <span>({(data.kosdaq?.changePercent || 0) >= 0 ? '+' : ''}{(data.kosdaq?.changePercent || 0).toFixed(2)}%)</span>
              </div>
              <div className="text-xs text-muted-foreground">
        ...
        <Card className="hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className={cn(
                "flex items-center gap-1 text-sm",
                (data.usdkrw?.change || 0) >= 0 ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"
              )}>
                ...
                <span>
                  {(data.usdkrw?.change || 0) >= 0 ? '+' : ''}{(data.usdkrw?.change || 0).toFixed(2)}
                </span>
                <span>({(data.usdkrw?.changePercent || 0) >= 0 ? '+' : ''}{(data.usdkrw?.changePercent || 0).toFixed(2)}%)</span>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Badge 
                    ...
                    className={cn(
                      sector.performance >= 0 ? "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400" : "bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400"
                    )}
                  >
