              ...
              {[
                {
                  ...
                  title: '맞춤형 진단',
                  description:
                    '기업 및 개인 자산 현황에 따른 정밀 분석 및 진단 리포트 제공',
                  color: 'blue',
                },
                {
                  icon: Shield,
                  title: '리스크 관리',
                  description:
                    '잠재적 위험 요소를 사전에 파악하고 대비하는 최적의 솔루션 제시',
                  color: 'red',
                },
                {
                  icon: Building,
                  title: '가업 승계',
                  description:
                    '원활한 가업 승계와 절세를 위한 장기적인 로드맵 수립 지원',
                  color: 'purple',
                },
              ].map((benefit, index) => (
                <Card
                  key={index}
                  className="text-center h-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg hover:-translate-y-1 transition-transform duration-300"
                >
                  <CardHeader>
                    <div
                      className={`w-16 h-16 bg-${benefit.color}-50 dark:bg-${benefit.color}-900/20 rounded-2xl mx-auto mb-4 flex items-center justify-center text-${benefit.color}-600 dark:text-${benefit.color}-400 shadow-sm`}
                    >
                    ...
                    <CardContent className="p-6 flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-xl font-black text-blue-600 dark:text-blue-400 hover:underline"
                        >
                          0502-5550-8700
                        </a>
                      </div>
                    ...
                    <CardContent className="p-6 flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-lg font-bold text-purple-600 dark:text-purple-400 hover:underline break-all"
                        >
              ...
              <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl border border-slate-100 dark:border-slate-700 relative overflow-hidden">
                ...
                >
                  ...
                  <div className="pt-2">
                    <Button
                      type="submit"
                      className="w-full py-6 text-lg font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-lg rounded-xl"
                    >
                      상담 신청하기
                      <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                    <p className="text-xs text-slate-400 mt-4 text-center">
                      보내주신 정보는 상담 목적으로만 사용되며, 안전하게
                      보호됩니다.
                    </p>
                  </div>
                </form>
                ...
                {[
                  {
                    step: '01',
                    title: '상담 신청',
                    desc: '전화, 이메일, 폼을 통한 접수',
                  },
                  {
                    step: '02',
                    title: '기초 상담',
                    desc: '유선 또는 대면으로 니즈 파악',
                  },
                  {
                    step: '03',
                    title: '솔루션 제안',
                  ...
                  <div
                    key={index}
                    className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-lg border border-slate-100 dark:border-slate-700 text-center group hover:-translate-y-2 transition-transform duration-300"
                  >
            ...
            <div className="bg-gradient-to-br from-slate-900 to-blue-900 rounded-3xl p-12 md:p-20 relative overflow-hidden shadow-2xl max-w-5xl mx-auto text-white">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    size="lg"
                    className="px-10 py-6 text-lg font-bold bg-white text-blue-900 hover:bg-blue-50 shadow-xl border-none rounded-full"
                    onClick={() =>
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="px-10 py-6 text-lg font-bold border-2 border-white/30 text-white hover:bg-white/10 bg-transparent rounded-full"
                    asChild
                  >
                    <Link href="/solutions">솔루션 보기</Link>
                  </Button>
                </div>
              </div>
            </div>
